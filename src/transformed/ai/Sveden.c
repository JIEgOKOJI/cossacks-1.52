...
static int * FUN_10002f50(void);
static int FUN_10002f80(int param_1,int param_2,int param_3);
static int FUN_10002fb0(int param_1,int param_2,int param_3);
static void FUN_10003060(void);
static void FUN_100031e0(void);
static void FUN_10003250(void);
static void FUN_100032f0(void);
static void FUN_10003340(void);
static void FUN_10003380(void);
static void FUN_10004250(void);
static void FUN_10004330(void);
static void FUN_10004380(void);
static void FUN_10005240(void);
static int FUN_10005290(int *param_1);
static void FUN_100052d0(void);
static void FUN_10005ab0(void);
static void FUN_10005bf0(void);
static void FUN_10005e10(int param_1);
static void FUN_10005ff0(int param_1);
static void FUN_10006310(int param_1);
static void FUN_10006650(void);
static void FUN_10006700(void);
static void FUN_10006750(void);
static void FUN_10006840(void);
static void FUN_10006970(void);
static void FUN_10006b80(void);
static void FUN_10006c00(void);
static void FUN_10006c60(void);
static void FUN_10006d60(void);


int * FUN_10002f50(void)
...
int  FUN_10002f80(int param_1,int param_2,int param_3)
...
int  FUN_10002fb0(int param_1,int param_2,int param_3)
...
LAB_10003cac:
  ...
  if ((cVar1 == '\0') || (cVar1 = UpgIsDone(&DAT_100161e0), cVar1 == '\0')) {
    ...
    iVar4 = GetMoney(5);
    if ((4999 < iVar4) || (iVar4 = GetMoney(0), iVar4 == 0)) goto LAB_100041da;
    uVar17 = 50000;
    uVar15 = 5;
  }
...

{
  ...
  char acStack_30 [48];
  if ((((1) &&
       (RegisterUpgrade(&DAT_10016068,"KUZ04SV"), 1)) &&
      (RegisterUpgrade(&DAT_10016008,"AKA35SV"), 1)) &&
     (RegisterUpgrade(&DAT_10016060,"AKA36SV"), 1)) {
    RegisterUpgrade(&DAT_10016070,"AKA32SV");
  }
  if (1) {
    RegisterUnitType(&DAT_10013670,"Dragun(SV)");
  }
  if ((((((1) &&
         (RegisterUpgrade(&DAT_100138e0,"Dragun(SV)ATTACK"), 1))
        && ((RegisterUpgrade(&DAT_100138d8,"Dragun(SV)ATTACK3"),
            1 &&
            ((RegisterUpgrade(&DAT_100138d0,"Dragun(SV)ATTACK4"),
             1 &&
             (RegisterUpgrade(&DAT_10013918,"Dragun(SV)ATTACK5"),
             1)))))) &&
       (RegisterUpgrade(&DAT_10013908,"Dragun(SV)ATTACK6"), 1))
      && (((((RegisterUpgrade(&DAT_10013900,"Dragun(SV)ATTACK7"),
             1 &&
             (RegisterUpgrade(&DAT_100136b8,"Dragun(SV)SHIELD"),
             1)) &&
            (RegisterUpgrade(&DAT_100136a8,"Dragun(SV)SHIELD3"),
            1)) &&
           ((RegisterUpgrade(&DAT_100138a0,"Dragun(SV)SHIELD4"),
            1 &&
            (RegisterUpgrade(&DAT_10013898,"Dragun(SV)SHIELD5"),
            1)))) &&
          ((RegisterUpgrade(&DAT_10013890,"Dragun(SV)SHIELD6"), 1
           && ((RegisterUpgrade(&DAT_10013888,"Dragun(SV)SHIELD7"),
               1 &&
               (RegisterUpgrade(&DAT_100138e0,"Dragun(SV)ATTACK"),
               1)))))))) &&
     (((RegisterUpgrade(&DAT_100138d8,"Dragun(SV)ATTACK3"), 1 &&
       (((RegisterUpgrade(&DAT_100138d0,"Dragun(SV)ATTACK4"), 1
         && (RegisterUpgrade(&DAT_10013918,"Dragun(SV)ATTACK5"),
            1)) &&
        (RegisterUpgrade(&DAT_10013908,"Dragun(SV)ATTACK6"), 1)))
       ) && ((((RegisterUpgrade(&DAT_10013900,"Dragun(SV)ATTACK7"),
              ...
              ((RegisterUpgrade(&DAT_100136a8,"Dragun(SV)SHIELD3"),
               ...
               ((RegisterUpgrade(&DAT_100138a0,"Dragun(SV)SHIELD4"),
                ...
                (RegisterUpgrade(&DAT_10013898,"Dragun(SV)SHIELD5"),
                1)))))) &&
             (RegisterUpgrade(&DAT_10013890,"Dragun(SV)SHIELD6"),
             1)))))) {
    RegisterUpgrade(&DAT_10013888,"Dragun(SV)SHIELD7");
  }
  if (1) {
    RegisterUnitType(&DAT_10013660,"Dragun_18(SV)");
  }
  if ((((((1) &&
         (RegisterUpgrade(&DAT_10013638,"Dragun_18(SV)ATTACK"), 1
         )) && (RegisterUpgrade(&DAT_10013630,"Dragun_18(SV)ATTACK3"),
               1)) &&
       ((RegisterUpgrade(&DAT_10013628,"Dragun_18(SV)ATTACK4"), 1
        && (RegisterUpgrade(&DAT_100162f8,"Dragun_18(SV)ATTACK5"),
           1)))) &&
      ((RegisterUpgrade(&DAT_100162f0,"Dragun_18(SV)ATTACK6"), 1
       && ((RegisterUpgrade(&DAT_100162e8,"Dragun_18(SV)ATTACK7"),
           1 &&
           (RegisterUpgrade(&DAT_10016370,"Dragun_18(SV)SHIELD"),
           1)))))) &&
     (((RegisterUpgrade(&DAT_10016368,"Dragun_18(SV)SHIELD3"), 1
       && (((RegisterUpgrade(&DAT_100163b8,"Dragun_18(SV)SHIELD4"),
            1 &&
            (RegisterUpgrade(&DAT_100163b0,"Dragun_18(SV)SHIELD5"),
            1)) &&
           (RegisterUpgrade(&DAT_100163a8,"Dragun_18(SV)SHIELD6"),
           1)))) &&
      ((((RegisterUpgrade(&DAT_100163a0,"Dragun_18(SV)SHIELD7"),
         1 &&
         (RegisterUpgrade(&DAT_10013638,"Dragun_18(SV)ATTACK"), 1
         )) && (((RegisterUpgrade(&DAT_10013630,"Dragun_18(SV)ATTACK3"),
                 1 &&
                 ((RegisterUpgrade(&DAT_10013628,"Dragun_18(SV)ATTACK4"),
                  1 &&
                  (RegisterUpgrade(&DAT_100162f8,"Dragun_18(SV)ATTACK5"),
                  1)))) &&
                (RegisterUpgrade(&DAT_100162f0,"Dragun_18(SV)ATTACK6"),
                1)))) &&
       ((((RegisterUpgrade(&DAT_100162e8,"Dragun_18(SV)ATTACK7"),
          1 &&
          (RegisterUpgrade(&DAT_10016370,"Dragun_18(SV)SHIELD"),
          1)) &&
         (RegisterUpgrade(&DAT_10016368,"Dragun_18(SV)SHIELD3"),
         1)) &&
        (((RegisterUpgrade(&DAT_100163b8,"Dragun_18(SV)SHIELD4"),
          1 &&
          (RegisterUpgrade(&DAT_100163b0,"Dragun_18(SV)SHIELD5"),
  ...
  if (1) {
    RegisterUnitType(&DAT_10015fc0,"Sveshenik_evro(SV)");
  }
  DAT_10016294 = GetAINation();
  iVar3 = DAT_10016294 * 0x4b8;
  *(int *)(&DAT_10013ad0 + iVar3) = 0;
  *(int *)(&DAT_10013c64 + iVar3) = 0;
  uVar4 = GetRandomIndex();
  *(unsigned int *)(&DAT_10015f78 + DAT_10016294 * 4) = uVar4 & 0x80;
  if (1) {
    RegisterUpgrade(&DAT_100160b0,"Barabanshik_ev1(SV)SHIELD");
  }
  if (1) {
    RegisterUnitType(&DAT_10013868,"Dragun_18_DIP(SV)");
  }
  bVar2 = GetRandomIndex();
  pcVar7 = "Dragun(SV)";
  if ((bVar2 & 6) != 2) {
    pcVar7 = "Reitar_Shwec(SV)";
  }
  uVar4 = 0xffffffff;
  do {
    pcVar8 = pcVar7;
  ...
  if (((1) &&
      (RegisterUnitType(&DAT_10013868,"Dragun_18_DIP(SV)"), 1)) &&
     ((RegisterUnitType(&DAT_10016258,"Strelec_Algir_DIP(SV)"), 1
      && (RegisterUnitType(&DAT_10016308,"Kozak_loshad_DIP(SV)"),
         1)))) {
    RegisterUnitType(&DAT_100136e0,"Officer_evro(SV)");
  }
  if ((1) &&
     (RegisterUpgrade(&DAT_10016240,"Officer_evro(SV)ATTACK"), 1)
     ) {
    RegisterUpgrade(&DAT_10015fa8,"Officer_evro(SV)SHIELD");
  }
  if (1) {
    RegisterUnitType(&DAT_10013620,"Barabanshik_ev1(SV)");
  }
  AssignFormUnit("Pikiner_evro(SV)");
  if ((((1) &&
       (RegisterUnitType(&DAT_10013668,"Pikiner_evro(SV)"), 1)) &&
      (RegisterUnitType(&DAT_10016170,"Krestian_Sved(SV)"), 1)) &&
     (RegisterUnitType(&DAT_10016140,"Grenader_DIP(SV)"), 1)) {
    RegisterUnitType(&DAT_100160c0,"Mushketer_ev(SV)");
    if (((((1) &&
          (RegisterUnitType(&DAT_10016390,acStack_60), 1)) &&
         ((RegisterUnitType(&DAT_10016310,"Kirasir(SV)"), 1 &&
          ((RegisterUnitType(&DAT_10015f60,acStack_30), 1 &&
           (RegisterUnitType(&DAT_10016350,"Pushka(SV)"), 1))))))
        && (((RegisterUnitType(&DAT_10013648,"Mortira(SV)"), 1 &&
             (((RegisterUnitType(&DAT_100138a8,"Mortira_b(SV)"), 1
               && (RegisterUnitType(&DAT_100161d0,"Lodka(SV)"), 1)
               ) && (RegisterUnitType(&DAT_10015f98,"Center_Swesair(SV)"),
                    1)))) &&
            (((RegisterUnitType(&DAT_10015fb8,"Melnica(SV)"), 1 &&
              (RegisterUnitType(&DAT_10016230,"Kazarma_evro(SV)"),
              1)) &&
             ((RegisterUnitType(&DAT_10016238,"Kazarma(SV)"), 1 &&
              ((RegisterUnitType(&DAT_10015fb0,"Sclad1(SV)"), 1 &&
               (RegisterUnitType(&DAT_10015f00,"akademia_E(SV)"),
               1)))))))))) &&
       ((RegisterUnitType(&DAT_100160b8,"Konushnia_Swesair(SV)"),
        1 &&
        (((((RegisterUnitType(&DAT_10015fc8,"Dip_korpus(SV)"), 1
            && (RegisterUnitType(&DAT_100135f8,"artileri_depo(SV)"),
               1)) &&
           (RegisterUnitType(&DAT_10013858,"Rinok(SV)"), 1)) &&
          (((RegisterUnitType(&DAT_100138b8,"Bashnia(SV)"), 1 &&
            (RegisterUnitType(&DAT_100161c8,"Kuznica(SV)"), 1)) &&
           ((RegisterUnitType(&DAT_100160d8,"Kostel(SV)"), 1 &&
            ((RegisterUnitType(&DAT_100162b8,"PorE(SV)"), 1 &&
             (RegisterUnitType(&DAT_100138c8,"Fregat(SV)"), 1)))))
           ))) && ((RegisterUnitType(&DAT_10015f70,"GALERA(SV)"),
                   1 &&
                   ((RegisterUnitType(&DAT_10016378,"Linkor(SV)"),
                    1 &&
                    (RegisterUnitType(&DAT_10015f68,"Yahta(SV)"),
                    1)))))))))) {
      RegisterUnitType(&DAT_10013880,"PERES_KOR(SV)");
    }
  }
  if (((((((((1) &&
            (RegisterUpgrade(&DAT_10016358,"Melnica(SV)GETRES"),
            1)) &&
           (RegisterUpgrade(&DAT_100160e0,"Melnica(SV)GETRES2"),
           1)) &&
          ((RegisterUpgrade(&DAT_10013640,"KUZ01SV"), 1 &&
           (RegisterUpgrade(&DAT_10016330,"Pikiner_evro(SV)ATTACK"),
           1)))) &&
         (RegisterUpgrade(&DAT_10016338,"Pikiner_evro(SV)ATTACK3"),
         1)) &&
        ((RegisterUpgrade(&DAT_10016320,"Pikiner_evro(SV)ATTACK4"),
         1 &&
         (RegisterUpgrade(&DAT_10016328,"Pikiner_evro(SV)ATTACK5"),
         1)))) &&
       ((RegisterUpgrade(&DAT_10016340,"Pikiner_evro(SV)ATTACK6"),
        1 &&
        (((RegisterUpgrade(&DAT_10016278,"Pikiner_evro(SV)SHIELD"),
          1 &&
          (RegisterUpgrade(&DAT_10016260,"Pikiner_evro(SV)SHIELD3"),
          1)) &&
         (RegisterUpgrade(&DAT_10016268,"Pikiner_evro(SV)SHIELD4"),
         1)))))) &&
      ((((RegisterUpgrade(&DAT_10016280,"Pikiner_evro(SV)SHIELD5"),
         1 &&
         (RegisterUpgrade(&DAT_10016288,"Pikiner_evro(SV)SHIELD6"),
         1)) &&
        (RegisterUpgrade(&DAT_100138f0,"Mushketer_ev(SV)ATTACK"),
        1)) &&
       ((RegisterUpgrade(&DAT_100138f8,"Mushketer_ev(SV)ATTACK3"),
        1 &&
        (RegisterUpgrade(&DAT_100138e8,"Mushketer_ev(SV)ATTACK4"),
        1)))))) &&
     ((RegisterUpgrade(&DAT_10015f58,"Mushketer_ev(SV)SHIELD"), 1
      && (RegisterUpgrade(&DAT_10015f48,"Mushketer_ev(SV)SHIELD3"),
         1)))) {
    RegisterUpgrade(&DAT_10015f50,"Mushketer_ev(SV)SHIELD4");
  }
  puVar5 = FUN_10002f50();
  ...
  if (((((1) &&
        (RegisterUpgrade(&DAT_10013698,"Kirasir(SV)ATTACK"), 1))
       && (RegisterUpgrade(&DAT_10013690,"Kirasir(SV)ATTACK3"), 1
          )) && ((RegisterUpgrade(&DAT_10013688,"Kirasir(SV)ATTACK4"),
                 1 &&
                 (RegisterUpgrade(&DAT_10013680,"Kirasir(SV)ATTACK5"),
                 1)))) &&
     ((((RegisterUpgrade(&DAT_10013658,"Kirasir(SV)ATTACK6"), 1
        && ((RegisterUpgrade(&DAT_10013650,"Kirasir(SV)ATTACK7"),
            1 &&
            (RegisterUpgrade(&DAT_10013728,"Kirasir(SV)SHIELD"),
            1)))) &&
       (RegisterUpgrade(&DAT_10013720,"Kirasir(SV)SHIELD3"), 1))
      && (((RegisterUpgrade(&DAT_10013718,"Kirasir(SV)SHIELD4"),
           1 &&
           (RegisterUpgrade(&DAT_10013700,"Kirasir(SV)SHIELD5"),
           1)) &&
          (RegisterUpgrade(&DAT_100136f8,"Kirasir(SV)SHIELD6"), 1
          )))))) {
    RegisterUpgrade(&DAT_100136f0,"Kirasir(SV)SHIELD7");
  }
  puVar5 = FUN_10002f50();
  ...
  if (((((((1) &&
          (RegisterUpgrade(&DAT_100161b8,"Pushka(SV)BUILD"), 1))
         && ((RegisterUpgrade(&DAT_100161b0,"Pushka(SV)BUILD3"),
             1 &&
             ((RegisterUpgrade(&DAT_10016180,"Pushka(SV)BUILD4"),
              1 &&
              (RegisterUpgrade(&DAT_10016178,"Pushka(SV)BUILD5"),
              1)))))) &&
        ((RegisterUpgrade(&DAT_10016188,"Pushka(SV)BUILD6"), 1 &&
         (((((RegisterUpgrade(&DAT_10016078,"Mortira(SV)BUILD"),
             1 &&
             (RegisterUpgrade(&DAT_10016080,"Mortira(SV)BUILD3"),
             1)) &&
            (RegisterUpgrade(&DAT_10016088,"Mortira(SV)BUILD4"),
            1)) &&
           ((RegisterUpgrade(&DAT_10016090,"Mortira(SV)BUILD5"),
            1 &&
            (RegisterUpgrade(&DAT_10016198,"KUZ03SV"), 1)))) &&
          ((RegisterUpgrade(&DAT_10016000,"MAINSV"), 1 &&
           ((RegisterUpgrade(&DAT_10013938,"AKA06SV"), 1 &&
            (RegisterUpgrade(&DAT_10016058,"AKA01SV"), 1)))))))))
        ) && (RegisterUpgrade(&DAT_10016010,"AKA02SV"), 1)) &&
      (((((((((RegisterUpgrade(&DAT_10016018,"AKA03SV"), 1 &&
              (RegisterUpgrade(&DAT_10016020,"AKA04SV"), 1)) &&
             (RegisterUpgrade(&DAT_10016250,"AKA08SV"), 1)) &&
            ((RegisterUpgrade(&DAT_100160f0,"AKA23SV"), 1 &&
             (RegisterUpgrade(&DAT_10016130,"AKA24SV"), 1)))) &&
           ((RegisterUpgrade(&DAT_100161e8,"AKA31SV"), 1 &&
            ((RegisterUpgrade(&DAT_100161f0,"AKA33SV"), 1 &&
             (RegisterUpgrade(&DAT_10016148,"AKA12SV"), 1))))))
          && (RegisterUpgrade(&DAT_10016158,"AKA13SV"), 1)) &&
         (((RegisterUpgrade(&DAT_10016160,"AKA14SV"), 1 &&
           (RegisterUpgrade(&DAT_10016150,"AKA15SV"), 1)) &&
          (RegisterUpgrade(&DAT_10013930,"AKA11SV"), 1)))) &&
        (((RegisterUpgrade(&DAT_100138c0,"AKA10SV"), 1 &&
          (RegisterUpgrade(&DAT_10013780,"AKA30SV"), 1)) &&
         ((RegisterUpgrade(&DAT_100160d0,"AKA07SV"), 1 &&
          ((RegisterUpgrade(&DAT_10013920,"AKA20SV"), 1 &&
           (RegisterUpgrade(&DAT_100161d8,"KUZ02SV"), 1))))))))
       && ((RegisterUpgrade(&DAT_100161e0,"AKA09SV"), 1 &&
           ((((RegisterUpgrade(&DAT_10013850,"AKA05SV"), 1 &&
              (RegisterUpgrade(&DAT_10013860,"AKA28SV"), 1)) &&
             (RegisterUpgrade(&DAT_10013748,"AKA29SV"), 1)) &&
            ((RegisterUpgrade(&DAT_10013608,"KUZ05SV"), 1 &&
             (RegisterUpgrade(&DAT_100136e8,"KUZ06SV"), 1))))))))
      )) && ((((RegisterUpgrade(&DAT_10013610,"AKA34SV"), 1 &&
               ((RegisterUpgrade(&DAT_100162c8,"Bashnia(SV)PAUSE"),
                1 &&
                (RegisterUpgrade(&DAT_100162b0,"Bashnia(SV)PAUSE3"),
                1)))) &&
              (RegisterUpgrade(&DAT_100162c0,"Bashnia(SV)PAUSE4"),
              1)) &&
             ((RegisterUpgrade(&DAT_100162a0,"Bashnia(SV)PAUSE5"),
              1 &&
              (RegisterUpgrade(&DAT_100162a8,"Bashnia(SV)PAUSE6"),
              1)))))) {
    RegisterUpgrade(&DAT_10016298,"Bashnia(SV)PAUSE7");
  }
  SetPDistribution(9,4,4);
  AssignAmountOfMineUpgrades(6);
  AssignMineUpgrade(0,"shahta(SV)INSIDE",0x5a);
  AssignMineUpgrade(1,"shahta(SV)INSIDE3",0x32);
  AssignMineUpgrade(2,"shahta(SV)INSIDE4",0x32);
  AssignMineUpgrade(3,"shahta(SV)INSIDE5",0x32);
  AssignMineUpgrade(4,"shahta(SV)INSIDE6",0x32);
  AssignMineUpgrade(5,"shahta(SV)INSIDE7",0x32);
