...

{
  ...
  char acStack_30 [48];
  if ((((1) &&
       (RegisterUpgrade(&DAT_10016068,"KUZ04VE"), 1)) &&
      (RegisterUpgrade(&DAT_10016008,"AKA35VE"), 1)) &&
     (RegisterUpgrade(&DAT_10016060,"AKA36VE"), 1)) {
    RegisterUpgrade(&DAT_10016070,"AKA32VE");
  }
  if (1) {
    RegisterUnitType(&DAT_10013670,"Dragun(VE)");
  }
  if ((((((1) &&
         (RegisterUpgrade(&DAT_100138e0,"Dragun(VE)ATTACK"), 1))
        && ((RegisterUpgrade(&DAT_100138d8,"Dragun(VE)ATTACK3"),
            1 &&
            ((RegisterUpgrade(&DAT_100138d0,"Dragun(VE)ATTACK4"),
             1 &&
             (RegisterUpgrade(&DAT_10013918,"Dragun(VE)ATTACK5"),
             1)))))) &&
       (RegisterUpgrade(&DAT_10013908,"Dragun(VE)ATTACK6"), 1))
      && (((((RegisterUpgrade(&DAT_10013900,"Dragun(VE)ATTACK7"),
             1 &&
             (RegisterUpgrade(&DAT_100136b8,"Dragun(VE)SHIELD"),
             1)) &&
            (RegisterUpgrade(&DAT_100136a8,"Dragun(VE)SHIELD3"),
            1)) &&
           ((RegisterUpgrade(&DAT_100138a0,"Dragun(VE)SHIELD4"),
            1 &&
            (RegisterUpgrade(&DAT_10013898,"Dragun(VE)SHIELD5"),
            1)))) &&
          ((RegisterUpgrade(&DAT_10013890,"Dragun(VE)SHIELD6"), 1
           && ((RegisterUpgrade(&DAT_10013888,"Dragun(VE)SHIELD7"),
               1 &&
               (RegisterUpgrade(&DAT_100138e0,"Dragun(VE)ATTACK"),
               1)))))))) &&
     (((RegisterUpgrade(&DAT_100138d8,"Dragun(VE)ATTACK3"), 1 &&
       (((RegisterUpgrade(&DAT_100138d0,"Dragun(VE)ATTACK4"), 1
         && (RegisterUpgrade(&DAT_10013918,"Dragun(VE)ATTACK5"),
            1)) &&
        (RegisterUpgrade(&DAT_10013908,"Dragun(VE)ATTACK6"), 1)))
       ) && ((((RegisterUpgrade(&DAT_10013900,"Dragun(VE)ATTACK7"),
              ...
              ((RegisterUpgrade(&DAT_100136a8,"Dragun(VE)SHIELD3"),
               ...
               ((RegisterUpgrade(&DAT_100138a0,"Dragun(VE)SHIELD4"),
                ...
                (RegisterUpgrade(&DAT_10013898,"Dragun(VE)SHIELD5"),
                1)))))) &&
             (RegisterUpgrade(&DAT_10013890,"Dragun(VE)SHIELD6"),
             1)))))) {
    RegisterUpgrade(&DAT_10013888,"Dragun(VE)SHIELD7");
  }
  if (1) {
    RegisterUnitType(&DAT_10013660,"Dragun_18(VE)");
  }
  if ((((((1) &&
         (RegisterUpgrade(&DAT_10013638,"Dragun_18(VE)ATTACK"), 1
         )) && (RegisterUpgrade(&DAT_10013630,"Dragun_18(VE)ATTACK3"),
               1)) &&
       ((RegisterUpgrade(&DAT_10013628,"Dragun_18(VE)ATTACK4"), 1
        && (RegisterUpgrade(&DAT_100162f8,"Dragun_18(VE)ATTACK5"),
           1)))) &&
      ((RegisterUpgrade(&DAT_100162f0,"Dragun_18(VE)ATTACK6"), 1
       && ((RegisterUpgrade(&DAT_100162e8,"Dragun_18(VE)ATTACK7"),
           1 &&
           (RegisterUpgrade(&DAT_10016370,"Dragun_18(VE)SHIELD"),
           1)))))) &&
     (((RegisterUpgrade(&DAT_10016368,"Dragun_18(VE)SHIELD3"), 1
       && (((RegisterUpgrade(&DAT_100163b8,"Dragun_18(VE)SHIELD4"),
            1 &&
            (RegisterUpgrade(&DAT_100163b0,"Dragun_18(VE)SHIELD5"),
            1)) &&
           (RegisterUpgrade(&DAT_100163a8,"Dragun_18(VE)SHIELD6"),
           1)))) &&
      ((((RegisterUpgrade(&DAT_100163a0,"Dragun_18(VE)SHIELD7"),
         1 &&
         (RegisterUpgrade(&DAT_10013638,"Dragun_18(VE)ATTACK"), 1
         )) && (((RegisterUpgrade(&DAT_10013630,"Dragun_18(VE)ATTACK3"),
                 1 &&
                 ((RegisterUpgrade(&DAT_10013628,"Dragun_18(VE)ATTACK4"),
                  1 &&
                  (RegisterUpgrade(&DAT_100162f8,"Dragun_18(VE)ATTACK5"),
                  1)))) &&
                (RegisterUpgrade(&DAT_100162f0,"Dragun_18(VE)ATTACK6"),
                1)))) &&
       ((((RegisterUpgrade(&DAT_100162e8,"Dragun_18(VE)ATTACK7"),
          1 &&
          (RegisterUpgrade(&DAT_10016370,"Dragun_18(VE)SHIELD"),
          1)) &&
         (RegisterUpgrade(&DAT_10016368,"Dragun_18(VE)SHIELD3"),
         1)) &&
        (((RegisterUpgrade(&DAT_100163b8,"Dragun_18(VE)SHIELD4"),
          1 &&
          (RegisterUpgrade(&DAT_100163b0,"Dragun_18(VE)SHIELD5"),
  ...
  if (1) {
    RegisterUnitType(&DAT_10015fc0,"Sveshenik_evro(VE)");
  }
  DAT_10016294 = GetAINation();
  ...
  *(unsigned int *)(&DAT_10015f78 + DAT_10016294 * 4) = uVar4 & 0x80;
  if (1) {
    RegisterUpgrade(&DAT_100160b0,"Barabanshik_ev1(VE)SHIELD");
  }
  if (1) {
    RegisterUnitType(&DAT_10013868,"Dragun_18_DIP(VE)");
  }
  bVar2 = GetRandomIndex();
  pcVar7 = "Dragun(VE)";
  if ((bVar2 & 6) != 2) {
    pcVar7 = "Konni_Ricar(VE)";
  }
  uVar4 = 0xffffffff;
  do {
    pcVar8 = pcVar7;
  ...
  if (((1) &&
      (RegisterUnitType(&DAT_10016258,"Strelec_Algir_DIP(VE)"), 1)
      ) && (RegisterUnitType(&DAT_10016308,"Kozak_loshad_DIP(VE)"),
           1)) {
    RegisterUnitType(&DAT_100136e0,"Officer_evro(VE)");
  }
  if ((1) &&
     (RegisterUpgrade(&DAT_10016240,"Officer_evro(VE)ATTACK"), 1)
     ) {
    RegisterUpgrade(&DAT_10015fa8,"Officer_evro(VE)SHIELD");
  }
  if (1) {
    RegisterUnitType(&DAT_10013620,"Barabanshik_ev1(VE)");
  }
  AssignFormUnit("Pikiner_evro(VE)");
  if ((((1) &&
       (RegisterUnitType(&DAT_10013668,"Pikiner_evro(VE)"), 1)) &&
      (RegisterUnitType(&DAT_10016170,"Kreposnoi_portugal(VE)"), 1
      )) && (RegisterUnitType(&DAT_10016140,"Grenader_DIP(VE)"), 1
            )) {
    RegisterUnitType(&DAT_100160c0,"Mushketer_ev(VE)");
    if (((((1) &&
          (RegisterUnitType(&DAT_10016390,acStack_60), 1)) &&
         ((RegisterUnitType(&DAT_10016310,"Kirasir(VE)"), 1 &&
          ((RegisterUnitType(&DAT_10015f60,acStack_30), 1 &&
           (RegisterUnitType(&DAT_10016350,"Pushka(VE)"), 1))))))
        && (((RegisterUnitType(&DAT_10013648,"Mortira(VE)"), 1 &&
             (((RegisterUnitType(&DAT_100138a8,"Mortira_b(VE)"), 1
               && (RegisterUnitType(&DAT_100161d0,"Lodka(VE)"), 1)
               ) && (RegisterUnitType(&DAT_10015f98,"Center_Venecia(VE)"),
                    1)))) &&
            (((RegisterUnitType(&DAT_10015fb8,"Melnica(VE)"), 1 &&
              (RegisterUnitType(&DAT_10016230,"Kazarma_evro(VE)"),
              1)) &&
             ((RegisterUnitType(&DAT_10016238,"Kazarma(VE)"), 1 &&
              ((RegisterUnitType(&DAT_10015fb0,"Sclad2(VE)"), 1 &&
               (RegisterUnitType(&DAT_10015f00,"akademia_E(VE)"),
               1)))))))))) &&
       ((RegisterUnitType(&DAT_100160b8,"Konushnia_Swesair(VE)"),
        1 &&
        (((((RegisterUnitType(&DAT_10015fc8,"Dip_korpus(VE)"), 1
            && (RegisterUnitType(&DAT_100135f8,"artileri_depo(VE)"),
               1)) &&
           (RegisterUnitType(&DAT_10013858,"Rinok(VE)"), 1)) &&
          (((RegisterUnitType(&DAT_100138b8,"Bashnia(VE)"), 1 &&
            (RegisterUnitType(&DAT_100161c8,"Kuznica(VE)"), 1)) &&
           ((RegisterUnitType(&DAT_100160d8,"Kostel(VE)"), 1 &&
            ((RegisterUnitType(&DAT_100162b8,"PorE(VE)"), 1 &&
             (RegisterUnitType(&DAT_100138c8,"Fregat(VE)"), 1)))))
           ))) && ((RegisterUnitType(&DAT_10015f70,"GALERA(VE)"),
                   1 &&
                   ((RegisterUnitType(&DAT_10016378,"Linkor(VE)"),
                    1 &&
                    (RegisterUnitType(&DAT_10015f68,"Yahta(VE)"),
                    1)))))))))) {
      RegisterUnitType(&DAT_10013880,"PERES_KOR(VE)");
    }
  }
  if (((((((((1) &&
            (RegisterUpgrade(&DAT_10016358,"Melnica(VE)GETRES"),
            1)) &&
           (RegisterUpgrade(&DAT_100160e0,"Melnica(VE)GETRES2"),
           1)) &&
          ((RegisterUpgrade(&DAT_10013640,"KUZ01VE"), 1 &&
           (RegisterUpgrade(&DAT_10016330,"Pikiner_evro(VE)ATTACK"),
           1)))) &&
         (RegisterUpgrade(&DAT_10016338,"Pikiner_evro(VE)ATTACK3"),
         1)) &&
        ((RegisterUpgrade(&DAT_10016320,"Pikiner_evro(VE)ATTACK4"),
         1 &&
         (RegisterUpgrade(&DAT_10016328,"Pikiner_evro(VE)ATTACK5"),
         1)))) &&
       ((RegisterUpgrade(&DAT_10016340,"Pikiner_evro(VE)ATTACK6"),
        1 &&
        (((RegisterUpgrade(&DAT_10016278,"Pikiner_evro(VE)SHIELD"),
          1 &&
          (RegisterUpgrade(&DAT_10016260,"Pikiner_evro(VE)SHIELD3"),
          1)) &&
         (RegisterUpgrade(&DAT_10016268,"Pikiner_evro(VE)SHIELD4"),
         1)))))) &&
      ((((RegisterUpgrade(&DAT_10016280,"Pikiner_evro(VE)SHIELD5"),
         1 &&
         (RegisterUpgrade(&DAT_10016288,"Pikiner_evro(VE)SHIELD6"),
         1)) &&
        (RegisterUpgrade(&DAT_100138f0,"Mushketer_ev(VE)ATTACK"),
        1)) &&
       ((RegisterUpgrade(&DAT_100138f8,"Mushketer_ev(VE)ATTACK3"),
        1 &&
        (RegisterUpgrade(&DAT_100138e8,"Mushketer_ev(VE)ATTACK4"),
        1)))))) &&
     ((RegisterUpgrade(&DAT_10015f58,"Mushketer_ev(VE)SHIELD"), 1
      && (RegisterUpgrade(&DAT_10015f48,"Mushketer_ev(VE)SHIELD3"),
         1)))) {
    RegisterUpgrade(&DAT_10015f50,"Mushketer_ev(VE)SHIELD4");
  }
  puVar5 = FUN_10002f30();
  ...
  if (((((1) &&
        (RegisterUpgrade(&DAT_10013698,"Kirasir(VE)ATTACK"), 1))
       && (RegisterUpgrade(&DAT_10013690,"Kirasir(VE)ATTACK3"), 1
          )) && ((RegisterUpgrade(&DAT_10013688,"Kirasir(VE)ATTACK4"),
                 1 &&
                 (RegisterUpgrade(&DAT_10013680,"Kirasir(VE)ATTACK5"),
                 1)))) &&
     ((((RegisterUpgrade(&DAT_10013658,"Kirasir(VE)ATTACK6"), 1
        && ((RegisterUpgrade(&DAT_10013650,"Kirasir(VE)ATTACK7"),
            1 &&
            (RegisterUpgrade(&DAT_10013728,"Kirasir(VE)SHIELD"),
            1)))) &&
       (RegisterUpgrade(&DAT_10013720,"Kirasir(VE)SHIELD3"), 1))
      && (((RegisterUpgrade(&DAT_10013718,"Kirasir(VE)SHIELD4"),
           1 &&
           (RegisterUpgrade(&DAT_10013700,"Kirasir(VE)SHIELD5"),
           1)) &&
          (RegisterUpgrade(&DAT_100136f8,"Kirasir(VE)SHIELD6"), 1
          )))))) {
    RegisterUpgrade(&DAT_100136f0,"Kirasir(VE)SHIELD7");
  }
  puVar5 = FUN_10002f30();
  ...
  if (((((((1) &&
          (RegisterUpgrade(&DAT_100161b8,"Pushka(VE)BUILD"), 1))
         && ((RegisterUpgrade(&DAT_100161b0,"Pushka(VE)BUILD3"),
             1 &&
             ((RegisterUpgrade(&DAT_10016180,"Pushka(VE)BUILD4"),
              1 &&
              (RegisterUpgrade(&DAT_10016178,"Pushka(VE)BUILD5"),
              1)))))) &&
        ((RegisterUpgrade(&DAT_10016188,"Pushka(VE)BUILD6"), 1 &&
         (((((RegisterUpgrade(&DAT_10016078,"Mortira(VE)BUILD"),
             1 &&
             (RegisterUpgrade(&DAT_10016080,"Mortira(VE)BUILD3"),
             1)) &&
            (RegisterUpgrade(&DAT_10016088,"Mortira(VE)BUILD4"),
            1)) &&
           ((RegisterUpgrade(&DAT_10016090,"Mortira(VE)BUILD5"),
            1 &&
            (RegisterUpgrade(&DAT_10016198,"KUZ03VE"), 1)))) &&
          ((RegisterUpgrade(&DAT_10016000,"MAINVE"), 1 &&
           ((RegisterUpgrade(&DAT_10013938,"AKA06VE"), 1 &&
            (RegisterUpgrade(&DAT_10016058,"AKA01VE"), 1)))))))))
        ) && (RegisterUpgrade(&DAT_10016010,"AKA02VE"), 1)) &&
      (((((((((RegisterUpgrade(&DAT_10016018,"AKA03VE"), 1 &&
              (RegisterUpgrade(&DAT_10016020,"AKA04VE"), 1)) &&
             (RegisterUpgrade(&DAT_10016250,"AKA08VE"), 1)) &&
            ((RegisterUpgrade(&DAT_100160f0,"AKA23VE"), 1 &&
             (RegisterUpgrade(&DAT_10016130,"AKA24VE"), 1)))) &&
           ((RegisterUpgrade(&DAT_100161e8,"AKA31VE"), 1 &&
            ((RegisterUpgrade(&DAT_100161f0,"AKA33VE"), 1 &&
             (RegisterUpgrade(&DAT_10016148,"AKA12VE"), 1))))))
          && (RegisterUpgrade(&DAT_10016158,"AKA13VE"), 1)) &&
         (((RegisterUpgrade(&DAT_10016160,"AKA14VE"), 1 &&
           (RegisterUpgrade(&DAT_10016150,"AKA15VE"), 1)) &&
          (RegisterUpgrade(&DAT_10013930,"AKA11VE"), 1)))) &&
        (((RegisterUpgrade(&DAT_100138c0,"AKA10VE"), 1 &&
          (RegisterUpgrade(&DAT_10013780,"AKA30VE"), 1)) &&
         ((RegisterUpgrade(&DAT_100160d0,"AKA07VE"), 1 &&
          ((RegisterUpgrade(&DAT_10013920,"AKA20VE"), 1 &&
           (RegisterUpgrade(&DAT_100161d8,"KUZ02VE"), 1))))))))
       && ((RegisterUpgrade(&DAT_100161e0,"AKA09VE"), 1 &&
           ((((RegisterUpgrade(&DAT_10013850,"AKA05VE"), 1 &&
              (RegisterUpgrade(&DAT_10013860,"AKA28VE"), 1)) &&
             (RegisterUpgrade(&DAT_10013748,"AKA29VE"), 1)) &&
            ((RegisterUpgrade(&DAT_10013608,"KUZ05VE"), 1 &&
             (RegisterUpgrade(&DAT_100136e8,"KUZ06VE"), 1))))))))
      )) && ((((RegisterUpgrade(&DAT_10013610,"AKA34VE"), 1 &&
               ((RegisterUpgrade(&DAT_100162c8,"Bashnia(VE)PAUSE"),
                1 &&
                (RegisterUpgrade(&DAT_100162b0,"Bashnia(VE)PAUSE3"),
                1)))) &&
              (RegisterUpgrade(&DAT_100162c0,"Bashnia(VE)PAUSE4"),
              1)) &&
             ((RegisterUpgrade(&DAT_100162a0,"Bashnia(VE)PAUSE5"),
              1 &&
              (RegisterUpgrade(&DAT_100162a8,"Bashnia(VE)PAUSE6"),
              1)))))) {
    RegisterUpgrade(&DAT_10016298,"Bashnia(VE)PAUSE7");
  }
  SetPDistribution(9,4,4);
  AssignAmountOfMineUpgrades(6);
  AssignMineUpgrade(0,"shahta(VE)INSIDE",0x5a);
  AssignMineUpgrade(1,"shahta(VE)INSIDE3",0x32);
  AssignMineUpgrade(2,"shahta(VE)INSIDE4",0x32);
  AssignMineUpgrade(3,"shahta(VE)INSIDE5",0x32);
  AssignMineUpgrade(4,"shahta(VE)INSIDE6",0x32);
  AssignMineUpgrade(5,"shahta(VE)INSIDE7",0x32);
