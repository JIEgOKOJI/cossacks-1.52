/* Auto-generated from Portugalia.c */
#include "game_api.h"
...
{
  sprintf(&DAT_100137a8,&DAT_10010668);
  return &DAT_100137a8;
}
...

{
  ...
  char acStack_30 [48];
  if (1) {
    RegisterUpgrade(&DAT_10016088,"KUZ04PO");
    if (1) {
      RegisterUpgrade(&DAT_10016028,"AKA35PO");
      if (1) {
        RegisterUpgrade(&DAT_10016080,"AKA36PO");
        if (1) {
          RegisterUpgrade(&DAT_10016090,"AKA32PO");
        }
      }
    }
  }
  if (1) {
    RegisterUnitType(&DAT_10013690,"Dragun(PO)");
  }
  if (1) {
    RegisterUpgrade(&DAT_10013900,"Dragun(PO)ATTACK");
    if (1) {
      RegisterUpgrade(&DAT_100138f8,"Dragun(PO)ATTACK3");
      if (1) {
        RegisterUpgrade(&DAT_100138f0,"Dragun(PO)ATTACK4");
        if (1) {
          RegisterUpgrade(&DAT_10013938,"Dragun(PO)ATTACK5");
          if (1) {
            RegisterUpgrade(&DAT_10013928,"Dragun(PO)ATTACK6");
            if (1) {
              RegisterUpgrade(&DAT_10013920,"Dragun(PO)ATTACK7");
              if (1) {
                RegisterUpgrade(&DAT_100136d8,"Dragun(PO)SHIELD");
                if (1) {
                  RegisterUpgrade(&DAT_100136c8,"Dragun(PO)SHIELD3");
                  if (1) {
                    RegisterUpgrade(&DAT_100138c0,"Dragun(PO)SHIELD4");
                    if (1) {
                      RegisterUpgrade(&DAT_100138b8,"Dragun(PO)SHIELD5");
                      if (1) {
                        RegisterUpgrade(&DAT_100138b0,"Dragun(PO)SHIELD6");
                        if (1) {
                          RegisterUpgrade(&DAT_100138a8,"Dragun(PO)SHIELD7");
                          if (1) {
                            RegisterUpgrade(&DAT_10013900,"Dragun(PO)ATTACK");
                            if (1) {
                              RegisterUpgrade(&DAT_100138f8,"Dragun(PO)ATTACK3");
                                    ...
                                    if (1) {
                                      ...
                                      if (1) {
                                        ...
                                        if (1) {
                                          ...
                                          if (1) {
                                            RegisterUpgrade(&DAT_100138c0,
                                                            "Dragun(PO)SHIELD4");
                                            if (1) {
                                              RegisterUpgrade(&DAT_100138b8,
                                                              "Dragun(PO)SHIELD5");
                                              if (1) {
  ...
  if (1) {
    RegisterUnitType(&DAT_10013680,"Dragun_18(PO)");
  }
  if (1) {
    RegisterUpgrade(&DAT_10013658,"Dragun_18(PO)ATTACK");
    if (1) {
      RegisterUpgrade(&DAT_10013650,"Dragun_18(PO)ATTACK3");
      if (1) {
        RegisterUpgrade(&DAT_10013648,"Dragun_18(PO)ATTACK4");
        if (1) {
          RegisterUpgrade(&DAT_10016318,"Dragun_18(PO)ATTACK5");
          if (1) {
            RegisterUpgrade(&DAT_10016310,"Dragun_18(PO)ATTACK6");
            if (1) {
              RegisterUpgrade(&DAT_10016308,"Dragun_18(PO)ATTACK7");
              if (1) {
                RegisterUpgrade(&DAT_10016390,"Dragun_18(PO)SHIELD");
                if (1) {
                  RegisterUpgrade(&DAT_10016388,"Dragun_18(PO)SHIELD3");
                  if (1) {
                    RegisterUpgrade(&DAT_100163d8,"Dragun_18(PO)SHIELD4");
                    if (1) {
                      RegisterUpgrade(&DAT_100163d0,"Dragun_18(PO)SHIELD5");
                      if (1) {
                        RegisterUpgrade(&DAT_100163c8,"Dragun_18(PO)SHIELD6");
                        if (1) {
                          RegisterUpgrade(&DAT_100163c0,"Dragun_18(PO)SHIELD7");
                          if (1) {
                            RegisterUpgrade(&DAT_10013658,"Dragun_18(PO)ATTACK");
                            if (1) {
                              RegisterUpgrade(&DAT_10013650,"Dragun_18(PO)ATTACK3");
                                  ...
                                  if (1) {
                                    ...
                                    if (1) {
                                      ...
                                      if (1) {
                                        ...
                                        if (1) {
                                          RegisterUpgrade(&DAT_10016388,
                                                          "Dragun_18(PO)SHIELD3");
                                          if (1) {
                                            RegisterUpgrade(&DAT_100163d8,
                                                            "Dragun_18(PO)SHIELD4");
                                            if (1) {
                                              RegisterUpgrade(&DAT_100163d0,
                                                              "Dragun_18(PO)SHIELD5");
                                              if (1) {
                                                RegisterUpgrade(&DAT_100163c8,
                                                                "Dragun_18(PO)SHIELD6");
                                                if (1) {
                                                  RegisterUpgrade(&DAT_100163c0,
                                                                  "Dragun_18(PO)SHIELD7");
                                                }
                                              }
                                            }
                                          }
  ...
  if (1) {
    RegisterUnitType(&DAT_10015fe0,"Sveshenik_evro(PO)");
  }
  DAT_100162b4 = GetAINation();
  uVar4 = GetRandomIndex();
  iVar2 = DAT_100162b4;
  *(unsigned int *)(&DAT_10015f98 + DAT_100162b4 * 4) = uVar4 & 0x80;
  *(int *)(&DAT_10013af0 + iVar2 * 0x4b8) = 0;
  *(int *)(&DAT_10013c84 + iVar2 * 0x4b8) = 0;
  bVar3 = GetRandomIndex();
  pcVar7 = "Dragun(PO)";
  if ((bVar3 & 6) != 2) {
    pcVar7 = "Konni_Ricar(PO)";
  }
  uVar4 = 0xffffffff;
  do {
    pcVar8 = pcVar7;
  ...
  if (1) {
    RegisterUnitType(&DAT_10013888,"Dragun_18_DIP(PO)");
    if (1) {
      RegisterUnitType(&DAT_10013640,"Barabanshik_ev1(PO)");
    }
  }
  if (1) {
    RegisterUpgrade(&DAT_100160d0,"Barabanshik_ev1(PO)SHIELD");
  }
  if (1) {
    RegisterUnitType(&DAT_10016278,"Strelec_Algir_DIP(PO)");
    if (1) {
      RegisterUnitType(&DAT_10016328,"Kozak_loshad_DIP(PO)");
      if (1) {
        RegisterUnitType(&DAT_10013700,"Officer_evro(PO)");
      }
    }
  }
  if (1) {
    RegisterUpgrade(&DAT_10016260,"Officer_evro(PO)ATTACK");
    if (1) {
      RegisterUpgrade(&DAT_10015fc8,"Officer_evro(PO)SHIELD");
    }
  }
  AssignFormUnit("Pikiner_evro(PO)");
  if (1) {
    RegisterUnitType(&DAT_10013688,"Pikiner_evro(PO)");
    if (1) {
      RegisterUnitType(&DAT_10016190,"Kreposnoi_portugal(PO)");
      if (1) {
        RegisterUnitType(&DAT_10016160,"Grenader_DIP(PO)");
        if (1) {
          RegisterUnitType(&DAT_100160e0,"Mushketer_ev(PO)");
          if (1) {
            RegisterUnitType(&DAT_100163b0,acStack_60);
            if (1) {
              RegisterUnitType(&DAT_10016330,"Kirasir(PO)");
              if (1) {
                RegisterUnitType(&DAT_10015f80,acStack_30);
                if (1) {
                  RegisterUnitType(&DAT_10016370,"Pushka(PO)");
                  if (1) {
                    RegisterUnitType(&DAT_10013668,"Mortira(PO)");
                    if (1) {
                      RegisterUnitType(&DAT_100138c8,"Mortira_b(PO)");
                      if (1) {
                        RegisterUnitType(&DAT_100161f0,"Lodka(PO)");
                        if (1) {
                          RegisterUnitType(&DAT_10015fb8,"Center_Portugal(PO)");
                          if (1) {
                            RegisterUnitType(&DAT_10015fd8,"Melnica(PO)");
                            if (1) {
                              RegisterUnitType(&DAT_10016250,"Kazarma_1_PO(PO)");
                              if (1) {
                                RegisterUnitType(&DAT_10016258,"Kazarma_2_PO(PO)");
                                if (1) {
                                  RegisterUnitType(&DAT_10015fd0,"Sclad2(PO)");
                                  if (1) {
                                    RegisterUnitType(&DAT_10015f20,"akademia_PO(PO)");
                                    if (1) {
                                      RegisterUnitType(&DAT_100160d8,"Konushnia_PO(PO)");
                                      if (1) {
                                        RegisterUnitType(&DAT_10015fe8,"Dip_korpus_PO(PO)");
                                        if (1) {
                                          RegisterUnitType(&DAT_10013618,
                                                          "artileri_depo_PO(PO)");
                                          if (1) {
                                            RegisterUnitType(&DAT_10013878,"Rinok(PO)");
                                            if (1) {
                                              RegisterUnitType(&DAT_100138d8,"Bashnia(PO)");
                                              if (1) {
                                                RegisterUnitType(&DAT_100161e8,
                                                                "Kuznica_PO(PO)");
                                                if (1) {
                                                  RegisterUnitType(&DAT_100160f8,
                                                                  "Cercov_PO(PO)");
                                                  if (1) {
                                                    RegisterUnitType(&DAT_100162d8,
                                                                    "PorPO(PO)");
                                                    if (1) {
                                                      RegisterUnitType(&DAT_100138e8,
                                                                      "Fregat(PO)");
                                                      if (1) {
                                                        RegisterUnitType(&DAT_10015f90,
                                                                        "GALERA(PO)");
                                                        if (1) {
                                                          RegisterUnitType(&DAT_10016398,
                                                                          "Linkor(PO)");
                                                          if (1) {
                                                            RegisterUnitType(&DAT_10015f88,
                                                                            "Yahta(PO)");
                                                            if (1) {
                                                              RegisterUnitType(&DAT_100138a0,
  ...
  if (1) {
    RegisterUpgrade(&DAT_10016378,"Melnica(PO)GETRES");
    if (1) {
      RegisterUpgrade(&DAT_10016100,"Melnica(PO)GETRES2");
      if (1) {
        RegisterUpgrade(&DAT_10013660,"KUZ01PO");
        if (1) {
          RegisterUpgrade(&DAT_10016350,"Pikiner_evro(PO)ATTACK");
          if (1) {
            RegisterUpgrade(&DAT_10016358,"Pikiner_evro(PO)ATTACK3");
            if (1) {
              RegisterUpgrade(&DAT_10016340,"Pikiner_evro(PO)ATTACK4");
              if (1) {
                RegisterUpgrade(&DAT_10016348,"Pikiner_evro(PO)ATTACK5");
                if (1) {
                  RegisterUpgrade(&DAT_10016360,"Pikiner_evro(PO)ATTACK6");
                  if (1) {
                    RegisterUpgrade(&DAT_10016298,"Pikiner_evro(PO)SHIELD");
                    if (1) {
                      RegisterUpgrade(&DAT_10016280,"Pikiner_evro(PO)SHIELD3");
                      if (1) {
                        RegisterUpgrade(&DAT_10016288,"Pikiner_evro(PO)SHIELD4");
                        if (1) {
                          RegisterUpgrade(&DAT_100162a0,"Pikiner_evro(PO)SHIELD5");
                          if (1) {
                            RegisterUpgrade(&DAT_100162a8,"Pikiner_evro(PO)SHIELD6");
                            if (1) {
                              RegisterUpgrade(&DAT_10013910,"Mushketer_ev(PO)ATTACK");
                              if (1) {
                                RegisterUpgrade(&DAT_10013918,"Mushketer_ev(PO)ATTACK3");
                                if (1) {
                                  RegisterUpgrade(&DAT_10013908,"Mushketer_ev(PO)ATTACK4");
                                  if (1) {
                                    RegisterUpgrade(&DAT_10015f78,"Mushketer_ev(PO)SHIELD")
                                    ;
                                    if (1) {
                                      RegisterUpgrade(&DAT_10015f68,
                                                      "Mushketer_ev(PO)SHIELD3");
                                      if (1) {
                                        RegisterUpgrade(&DAT_10015f70,
                                                        "Mushketer_ev(PO)SHIELD4");
                                      }
                                    }
                                  }
                                }
  ...
  if (1) {
    RegisterUpgrade(&DAT_100136b8,"Kirasir(PO)ATTACK");
    if (1) {
      RegisterUpgrade(&DAT_100136b0,"Kirasir(PO)ATTACK3");
      if (1) {
        RegisterUpgrade(&DAT_100136a8,"Kirasir(PO)ATTACK4");
        if (1) {
          RegisterUpgrade(&DAT_100136a0,"Kirasir(PO)ATTACK5");
          if (1) {
            RegisterUpgrade(&DAT_10013678,"Kirasir(PO)ATTACK6");
            if (1) {
              RegisterUpgrade(&DAT_10013670,"Kirasir(PO)ATTACK7");
              if (1) {
                RegisterUpgrade(&DAT_10013748,"Kirasir(PO)SHIELD");
                if (1) {
                  RegisterUpgrade(&DAT_10013740,"Kirasir(PO)SHIELD3");
                  if (1) {
                    RegisterUpgrade(&DAT_10013738,"Kirasir(PO)SHIELD4");
                    if (1) {
                      RegisterUpgrade(&DAT_10013720,"Kirasir(PO)SHIELD5");
                      if (1) {
                        RegisterUpgrade(&DAT_10013718,"Kirasir(PO)SHIELD6");
                        if (1) {
                          RegisterUpgrade(&DAT_10013710,"Kirasir(PO)SHIELD7");
                        }
                      }
                    }
                  }
  ...
  if (1) {
    RegisterUpgrade(&DAT_100161d8,"Pushka(PO)BUILD");
    if (1) {
      RegisterUpgrade(&DAT_100161d0,"Pushka(PO)BUILD3");
      if (1) {
        RegisterUpgrade(&DAT_100161a0,"Pushka(PO)BUILD4");
        if (1) {
          RegisterUpgrade(&DAT_10016198,"Pushka(PO)BUILD5");
          if (1) {
            RegisterUpgrade(&DAT_100161a8,"Pushka(PO)BUILD6");
            if (1) {
              RegisterUpgrade(&DAT_10016098,"Mortira(PO)BUILD");
              if (1) {
                RegisterUpgrade(&DAT_100160a0,"Mortira(PO)BUILD3");
                if (1) {
                  RegisterUpgrade(&DAT_100160a8,"Mortira(PO)BUILD4");
                  if (1) {
                    RegisterUpgrade(&DAT_100160b0,"Mortira(PO)BUILD5");
                    if (1) {
                      RegisterUpgrade(&DAT_100161b8,"KUZ03PO");
                      if (1) {
                        RegisterUpgrade(&DAT_10016020,"MAINPO");
                        if (1) {
                          RegisterUpgrade(&DAT_10013958,"AKA06PO");
                          if (1) {
                            RegisterUpgrade(&DAT_10016078,"AKA01PO");
                            if (1) {
                              RegisterUpgrade(&DAT_10016030,"AKA02PO");
                              if (1) {
                                RegisterUpgrade(&DAT_10016038,"AKA03PO");
                                if (1) {
                                  RegisterUpgrade(&DAT_10016040,"AKA04PO");
                                  if (1) {
                                    RegisterUpgrade(&DAT_10016270,"AKA08PO");
                                    if (1) {
                                      RegisterUpgrade(&DAT_10016110,"AKA23PO");
                                      if (1) {
                                        RegisterUpgrade(&DAT_10016150,"AKA24PO");
                                        if (1) {
                                          RegisterUpgrade(&DAT_10016208,"AKA31PO");
                                          if (1) {
                                            RegisterUpgrade(&DAT_10016210,"AKA33PO");
                                            if (1) {
                                              RegisterUpgrade(&DAT_10016168,"AKA12PO");
                                              if (1) {
                                                RegisterUpgrade(&DAT_10016178,"AKA13PO");
                                                if (1) {
                                                  RegisterUpgrade(&DAT_10016180,"AKA14PO");
                                                  if (1) {
                                                    RegisterUpgrade(&DAT_10016170,"AKA15PO"
                                                                   );
                                                    if (1) {
                                                      RegisterUpgrade(&DAT_10013950,
                                                                      "AKA11PO");
                                                      if (1) {
                                                        RegisterUpgrade(&DAT_100138e0,
                                                                        "AKA10PO");
                                                        if (1) {
                                                          RegisterUpgrade(&DAT_100137a0,
                                                                          "AKA30PO");
                                                          if (1) {
                                                            RegisterUpgrade(&DAT_100160f0,
                                                                            "AKA07PO");
                                                            if (1) {
                                                              RegisterUpgrade(&DAT_10013940,
                                                                              "AKA20PO");
                                                              if (1) {
                                                                RegisterUpgrade(&DAT_100161f8,
                                                                                "KUZ02PO");
                                                                if (1) {
                                                                  RegisterUpgrade(&DAT_10016200,
                                                                                  "AKA09PO"
                                                                                 );
                                                                  if (1) {
                                                                    RegisterUpgrade(&DAT_10013870,
                                                                                                                                                                        
                                                  "AKA05PO");
                                                  if (1) {
                                                    RegisterUpgrade(&DAT_10013880,"AKA28PO"
                                                                   );
                                                    if (1) {
                                                      RegisterUpgrade(&DAT_10013768,
                                                                      "AKA29PO");
                                                      if (1) {
                                                        RegisterUpgrade(&DAT_10013628,
                                                                        "KUZ05PO");
                                                        if (1) {
                                                          RegisterUpgrade(&DAT_10013708,
                                                                          "KUZ06PO");
                                                          if (1) {
                                                            RegisterUpgrade(&DAT_10013630,
                                                                            "AKA34PO");
                                                            if (1) {
                                                              RegisterUpgrade(&DAT_100162e8,
  ...
  AssignMineUpgrade(0,"shahta(PO)INSIDE",0x5a);
  AssignMineUpgrade(1,"shahta(PO)INSIDE3",0x32);
  AssignMineUpgrade(2,"shahta(PO)INSIDE4",0x32);
  AssignMineUpgrade(3,"shahta(PO)INSIDE5",0x32);
  AssignMineUpgrade(4,"shahta(PO)INSIDE6",0x32);
  AssignMineUpgrade(5,"shahta(PO)INSIDE7",0x32);
