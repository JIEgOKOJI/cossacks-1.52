...
unsigned char DAT_100384a0[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_100384a8 (*(long long *)((char *)DAT_100384a0 + 0x8))
#define DAT_100384b0 (*(long long *)((char *)DAT_100384a8 + 0x8))
#define DAT_100384b8 (*(long long *)((char *)DAT_100384b0 + 0x8))
long long DAT_100384c0 = 0;
long long DAT_100384c8 = 0;
unsigned char DAT_100384d0[16] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_100384d8 (*(long long *)((char *)DAT_100384d0 + 0x8))
#define DAT_100384e0 (*(long long *)((char *)DAT_100384d8 + 0x8))
#define DAT_100384e8 (*(long long *)((char *)DAT_100384e0 + 0x8))
#define DAT_100384f0 (*(long long *)((char *)DAT_100384e8 + 0x8))
#define DAT_100384f8 (*(long long *)((char *)DAT_100384f0 + 0x8))
#define DAT_10038500 (*(long long *)((char *)DAT_100384f8 + 0x8))
#define DAT_10038508 (*(long long *)((char *)DAT_10038500 + 0x8))
#define DAT_10038510 (*(long long *)((char *)DAT_10038508 + 0x8))
#define DAT_10038518 (*(long long *)((char *)DAT_10038510 + 0x8))
#define DAT_10038520 (*(long long *)((char *)DAT_10038518 + 0x8))
...
uVar1 = Trigg(100);
  ...
  uVar1 = Trigg(0x4d);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_10038a98);
    if (iVar13 == 0) {
      SetTrigg(0x4d,0);
  ...
  uVar1 = Trigg(0x53);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_10038b70);
    if (iVar13 < 0x12) {
      SetTrigg(0x53,0);
...
LAB_10004e48:
  ...
  if ((uVar1 & 0xff) != 0) {
    uVar1 = Trigg(0x5c);
    if ((uVar1 & 0xff) == 0) {
      iVar13 = GetTotalAmount0(&DAT_10038a88);
      if (iVar13 == 0) {
        iVar13 = GetTotalAmount0(&DAT_10038a60);
        if (iVar13 == 0) {
          iVar13 = GetTotalAmount0(&DAT_10038928);
          if (iVar13 == 0) {
...
LAB_10006204:
  ...
  if ((uVar1 & 0xff) != 0) {
    uVar1 = Trigg(0x42);
    if ((uVar1 & 0xff) == 0) {
      iVar13 = GetTotalAmount0(&DAT_100384e8);
      if (iVar13 == 0) {
        iVar13 = GetTotalAmount0(&DAT_100384e0);
        if (iVar13 == 0) {
          iVar13 = GetTotalAmount0(&DAT_100384d8);
          if (iVar13 == 0) {
            iVar13 = GetTotalAmount0(&DAT_100384d0);
            if (iVar13 == 0) {
              iVar13 = GetTotalAmount0(&DAT_10038518);
              if (iVar13 == 0) {
                iVar13 = GetTotalAmount0(&DAT_10038510);
                if (iVar13 == 0) {
                  iVar13 = GetTotalAmount0(&DAT_10038500);
                  if (iVar13 == 0) {
                    iVar13 = GetTotalAmount0(&DAT_100384f0);
                    if (iVar13 == 0) {
                      iVar13 = GetTotalAmount0(&DAT_100384b0);
                      if (iVar13 == 0) {
                        iVar13 = GetTotalAmount0(&DAT_100384a8);
                        if (iVar13 == 0) {
                          iVar13 = GetTotalAmount0(&DAT_10038508);
                          if (iVar13 == 0) {
                            iVar13 = GetTotalAmount0(&DAT_100384f8);
                            if (iVar13 == 0) {
                              SetTrigg(0x66,0);
                              DisableMission(0x58);
                              EnableMission(0x59);
  ...
  uVar1 = Trigg(0xfa);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount1(&DAT_100388c0,0);
    if (0 < iVar13) {
      SetTrigg(0xfa,0);
      SetTrigg(0xfb,0);
...
LAB_10007b4a:
  ...
  uVar1 = Trigg(0x15);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_10038918);
    if (iVar13 == 0) {
      SetTrigg(0x15,0);
      ShowPage("#PAGE19");
    }
  ...
  uVar1 = Trigg(0x14);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_10038560);
    if (iVar13 == 0) {
      SetTrigg(0x14,0);
      ShowPage("#PAGE19");
    }
  ...
  uVar1 = Trigg(0x13);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_100389b8);
    if (iVar13 == 0) {
      SetTrigg(0x13,0);
      ShowPage("#PAGE19");
    }
...
LAB_10008808:
  ...
  uVar1 = Trigg(0xc9);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_10038ab8);
    if (iVar13 == 0) {
      uVar1 = Trigg(0x4b);
      if ((uVar1 & 0xff) != 0) {
        SetTrigg(0xc9,0);
  ...
  uVar1 = Trigg(0xca);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_10038528);
    if (iVar13 < 3) {
      uVar1 = Trigg(0x51);
      if ((uVar1 & 0xff) != 0) {
        SetTrigg(0xca,0);
  ...
  uVar1 = Trigg(0xcb);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_10038a28);
    iVar2 = GetTotalAmount0(&DAT_10038a10);
    iVar3 = GetTotalAmount0(&DAT_10038a58);
    iVar4 = GetTotalAmount0(&DAT_10038940);
    iVar5 = GetTotalAmount0(&DAT_10038a48);
    iVar6 = GetTotalAmount0(&DAT_10038a30);
    iVar7 = GetTotalAmount0(&DAT_10038b08);
    iVar8 = GetTotalAmount0(&DAT_10038ae8);
    iVar9 = GetTotalAmount0(&DAT_10038b10);
    iVar10 = GetTotalAmount0(&DAT_10038ad8);
    iVar11 = GetTotalAmount0(&DAT_10038af0);
    iVar12 = GetTotalAmount0(&DAT_100389e0);
  ...
  uVar1 = Trigg(0xcc);
  if ((uVar1 & 0xff) != 0) {
    iVar13 = GetTotalAmount0(&DAT_10038498);
    iVar2 = GetTotalAmount0(&DAT_10038990);
    iVar3 = GetTotalAmount0(&DAT_10038930);
    iVar4 = GetTotalAmount0(&DAT_100389a8);
    iVar5 = GetTotalAmount0(&DAT_100384c8);
    iVar6 = GetTotalAmount0(&DAT_10038968);
    iVar7 = GetTotalAmount0(&DAT_10038980);
    iVar8 = GetTotalAmount0(&DAT_10038950);
    iVar9 = GetTotalAmount0(&DAT_10038490);
