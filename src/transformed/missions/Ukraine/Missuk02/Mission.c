...
void FUN_100071d0(int param_1);
void FUN_10007220(int param_1,char param_2);
...
void __cdecl FUN_10007220(int param_1,char param_2)
...
LAB_100048fa:
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if ((uVar1 & 0xff) != 0) {
      FUN_10007220(&DAT_10034630,0);
      if (iVar2 == 0) {
        FUN_10007220(&DAT_10034638,0);
        if (iVar2 == 0) {
          FUN_10007220(&DAT_10034620,0);
          if (iVar2 == 0) {
            FUN_10007220(&DAT_100345f8,0);
            if (iVar2 == 0) {
              SetTrigg(0xe,0);
              ShowPage("#PAGE17");
              LooseGame();
