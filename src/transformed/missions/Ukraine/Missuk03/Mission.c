...
void FUN_10008ec0(int param_1);
void FUN_10008f10(int param_1,char param_2);


void __cdecl FUN_10008ec0(int param_1)
...
void __cdecl FUN_10008f10(int param_1,char param_2)
...
LAB_10002d80:
  ...
  uVar1 = Trigg(0x5a);
  if ((uVar1 & 0xff) != 0) {
    FUN_10008ec0(&DAT_10036420);
    if (iVar4 != 0) {
      FUN_10008ec0(&DAT_10036758);
...
LAB_10003862:
  uVar1 = Trigg(0x59);
  if ((uVar1 & 0xff) != 0) {
    FUN_10008ec0(&DAT_10036428);
    if (iVar4 == 0) {
      FUN_10008ec0(&DAT_10036768);
      if (iVar4 == 0) {
        SetTrigg(0x59,0);
        SetTrigg(0x5a,0);
      }
  ...
  if ((uVar1 & 0xff) != 0) {
    uVar1 = Trigg(0x32);
    if ((uVar1 & 0xff) == 0) {
      FUN_10008ec0(&DAT_10036400);
      if (iVar4 == 0) {
        FUN_10008ec0(&DAT_10036418);
        if (iVar4 == 0) {
          SetTrigg(0x2f,0);
          ShowPage("#PAGE13");
          ShowPage("#PAGE14");
...
LAB_10006671:
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if ((uVar1 & 0xff) != 0) {
      FUN_10008ec0(&DAT_100367d0);
      FUN_10008ec0(&DAT_100367e0);
      FUN_10008ec0(&DAT_100368a0);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if ((uVar1 & 0xff) != 0) {
      FUN_10008f10(&DAT_100366b8,0);
      if (iVar4 == 0) {
        FUN_10008f10(&DAT_100366c0,0);
        if (iVar4 == 0) {
          FUN_10008f10(&DAT_100366a0,0);
          if (iVar4 == 0) {
            FUN_10008f10(&DAT_100366a8,0);
            if (iVar4 == 0) {
              SetTrigg(0x10,0);
              ShowPage("#PAGE24");
              LooseGame();
...
LAB_10007968:
  uVar1 = Trigg(0x11);
  if ((uVar1 & 0xff) != 0) {
    FUN_10008ec0(&DAT_10036880);
    if (iVar4 != 0) {
      FUN_10008ec0(&DAT_10036890);
