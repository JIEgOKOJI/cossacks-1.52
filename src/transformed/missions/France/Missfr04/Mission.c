...
uVar1 = Trigg(1);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if ((uVar1 & 0xff) != 0) {
      ...
      if (iVar2 == 0) {
        GetTotalAmount1(&DAT_1002f3e0,0);
        if (iVar2 == 0) {
          GetTotalAmount1(&DAT_1002f3e8,0);
          if (iVar2 == 0) {
            SetTrigg(6,0);
            ShowPage("#PAGE6");
            LooseGame();
    ...
    uVar1 = Trigg(7);
    if ((uVar1 & 0xff) != 0) {
      GetTotalAmount1(&DAT_1002f430,1);
      if (iVar2 == 0) {
        GetTotalAmount1(&DAT_1002f3e0,1);
        if (iVar2 == 0) {
          GetTotalAmount1(&DAT_1002f3e8,1);
          if (iVar2 == 0) {
            SetTrigg(7,0);
            ShowPage("#PAGE7");
          }
    ...
    uVar1 = Trigg(8);
    if ((uVar1 & 0xff) != 0) {
      GetTotalAmount1(&DAT_1002f430,2);
      if (iVar2 == 0) {
        GetTotalAmount1(&DAT_1002f3e0,2);
        if (iVar2 == 0) {
          GetTotalAmount1(&DAT_1002f3e8,2);
          if (iVar2 == 0) {
            SetTrigg(8,0);
            ShowPage("#PAGE8");
          }
