...
void FUN_10002330(int param_1,char param_2);


void __cdecl FUN_100022e0(int param_1)
...
uVar1 = Trigg(1);
  ...
  uVar1 = Trigg(6);
  if ((uVar1 & 0xff) != 0) {
    FUN_100022e0(&DAT_1002f3f8);
    if (iVar3 == 0) {
      FUN_100022e0(&DAT_1002f408);
      FUN_100022e0(&DAT_1002f418);
      if (iVar3 == iVar2) {
        FUN_10002330(&DAT_1002f420,1);
        if (iVar3 == 0) {
          SetTrigg(6,0);
          uVar1 = Trigg(7);
          if ((uVar1 & 0xff) == 0) {
