...
uVar1 = Trigg(1);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (iVar3 == iVar2) {
      ...
      iVar2 = GetTotalAmount0(&DAT_1002f4d0);
      if (iVar3 == iVar2) {
  ...
  if (0 < iVar3) {
    iVar3 = GetTotalAmount0(&DAT_1002f418);
    if (0 < iVar3) {
  ...
  if (0 < iVar3) {
    iVar3 = GetTotalAmount0(&DAT_1002f4a8);
    if (0 < iVar3) {
  ...
  if (0 < iVar3) {
    iVar3 = GetTotalAmount0(&DAT_1002f4c0);
    if (0 < iVar3) {
  ...
  if ((uVar1 & 0xff) != 0) {
    uVar1 = Trigg(0x25);
    if ((uVar1 & 0xff) != 0) {
      iVar3 = GetTotalAmount1(&DAT_1002f4a0,0);
      iVar2 = GetTotalAmount0(&DAT_1002f4d0);
      if (iVar3 == iVar2) {
        iVar3 = GetTotalAmount1(&DAT_1002f4a0,0);
        if (0 < iVar3) {
  ...
  uVar1 = Trigg(3);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount1(&DAT_1002f4d8,0);
    if (0 < iVar3) {
      SetTrigg(3,0);
      ShowPage("#PAGE3");
  ...
  uVar1 = Trigg(4);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount0(&DAT_1002f4c8);
    if (iVar3 == 0) {
      SetTrigg(4,0);
      ShowPage("#PAGE4");
      ShowVictory();
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (0 < iVar3) {
      iVar3 = GetTotalAmount0(&DAT_1002f4b8);
      if (0 < iVar3) {
        SetTrigg(6,0);
        ShowPage("#PAGE6");
