...
uVar1 = Trigg(1);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (3 < iVar3) {
      iVar3 = GetTotalAmount0(&DAT_1002f400);
      if (0 < iVar3) {
        iVar3 = GetTotalAmount0(&DAT_1002f438);
        if (0 < iVar3) {
          SetTrigg(4,0);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (3 < iVar3) {
      ...
      if (0 < iVar3) {
        iVar3 = GetTotalAmount0(&DAT_1002f448);
        if (0 < iVar3) {
          SetTrigg(5,0);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (3 < iVar3) {
      ...
      if (0 < iVar3) {
        iVar3 = GetTotalAmount0(&DAT_1002f440);
        if (0 < iVar3) {
          SetTrigg(6,0);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (3 < iVar3) {
      ...
      if (0 < iVar3) {
        iVar3 = GetTotalAmount0(&DAT_1002f450);
        if (0 < iVar3) {
          SetTrigg(7,0);
