...
uVar1 = Trigg(1);
  ...
  if ((0 < iVar3) && (iVar3 = GetTotalAmount0(&DAT_100303f0), 0 < iVar3)) {
    AttackEnemyInZone(&DAT_100303f0,&DAT_10030468,0);
  }
  uVar1 = Trigg(3);
  if (((uVar1 & 0xff) != 0) && (iVar3 = GetTotalAmount0(&DAT_100303f0), iVar3 == 0)) {
    SetTrigg(3,0);
    ShowPage("#PAGE3");
    DisableMission(0x43);
    EnableMission(0x45);
  ...
  if ((0 < iVar3) && (iVar3 = GetTotalAmount0(&DAT_10030408), 0 < iVar3)) {
    AttackEnemyInZone(&DAT_10030408,&DAT_10030470,0);
  }
  uVar1 = Trigg(0x32);
  if (((uVar1 & 0xff) != 0) && (iVar3 = GetTotalAmount0(&DAT_10030408), iVar3 < 7)) {
    SetTrigg(0x32,0);
    ClearSelection(1);
  ...
  if ((0 < iVar3) && (iVar3 = GetTotalAmount0(&DAT_10030400), 0 < iVar3)) {
    AttackEnemyInZone(&DAT_10030400,&DAT_10030478,0);
  }
  uVar1 = Trigg(5);
  if (((uVar1 & 0xff) != 0) && (iVar3 = GetTotalAmount0(&DAT_10030400), iVar3 == 0)) {
    SetTrigg(5,0);
    ShowPage("#PAGE5");
    DisableMission(0x42);
    EnableMission(0x44);
    iVar3 = GetTotalAmount0(&DAT_100304f0);
    if (0 < iVar3) {
  ...
  if ((0 < iVar3) && (iVar3 = GetTotalAmount0(&DAT_10030418), 0 < iVar3)) {
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if ((iVar2 / 2 < iVar3) && (iVar3 = GetTotalAmount0(&DAT_10030410), 8 < iVar3)) {
      SetTrigg(7,0);
      ShowPage("#PAGE7");
      DisableMission(0x4b);
      EnableMission(0x4c);
  ...
  uVar1 = Trigg(8);
  if (((uVar1 & 0xff) != 0) && (iVar3 = GetTotalAmount0(&DAT_10030410), iVar3 < 9)) {
    SetTrigg(8,0);
    ShowPage("#PAGE8");
    LooseGame();
  }
  iVar3 = GetUnitsAmount0(&DAT_100304a0,0);
  if ((0 < iVar3) && (iVar3 = GetTotalAmount0(&DAT_10030420), 0 < iVar3)) {
    AttackEnemyInZone(&DAT_10030420,&DAT_100304a0,0);
  }
  uVar1 = Trigg(9);
  if (((uVar1 & 0xff) != 0) && (iVar3 = GetTotalAmount0(&DAT_10030420), iVar3 < 4)) {
    SetTrigg(9,0);
    ShowPage("#PAGE9");
  }
  uVar1 = Trigg(10);
  if (((uVar1 & 0xff) != 0) && (iVar3 = GetTotalAmount0(&DAT_100303e8), iVar3 == 0)) {
    SetTrigg(10,0);
  ...
  if ((0 < iVar3) && (iVar3 = GetTotalAmount0(&DAT_100304c8), 0 < iVar3)) {
    AttackEnemyInZone(&DAT_100304c8,&DAT_10030450,0);
  }
  uVar1 = Trigg(0xe);
  if (((uVar1 & 0xff) != 0) && (iVar3 = GetTotalAmount1(&DAT_100304f8,0), 0 < iVar3)) {
    SetTrigg(0xe,0);
    ShowPage("#PAGE14");
    DisableMission(0x48);
    EnableMission(0x4a);
  ...
  uVar1 = Trigg(0xe);
  if (((uVar1 & 0xff) != 0) && (iVar3 = GetTotalAmount0(&DAT_100304b8), iVar3 == 0)) {
    SetTrigg(0xe,0);
    ShowPage("#PAGE14A");
    DisableMission(0x48);
    EnableMission(0x4a);
