...
LAB_10001c59:
  ...
  uVar1 = Trigg(5);
  if ((uVar1 & 0xff) != 0) {
    iVar2 = GetTotalAmount0(&DAT_100303f0);
    if (0 < iVar2) {
      SetTrigg(5,0);
...
LAB_10001f8f:
    ...
    if ((uVar1 & 0xff) == 0) {
      iVar2 = GetTotalAmount0(&DAT_100303f0);
      if (0 < iVar2) {
        iVar2 = GetTotalAmount0(&DAT_100304c0);
        if (0 < iVar2) {
          SelectUnits(&DAT_100303f0,0);
...
LAB_1000277c:
  ...
  uVar1 = Trigg(0x12);
  if ((uVar1 & 0xff) == 0) {
    iVar2 = GetTotalAmount0(&DAT_10030450);
    if (0 < iVar2) {
      iVar2 = GetTotalAmount0(&DAT_10030448);
      if (0 < iVar2) {
        SelectUnits(&DAT_10030448,0);
  ...
  uVar1 = Trigg(0x14);
  if ((uVar1 & 0xff) == 0) {
    iVar2 = GetTotalAmount0(&DAT_10030508);
    if (0 < iVar2) {
      iVar2 = GetTotalAmount0(&DAT_10030448);
      if (0 < iVar2) {
        SelectUnits(&DAT_10030448,0);
  ...
  uVar1 = Trigg(0x16);
  if ((uVar1 & 0xff) == 0) {
    iVar2 = GetTotalAmount0(&DAT_10030510);
    if (0 < iVar2) {
      iVar2 = GetTotalAmount0(&DAT_10030448);
      if (0 < iVar2) {
        SelectUnits(&DAT_10030448,0);
  ...
  uVar1 = Trigg(0x18);
  if ((uVar1 & 0xff) == 0) {
    iVar2 = GetTotalAmount0(&DAT_10030518);
    if (0 < iVar2) {
      iVar2 = GetTotalAmount0(&DAT_10030448);
      if (0 < iVar2) {
        SelectUnits(&DAT_10030448,0);
