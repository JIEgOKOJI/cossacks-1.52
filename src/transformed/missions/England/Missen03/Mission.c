...
uVar1 = Trigg(1);
  ...
  if ((uVar1 & 0xff) == 0) {
    uVar1 = Trigg(6);
    if ((uVar1 & 0xff) != 0) {
      FUN_100045d0(&DAT_10031418);
      if (iVar3 == 0) {
        SetTrigg(6,0);
        FUN_100045d0(&DAT_100313f0);
        if (iVar3 == 0) {
          FUN_100045d0(&DAT_10031400);
          if (iVar3 == 0) {
            ShowPage("#PAGE6");
