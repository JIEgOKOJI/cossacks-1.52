...
uVar1 = Trigg(100);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if ((uVar1 & 0xff) != 0) {
      ...
      iVar2 = GetTotalAmount0(&DAT_10031430);
      if (iVar3 == iVar2) {
        SetTrigg(1,0);
        SelectUnits(&DAT_10031430,0);
  ...
  uVar1 = Trigg(0x1f);
  if ((uVar1 & 0xff) == 0) {
    iVar3 = GetTotalAmount0(&DAT_100315b0);
    if (iVar3 == 0) {
      uVar1 = Trigg(0xe);
      if ((uVar1 & 0xff) != 0) {
        uVar1 = Trigg(0xd);
  ...
  if (140000 < iVar3) {
    uVar1 = Trigg(0x28);
    if ((uVar1 & 0xff) != 0) {
      iVar3 = GetTotalAmount1(&DAT_10031570,5);
      if (0 < iVar3) {
        SetTrigg(0x28,0);
        ShowPage("#PAGE15");
  ...
  uVar1 = Trigg(4);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount0(&DAT_100315c0);
    if (iVar3 == 0) {
      iVar3 = GetTotalAmount0(&DAT_100315a8);
      if (iVar3 == 0) {
        SetTrigg(4,0);
        ShowPage("#PAGE4");
        AddResource(0,1,1000);
  ...
  uVar1 = Trigg(0xb);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount0(&DAT_10031440);
    if (iVar3 == 0) {
...
LAB_10003695:
  ...
  uVar1 = Trigg(0x13);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount1(&DAT_10031578,0);
    if (iVar3 == 0) {
  ...
  uVar1 = Trigg(0x14);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount0(&DAT_10031598);
    if (iVar3 == 0) {
      SetTrigg(0x14,0);
      ShowPage("#PAGE20");
    }
