...
int DAT_10036d88 = 0;
long long DAT_10036d90 = 0;
long long DAT_10036d98 = 0;
...
local_1c = &DAT_10036d90 + param_1 * 0x10;
  local_20 = GetUnitsAmount0(&DAT_10036d90 + param_1 * 0x10,0);
  local_24 = param_1 + -1;
  if (local_24 < 0) {
    local_24 = 0x13;
  }
...
uVar1 = Trigg(99);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    for (local_c = 0; local_c < 0xd; local_c = local_c + 1) {
      uVar6 = 0;
      ProcessScenary((int)(&DAT_10036818 + local_c * 0x28));
...
local_8 = param_1;
  ...
  if (cVar1 != '\0') {
    ...
    if (iVar2 < 10) {
      FUN_100039a0(local_8,*(int *)((int)local_8 + 0x20));
    }
  }
...
if (((*(char *)((int)param_1 + 0x2c) != '\0') &&
    ...
    if (*(int *)((int)local_8 + 0x10) == 6) {
      ...
      FUN_10003a90((int)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        FUN_10004380(*(short **)((int)local_8 + 0x20));
...
*(int *)((int)this_ptr + 4) = param_1;
  (&DAT_1003707c)[DAT_100370cc] = this_ptr;
...
local_8 = DAT_1003707c;
  for (local_c = 0; local_c < DAT_100370cc; local_c = local_c + 1) {
    psVar1 = (short *)FUN_10004550((&DAT_1003707c)[local_c]);
    if (*psVar1 == *param_1) {
...
local_8 = this_ptr;
  ...
  FUN_100039a0(param_1,*(int *)((int)local_8 + 8));
...
local_8 = param_2;
  ...
  *(int **)(param_1 + 8) = &DAT_10036d90 + local_8 * 0x10;
  *(int **)(param_1 + 0xc) = &DAT_10036d98 + local_8 * 0x10;
  local_8 = local_8 + 1;
  if (0x13 < local_8) {
    local_8 = 0;
  }
  *(int **)(param_1 + 0x10) = &DAT_10036d90 + local_8 * 0x10;
  *(int **)(param_1 + 0x14) = &DAT_10036d98 + local_8 * 0x10;
  local_8 = local_8 + 1;
  if (0x13 < local_8) {
    local_8 = 0;
  }
  *(int **)(param_1 + 0x18) = &DAT_10036d90 + local_8 * 0x10;
  *(int **)(param_1 + 0x1c) = &DAT_10036d98 + local_8 * 0x10;
  local_8 = local_8 + 1;
  if (0x13 < local_8) {
    local_8 = 0;
  }
  *(int **)(param_1 + 0x20) = &DAT_10036d90 + local_8 * 0x10;
  *(int **)(param_1 + 0x24) = &DAT_10036d98 + local_8 * 0x10;
  return;
}
