...
long long DAT_100127c8 = 0;
long long DAT_100127cc = 0;
int DAT_100127d0 = 0;
long long DAT_100127d1 = 0;
int DAT_100127d5 = 0;
long long DAT_100127e0 = 0;
long long DAT_100127e4 = 0;
int DAT_100127e8 = 0;
long long DAT_100127e9 = 0;
int DAT_100127ed = 0;
long long DAT_100127f8 = 0;
long long DAT_100127fc = 0;
int DAT_10012800 = 0;
long long DAT_10012801 = 0;
int DAT_10012805 = 0;
int DAT_10012810 = 0;
...
int DAT_10012835 = 0;
long long DAT_10012840 = 0;
long long DAT_10012849 = 0;
long long DAT_10012882 = 0;
long long DAT_10012948 = 0;
...
int FUN_1000392f() { return 0; }
int FUN_10003c0c() { return 0; }
int FUN_100040f3() { return 0; }
...
int FUN_10001eb0(int param_1,int param_2);
...
void FUN_100037e0(int param_1,int param_2,char param_3);
void FUN_10003900(DWORD param_1);
void FUN_10003a0b(int *param_1);
int FUN_10003b56(int *param_1,int param_2,int param_3,int param_4,
...
int __cdecl
FUN_10003b56(int *param_1,int param_2,int param_3,int param_4,
            int param_5,int param_6,int param_7)
...
switchD_10001625_default:
  ...
  if (DAT_10012b04 == 0) {
    ...
    do {
      ...
      iVar2 = FUN_10002440((unsigned int)puVar6,0x10012af0,1,0);
      if ((char)iVar2 == '\0') {
  ...
  if (DAT_10012b04 == 1) {
    ...
    do {
      ...
      iVar2 = FUN_10002440((unsigned int)(puVar6 + -0x42),0x10012af0,1,0);
      if ((char)iVar2 == '\0') {
      ...
      iVar2 = FUN_10002440((unsigned int)(puVar6 + 0x84),0x10012af0,1,0);
      if ((char)iVar2 == '\0') {
