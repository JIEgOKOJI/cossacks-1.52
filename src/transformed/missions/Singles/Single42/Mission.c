...
int FUN_10001540(unsigned int param_1);
...
while (iVar1 = FUN_10001230((intptr_t)local_18), iVar1 != 0) {
  ...
  local_20 = (int *)FUN_100029d0((void *)0x34);
  local_8 = 0;
  if (local_20 == (int *)0x0) {
    local_24 = 0;
  }
    ...
    local_24 = FUN_10001140(local_20);
  }
  local_1c = local_24;
  local_8 = -1;
...
int __cdecl FUN_100029d0(void *param_1)
