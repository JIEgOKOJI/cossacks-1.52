...
void  FUN_10002d30(int param_1);
void  FUN_10002d90(int param_1);
int  FUN_10002df0(int param_1);
void  FUN_10002e20(int param_1);
...
if (DAT_100390a8 != '\0') {
    ...
    if (0 < iVar5) {
      ...
      if ((uVar2 & 0xff) == 0) {
        for (local_10 = 0; local_10 < 0xc; local_10 = local_10 + 1) {
          ...
          (&DAT_10038a10)[local_10] = (char)local_10;
        }
        SetTrigg(3,0);
      }
      else {
        for (local_c = 0; local_c < 0x18; local_c = local_c + 1) {
          ...
          (&DAT_10038a10)[local_c] = (char)local_c;
        }
      }
      SetTrigg(2,0);
    }
    ...
    if ((uVar2 & 0xff) != 0) {
      ...
      while( 1 ) {
        ...
        if ((&DAT_10038a10)[local_18] != -1) {
          FUN_100057c0((int)(&DAT_10038a28 +
                                          (unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25));
          uVar7 = (int)DAT_10038a08;
          if (cVar1 != '\0') {
            if ((&DAT_10038a34)[(unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25] == '\x01') {
              FUN_10005490(&DAT_10038a28 + (unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25,
                                 DAT_10038a08,DAT_10038a0c,0x46);
              FUN_10005870(&DAT_10038a28 +
                                                 (unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25,
                                                 local_38);
              DAT_10038a08 = *piVar3;
              ...
              FUN_10005280(&DAT_10038a28 + (unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25);
            }
            iVar5 = FUN_10005830((int)(&DAT_10038a28 +
                                            (unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25));
            iVar5 = GetUnitsAmount1(&DAT_10038f90,iVar5);
            iVar4 = FUN_10005830((int)(&DAT_10038a28 +
                                            (unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25));
            iVar4 = GetTotalAmount0(iVar4);
            uVar7 = (int)DAT_10038a08;
            if (iVar5 == iVar4) {
              (&DAT_10038a34)[(unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25] = 3;
              uVar8 = 0;
              iVar5 = FUN_10005830((int)(&DAT_10038a28 +
                                              (unsigned int)(byte)(&DAT_10038a10)[local_18] * 0x25));
  ...
  if ((uVar2 & 0xff) != 0) {
    for (local_1c = 0; local_1c < 8; local_1c = local_1c + 1) {
      OnInit();
      *(int *)(&DAT_10038978 + local_1c * 0x14) = uVar8;
    }
    RunTimer(3,2000);
  }
  ...
  if ((uVar2 & 0xff) != 0) {
    for (local_20 = 0; local_20 < 8; local_20 = local_20 + 1) {
      FUN_100059a0((int)(&DAT_10038968 + local_20 * 0x14));
    }
    RunTimer(4,100);
  }
  uVar2 = Trigg(8);
  ...
  if ((uVar2 & 0xff) != 0) {
    ...
    for (local_28 = 0; local_28 < 0x18; local_28 = local_28 + 1) {
      if ((&DAT_10038a34)[local_28 * 0x25] == '\x03') {
        iVar5 = FUN_10005830((int)(&DAT_10038a28 + local_28 * 0x25));
...
local_8 = param_1;
  ...
  if (cVar1 != '\0') {
    ...
    if (iVar2 < 10) {
      FUN_10003440(local_8,*(int *)((int)local_8 + 0x20));
    }
  }
...
if (((*(char *)((int)param_1 + 0x2c) != '\0') &&
    ...
    if (*(int *)((int)local_8 + 0x10) == 6) {
      ...
      FUN_10003530((int)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        FUN_10003e20(*(short **)((int)local_8 + 0x20));
...
*(int *)((int)this_ptr + 4) = param_1;
  (&DAT_1003921c)[DAT_1003926c] = this_ptr;
...
local_8 = DAT_1003921c;
  for (local_c = 0; local_c < DAT_1003926c; local_c = local_c + 1) {
    psVar1 = (short *)FUN_10003ff0((&DAT_1003921c)[local_c]);
    if (*psVar1 == *param_1) {
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  FUN_10003900(param_1,*(int *)((int)this_ptr + 0xc),*(int *)((int)this_ptr + 0x10));
  FUN_10003440(param_1,*(int *)((int)local_8 + 8));
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  bVar1 = FUN_100047c0((int)this_ptr);
  if (bVar1) {
    local_8[2] = param_1;
    *local_8 = param_2;
    local_8[1] = param_3;
...

{
  ...
  void *local_8;
local_8 = param_1;
  FUN_100057c0((int)param_1);
  if (cVar1 != '\0') {
    if (*(char *)((int)local_8 + 0xc) == '\x01') {
      uVar4 = 500;
      FUN_10005870(local_8,local_10);
      FUN_10005620((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        *(char *)((int)local_8 + 0xc) = 2;
      }
      else {
        FUN_10005720((int)local_8);
        if (cVar1 == '\0') {
          SelectUnits((int)local_8 + 0xd,0);
          SelSendTo(DAT_10036a30,(int)local_8 + 0x1d,*(char *)((int)local_8 + 8),0);
        }
      }
    }
    if (*(char *)((int)local_8 + 0xc) == '\x02') {
      ...
      if (iVar3 < 1) {
        SelectUnits((int)local_8 + 0xd,0);
        SelSendTo(DAT_10036a30,DAT_1003927c,*(char *)((int)local_8 + 8),0);
      }
      else {
...
local_c = param_1;
  ...
  FUN_100064c4(*(int*)((char*)&local_28 + 4),(int)local_28);
  lVar5 = 0;
  local_14 = (void *)lVar5;
  FUN_10005620((int)local_8 + 0x1d,local_18,local_14,100);
...
local_8 = this_ptr;
  ...
  FUN_10005c40(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  ...
  FUN_10005c40(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_2,param_3);
...
DAT_100390a8 = 1;
  ...
  for (local_14 = 0; local_14 < 0x18; local_14 = local_14 + 1) {
    ...
    FUN_10005220(&DAT_10038a28 + local_14 * 0x25,local_10);
  ...
  for (local_14 = 0; local_14 < 8; local_14 = local_14 + 1) {
    ...
    FUN_10005ae0(&DAT_10038968 + local_14 * 0x14,local_10);
