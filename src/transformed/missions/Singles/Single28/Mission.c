...

{
  ...
  ShowPageParam("#PAGE131",(int)&DAT_10011540 + (int)pvVar5 * 0xf,100,
...

{
  ...
  if (iVar3 == 0) {
    ...
    if (iVar3 == 1) {
      ...
      if (iVar3 == 0) {
        FUN_100024a0(pvVar1,*(int *)((int)param_1 + 0x2d7),(char *)((int)param_1 + 0x2c0),
                     *(int *)((int)param_1 + 0x2cf),
                     (int)*(char *)((int)param_1 + 0x313)
                     ,*(int *)((int)param_1 + 0x2d3));
      }
...

{
  ...
  uVar1 = (int)*(char *)((int)param_1 + 0x321);
  if (*(char *)((int)param_1 + 0x321) != '\0') {
    iVar2 = GetUnitsAmount2(*(int *)((int)param_1 + 0x2d3),&DAT_100100d8,
                            (int)*(char *)((int)param_1 + 0x313));
    uVar1 = 0;
    if (iVar2 != 0) {
      iVar2 = 0;
      ...
      do {
        if (*(char *)((int)pvVar8 + 0x19) == '\0') {
          iVar3 = GetUnitsAmount1(*(int *)((int)param_1 + 0x2d3),pvVar8);
          if (iVar3 != 0) {
        ...
        if (*piVar7 != 0) {
          ...
          do {
            if (*(char *)(*piVar7 + iVar9 + 0x19) != '\0') {
              iVar4 = GetUnitsAmount1(*(int *)((int)param_1 + 0x2d3),*piVar7 + iVar9);
              if (iVar4 != 0) {
                iVar3 = iVar3 * 0x44;
                *(char *)(*(int *)((int)param_1 + uStack_8 * 4 + 0x2ac) + 0x19 + iVar3) = 0;
...
LAB_1000336a:
        ...
        iVar1 = iVar7 * 0xf;
        strncpy((char *)((int)&DAT_10011540 + iVar1),(char *)(iVar9 + (int)puVar4),sVar6);
        iVar7 = iVar7 + 1;
        *(char *)((int)&DAT_10011540 + sVar6 + iVar1) = 0;
      } while (iVar7 < 6);
      iVar7 = 0;
      do {
        if (iVar7 == 0) {
...
LAB_1000342c:
        ...
        sVar6 = FUN_10004f40((byte *)(iVar9 + (int)puVar4),&DAT_1000c744);
        iVar1 = iVar7 * 0xf;
        strncpy((char *)((int)&DAT_1000f8c8 + iVar1),(char *)(iVar9 + (int)puVar4),sVar6);
        iVar7 = iVar7 + 1;
        *(char *)((int)&DAT_1000f8c8 + sVar6 + iVar1) = 0;
      } while (iVar7 < 9);
