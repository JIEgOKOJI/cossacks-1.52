...
unsigned char DAT_10022570[120] = {0};
unsigned char DAT_100225e8[120] = {0};
unsigned char DAT_10022660[120] = {0};
unsigned char DAT_100226d8[120] = {0};
...
unsigned char DAT_100227d8[120] = {0};
unsigned char DAT_10022850[120] = {0};
unsigned char DAT_100228c8[120] = {0};
...
void  FUN_100030d0(intptr_t param_1);
...
BOOL  FUN_100032f0(intptr_t param_1);
...

{
  ...
  *(int *)((intptr_t)this_ptr + 0x40) = param_1[1];
...
{
  *(int *)((intptr_t)this_ptr + 0x28) = *param_1;
  *(int *)((intptr_t)this_ptr + 0x2c) = param_1[1];
  *(int *)((intptr_t)this_ptr + 0x30) = param_2;
  *(int *)((intptr_t)this_ptr + 0x34) = param_3;
  return;
}
...
{
  *(int *)((intptr_t)this_ptr + 0x30) = param_1 * *(int *)((intptr_t)this_ptr + 0x30);
  return;
}
...
{
  *(int *)((intptr_t)this_ptr + 0x30) = *(int *)((intptr_t)this_ptr + 0x30) / param_1;
  return;
}
...
{
  *(int *)((intptr_t)this_ptr + 0x44) = param_1 * *(int *)((intptr_t)this_ptr + 0x44);
  return;
}
...
{
  *(int *)((intptr_t)this_ptr + 0x44) = *(int *)((intptr_t)this_ptr + 0x44) / param_1;
  return;
}
...

{
  ...
  uVar1 = FUN_10002de0((intptr_t)this_ptr);
  if ((char)uVar1 != '\0') {
    FUN_10001910(*(int *)this_ptr);
    SelectUnits((intptr_t)this_ptr + 0x1c,0);
    SelChangeNation(*(char *)this_ptr,7);
    FUN_10001910(7);
    SelectUnitsType((intptr_t)this_ptr + 0x28,7,0);
    SaveSelectedUnits(7,(intptr_t)this_ptr + 0x6c,0);
    SelectUnits((intptr_t)this_ptr + 0x1c,0);
    SelChangeNation(7,*(char *)this_ptr);
    FUN_10001950(7);
    SelectUnits((intptr_t)this_ptr + 0x6c,0);
    iVar2 = rand();
...

{
  ...
  if ((char)uVar1 != '\0') {
    ...
    SelChangeNation(*(char *)this_ptr,7);
    FUN_10001910(7);
    SelectUnitsType((intptr_t)this_ptr + 0x3c,7,0);
    SaveSelectedUnits(7,(intptr_t)this_ptr + 0x6c,0);
    SelectUnits((intptr_t)this_ptr + 0x1c,0);
    SelChangeNation(7,*(char *)this_ptr);
    FUN_10001950(7);
...

{
  ...
  RegisterDynGroup((intptr_t)this_ptr + 8);
  *(int *)((intptr_t)this_ptr + 0x22) = 0;
  *(int *)((intptr_t)this_ptr + 0x10) = 0;
  *(int *)((intptr_t)this_ptr + 0x14) = 0;
  *(short *)((intptr_t)this_ptr + 0x18) = 0;
  *(int *)((intptr_t)this_ptr + 0x2a) = 0;
  *(int *)((intptr_t)this_ptr + 0x2e) = 0;
  *(int *)((intptr_t)this_ptr + 0x32) = 0;
...

{
  ...
  bVar1 = FUN_100032f0((intptr_t)this_ptr);
  uVar2 = (int)bVar1;
  if (bVar1) {
...

{
  ...
  if ((char)uVar4 != '\0') {
    ...
    FUN_100030d0((intptr_t)&DAT_10022850);
  }
  uVar4 = FUN_10002de0((intptr_t)&DAT_100227d8);
  if ((char)uVar4 != '\0') {
    uVar5 = rand();
    if ((uVar5 & 0xff) < 0x80) {
    ...
    FUN_100030d0((intptr_t)&DAT_100227d8);
  }
  uVar4 = FUN_10002de0((intptr_t)&DAT_100228c8);
  if ((char)uVar4 != '\0') {
    uVar5 = rand();
    if ((uVar5 & 0xff) < 0x80) {
    ...
    FUN_100030d0((intptr_t)&DAT_100228c8);
  }
  cVar1 = Trigg(10);
  if (cVar1 != '\0') {
    SetTrigg(10,0);
  ...
  cVar1 = Trigg(0xc);
  if ((((cVar1 == '\0') && (bVar2 = FUN_10002cc0((intptr_t)&DAT_100226d8), !bVar2)) &&
      (iVar3 = GetUnitsAmount0(&DAT_10022758,5), iVar3 == 0)) &&
     ((iVar3 = GetUnitsAmount0(&DAT_10022760,5), iVar3 == 0 &&
  ...
  iVar3 = FUN_10001000(&DAT_100266bc,(intptr_t)&DAT_10012d40,5);
  if (DAT_10022962 == 0) {
  ...
  if ((cVar1 != '\0') || (bVar2 = FUN_100032f0((intptr_t)&DAT_100266b0), !bVar2)) {
    ShowPage("#defeat");
    LooseGame();
  }
  return;
