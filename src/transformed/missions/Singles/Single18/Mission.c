...
long long DAT_1000dd70 = 0;
long long DAT_1000ddb0 = 0;
int DAT_1000ddf4 = 0;
...

{
  ...
  *(char *)((int)this_ptr + 0x2f6) = 1;
  *(int *)((int)this_ptr + 0x2fb) = 1;
  *(char *)((int)this_ptr + 0x2ff) = 1;
  do {
    pcVar4 = param_3;
    if (uVar2 == 0) break;
    uVar2 = uVar2 - 1;
  ...
  *(int *)((int)this_ptr + 0x2b8) = 0;
  ...
  if (((param_6 == 0) || (param_6 == 1)) || (param_6 == 2)) {
    ...
    RemoveGroup(&DAT_1000d5e8,(int)this_ptr + 0x2b0);
  }
  if (param_6 == 0) {
...

{
  ...
  if ((*(char *)((int)this_ptr + 0x2af) == '\0') && (*(char *)((int)this_ptr + 0x2f6) != '\0')) {
    if ((*(char *)((int)this_ptr + 0x2ff) != '\0') &&
       (iVar1 = GetUnitsAmount2(*(int *)((int)this_ptr + 0x2ab),&DAT_1000d988,param_1),
       iVar1 != 0)) {
      uVar2 = AskMultilineQuestion(9,"#PAGE1",0,"VI1_1|VI1_2|VI1_3|VI1_4");
      switch(uVar2) {
      case 0:
        FUN_100015f0((int)this_ptr);
        *(char *)((int)this_ptr + 0x2ff) = 1;
        break;
      case 1:
        uVar2 = FUN_10001690((int)this_ptr);
        *(char *)((int)this_ptr + 0x2ff) = (char)uVar2;
        break;
      case 2:
...

{
  ...
  ShowPageParam("#PAGE131",(int)&DAT_1000dd08 + (int)pvVar5 * 0xf,100,
...

{
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 1) {
      ...
      if (iVar2 == 0) {
        FUN_100020e0(pvVar3,(char *)((int)param_1 + 0x298),*(int *)((int)param_1 + 0x2a7),
...

{
  ...
  uVar1 = (int)*(char *)((int)param_1 + 0x2f6);
  if (*(char *)((int)param_1 + 0x2f6) != '\0') {
    iVar2 = GetUnitsAmount2(*(int *)((int)param_1 + 0x2ab),&DAT_1000d5f8,
                            (int)*(char *)((int)param_1 + 0x2e8));
    uVar1 = 0;
    if (iVar2 != 0) {
      iVar2 = 0;
      pvVar7 = param_1;
      do {
        if (*(char *)((int)pvVar7 + 0x19) == '\0') {
          iVar3 = GetUnitsAmount1(*(int *)((int)param_1 + 0x2ab),pvVar7);
          if (iVar3 != 0) {
        ...
        if (*piVar8 != 0) {
          ...
          do {
            if (*(char *)(*piVar8 + 0x19 + iVar3) != '\0') {
              iVar4 = GetUnitsAmount1(*(int *)((int)param_1 + 0x2ab),*piVar8 + iVar3);
              if (iVar4 != 0) {
                iVar2 = iVar2 * 0x40;
                *(char *)(*(int *)((int)param_1 + uStack_4 * 4 + 0x284) + 0x19 + iVar2) = 0;
...

{
  ...
  *(char *)((int)this_ptr + 0x2f6) = param_3;
  return;
}
  ...
  if ((cVar1 != '\0') && (*(int *)((int)this_ptr + 4) != 0)) {
    ...
    *(int *)((int)this_ptr + 4) = *(int *)((int)this_ptr + 4) + -1;
    ...
    if (iVar2 != 0) {
      ...
      RemoveGroup(&DAT_1000d5e8,(int)this_ptr + 0x2d);
    }
    ...
    if (iVar2 != 0) {
      ...
      SelectUnits(&DAT_1000d5e8,0);
      SelSendAndKill(*(char *)this_ptr,param_4,0,0);
      RemoveGroup(&DAT_1000d5e8,(int)this_ptr + 0x35);
    }
  }
  return;
}
...
LAB_10002b12:
        ...
        iVar1 = iVar7 * 0xf;
        strncpy((char *)((int)&DAT_1000dd08 + iVar1),(char *)(iVar12 + (int)puVar4),sVar6);
        iVar7 = iVar7 + 1;
        *(char *)((int)&DAT_1000dd08 + sVar6 + iVar1) = 0;
      } while (iVar7 < 6);
      iVar7 = 0;
      do {
        if (iVar7 == 0) {
...
LAB_10002b8c:
        ...
        sVar6 = FUN_100036a0((byte *)(iVar12 + (int)puVar4),&DAT_1000a4dc);
        iVar1 = iVar7 * 0xf;
        strncpy((char *)((int)&DAT_1000d568 + iVar1),(char *)(iVar12 + (int)puVar4),sVar6);
        iVar7 = iVar7 + 1;
        *(char *)((int)&DAT_1000d568 + sVar6 + iVar1) = 0;
      } while (iVar7 < 3);
