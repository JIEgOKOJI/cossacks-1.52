...
long long DAT_10040d28 = 0;
long long DAT_10040d70 = 0;
long long DAT_10040d80 = 0;
long long DAT_10040d88 = 0;
int DAT_10040d90 = 0;
int DAT_10040d91 = 0;
long long DAT_10040d98 = 0;
long long DAT_10040da8 = 0;
long long DAT_10040db0 = 0;
int DAT_10040db8 = 0;
int DAT_10040db9 = 0;
long long DAT_10040dc0 = 0;
long long DAT_10040dd0 = 0;
long long DAT_10040dd8 = 0;
int DAT_10040de0 = 0;
int DAT_10040de1 = 0;
long long DAT_10040de8 = 0;
long long DAT_10040df8 = 0;
long long DAT_10040e00 = 0;
int DAT_10040e08 = 0;
int DAT_10040e09 = 0;
...
int FUN_1000af90() { return 0; }
int FUN_1000b320() { return 0; }
...
void  FUN_10006610(int param_1);
int  FUN_10006670(int param_1);
void  FUN_100066a0(int param_1);
void  FUN_10006700(void *this_ptr,int param_1);
void  FUN_10006740(void *this_ptr,int param_1);
...
void FUN_100076a0(short *param_1);
...
void  FUN_10007eb0(int param_1);
void  FUN_10007f20(void *this_ptr,int param_1);
...
void  FUN_10009040(int param_1);
int  FUN_100090b0(int param_1);
void  FUN_100090f0(void *this_ptr,int *param_1);
void  FUN_10009220(int param_1);
void  FUN_10009360(void *this_ptr,int param_1);
void  FUN_100093c0(int param_1);
void  FUN_10009450(int param_1);
void 
...
void  FUN_10009ad0(void *this_ptr,int param_1);
...
void  FUN_1000a240(int param_1);
void  FUN_1000a2a0(int param_1);
void  FUN_1000a340(int param_1);
...
void FUN_1000acb0(void *param_1);
int FUN_1000aec0(int *param_1,int param_2,int param_3,int param_4,
...
void FUN_1000b2d0(DWORD param_1);
...
local_8 = param_3;
  ...
  fVar3 = (long double)FUN_1000aa94(local_2c,(int)((double)(int)local_2c / (double)local_30));
...
local_c = local_c & 0xffff0000;
  ...
  for (local_40 = 0; local_40 < 8; local_40 = local_40 + 1) {
    if (0 < (int)(&DAT_10040cd0)[local_40]) {
      ...
      FUN_10002470(&DAT_10040cc0,(int)local_2a,1,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_48 = 0; local_48 < 8; local_48 = local_48 + 1) {
      if (0 < (int)(&DAT_10040cd0)[local_48]) {
        ...
        FUN_10002470(&DAT_10040cc0,(int)local_2a,2,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_50 = 0; local_50 < 8; local_50 = local_50 + 1) {
      if (0 < (int)(&DAT_10040cd0)[local_50]) {
        local_54 = ((float)(int)(&DAT_10040cd0)[local_50] * DAT_1003b050_ovl) / (float)local_10;
        if (local_54 < DAT_1003b04c_ovl) {
          local_54 = 1.0;
        }
        lVar5 = 0;
        FUN_10002470(&DAT_10040cc0,(int)local_2a,
...
DVar1 = FUN_1000b320((int *)0x0);
  ...
  for (local_8 = 0; local_8 < 9; local_8 = local_8 + 1) {
    RegisterUnitType(&DAT_10040d28 + local_8 * 8,(((int*)0))[local_8]);
  }
...
uVar1 = Trigg(99);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if ((uVar1 & 0xff) != 0) {
      ...
      FUN_10004810(0x10040d70);
      FUN_10004810(0x10040d98);
      FUN_10004810(0x10040dc0);
      FUN_10004810(0x10040de8);
...

{
  ...
  void *local_8;
local_8 = param_1;
  FUN_10006610(param_1);
  if (cVar1 != '\0') {
    FUN_10007020(local_8);
    FUN_10006b80(local_8);
    if (iVar2 < 10) {
      FUN_10006cc0(local_8,*(int *)((int)local_8 + 0x20));
    }
  }
...
if (((*(char *)((int)param_1 + 0x2c) != '\0') &&
      (local_8 = param_1, FUN_10006610(param_1), cVar1 != '\0')) &&
     (*(int *)((int)local_8 + 0x10) != 0)) {
    if (*(int *)((int)local_8 + 0x10) == 6) {
      uVar6 = 0;
      FUN_10006740(local_8,600);
      ...
      FUN_10006db0((int)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        FUN_100076a0(*(short **)((int)local_8 + 0x20));
...
local_8 = param_1;
  ...
  FUN_100064e0(local_8);
  uVar5 = 0;
  uVar4 = 0;
  FUN_10006740(local_8,100);
  SelSendTo(*(char *)((int)local_8 + 0x10),uVar1,uVar4,uVar5);
  FUN_10006ed0((int)local_8);
...
*(int *)((int)this_ptr + 4) = param_1;
  (&DAT_1004104c)[DAT_1004109c] = this_ptr;
...
local_8 = DAT_1004104c;
  for (local_c = 0; local_c < DAT_1004109c; local_c = local_c + 1) {
    psVar1 = (short *)FUN_10007870((&DAT_1004104c)[local_c]);
    if (*psVar1 == *param_1) {
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  FUN_10007180(param_1,*(int *)((int)this_ptr + 0xc),*(int *)((int)this_ptr + 0x10));
  FUN_10006cc0(param_1,*(int *)((int)local_8 + 8));
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  bVar1 = FUN_10008040((int)this_ptr);
  if (bVar1) {
    local_8[2] = param_1;
    *local_8 = param_2;
    local_8[1] = param_3;
...

{
  ...
  int local_8;
local_8 = param_1;
  FUN_100089f0(param_1);
  if (cVar1 != '\0') {
    local_c = *(char *)(local_8 + 0x1c);
    if (local_c == '\x01') {
      FUN_10008950(local_8);
      if (cVar1 == '\0') {
...

{
  ...
  void *local_8;
local_8 = param_1;
  FUN_10009040((int)param_1);
  if (cVar1 != '\0') {
    if (*(char *)((int)local_8 + 0xc) == '\x01') {
      uVar4 = 500;
      FUN_100090f0(local_8,local_10);
      FUN_10008ea0((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        *(char *)((int)local_8 + 0xc) = 2;
      }
      else {
        FUN_10008fa0((int)local_8);
        if (cVar1 == '\0') {
          SelectUnits((int)local_8 + 0xd,0);
          SelSendTo(DAT_1003ed88,(int)local_8 + 0x1d,*(char *)((int)local_8 + 8),0);
        }
      }
    }
    if (*(char *)((int)local_8 + 0xc) == '\x02') {
      uVar4 = 400;
      FUN_100090f0(local_8,local_18);
      FUN_10008ea0((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        SelectUnits((int)local_8 + 0xd,0);
        SelSendTo(DAT_1003ed88,DAT_100410ac,*(char *)((int)local_8 + 8),0);
      }
      else {
...
local_c = param_1;
  local_10 = param_2;
  local_8 = this_ptr;
  FUN_100090f0(this_ptr,local_34);
  local_1c = *piVar1;
  ...
  FUN_1000a934(*(int*)((char*)&local_28 + 4),(int)local_28);
  lVar5 = 0;
  local_14 = (void *)lVar5;
  FUN_10008ea0((int)local_8 + 0x1d,local_18,local_14,100);
...
local_8 = this_ptr;
  ...
  FUN_100094c0(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  ...
  FUN_100094c0(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_2,param_3);
...
int __cdecl
FUN_1000aec0(int *param_1,int param_2,int param_3,int param_4,
            int param_5,int param_6,int param_7)
