...
int FUN_100097e0(int *param_1,int param_2,int param_3,int param_4,
...
local_8 = param_3;
  ...
  fVar3 = (long double)FUN_100093b4(local_2c,(int)((double)(int)local_2c / (double)local_30));
...
local_14 = this_ptr;
  if (*(int *)((int)this_ptr + 8) == 0) {
    ...
    *(char **)((int)local_14 + 8) = local_20;
    ...
    FUN_100021b0(*(void **)((int)this_ptr + 8),param_1,param_2,param_3,param_4,param_5,param_6,
                       param_7);
  }
  return;
}
...
LAB_1000237a:
  ...
  if (*(int *)((int)this_ptr + 8) != 0) {
    ...
    local_8 = this_ptr;
    FUN_100022d0(*(void **)((int)this_ptr + 8),
                                 (int)(char)param_1,
                                 (int)(char)param_2,
...
local_c = local_c & 0xffff0000;
  ...
  for (local_40 = 0; local_40 < 8; local_40 = local_40 + 1) {
    if (0 < (int)(&DAT_1003ecc8)[local_40]) {
      ...
      FUN_100022d0(&DAT_1003ecb8,(int)local_2a,1,
                                 (int)(&DAT_1003cd60)[local_40],uVar2);
      local_44 = (int)uVar1;
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_48 = 0; local_48 < 8; local_48 = local_48 + 1) {
      if (0 < (int)(&DAT_1003ecc8)[local_48]) {
        ...
        FUN_100022d0(&DAT_1003ecb8,(int)local_2a,2,
                                   (int)(&DAT_1003cd60)[local_48],uVar2);
        local_4c = (int)uVar1;
        if ((local_c & 0xffff) / 100 < uVar1 / 100) {
          local_c = (int)uVar1;
        }
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_50 = 0; local_50 < 8; local_50 = local_50 + 1) {
      if (0 < (int)(&DAT_1003ecc8)[local_50]) {
        ...
        FUN_100022d0(&DAT_1003ecb8,(int)local_2a,3,
                                   (int)(&DAT_1003cd60)[local_50],uVar2);
        local_54 = (int)uVar1;
        if ((local_c & 0xffff) / 100 < uVar1 / 100) {
          local_c = (int)uVar1;
        }
...
local_8 = param_1;
  ...
  if (0 < iVar3) {
    ...
    case 3:
      ...
      local_18 = local_48;
      FUN_100018c0((int)local_10,*(int*)((char*)&local_10 + 4),(int)local_48,
    ...
    case 4:
      ...
      *(int*)((char*)&local_10 + 4) = *(unsigned short *)(local_8 + 10) - 0x96;
      ...
      local_18 = local_58;
      FUN_100018c0((int)local_10,*(int*)((char*)&local_10 + 4),(int)local_58,
...
SetPlayerName(0,"SPAIN");
  ...
  for (local_c = 0; local_c < 0xe; local_c = local_c + 1) {
    ...
    *(int *)(&DAT_1003ed18 + local_c * 0x1f) = 0x80;
...
local_8 = (int)1;
  ...
  if ((local_8 & 0xff) != 0) {
    FUN_10008e00(param_1,&DAT_1003ef20 + (local_10 & 0xff) * 8 + (local_c & 0xff) * 0x28,
...
uVar2 = Trigg(99);
  ...
  if ((uVar2 & 0xff) != 0) {
    for (local_8 = 0; local_8 < 0xe; local_8 = local_8 + 1) {
      FUN_10002fe0((int)(&DAT_1003ed00 + local_8 * 0x1f));
    }
    RunTimer(2,0x1e);
  }
  ...
  for (local_c = 0; local_c < 5; local_c = local_c + 1) {
    iVar3 = GetTotalAmount0(&DAT_1003ef20 + local_c * 8);
    if (0xf < iVar3) {
  ...
  for (local_c = 0; local_c < 0xe; local_c = local_c + 1) {
    ...
    local_18 = (unsigned int)*(unsigned short *)(&DAT_1003ed10 + local_c * 0x1f);
    local_1c = (unsigned int)*(unsigned short *)(&DAT_1003ed12 + local_c * 0x1f);
    local_30 = local_1c - local_14;
    local_34 = (void *)(local_18 - local_10);
    fVar5 = (long double)FUN_100093b4(local_34,(int)((double)local_30 / (double)(int)local_34));
...
local_8 = param_1;
  ...
  if (cVar1 != '\0') {
    ...
    if (iVar2 < 10) {
      FUN_10005e30(local_8,*(int *)((int)local_8 + 0x20));
    }
  }
...
if (((*(char *)((int)param_1 + 0x2c) != '\0') &&
    ...
    if (*(int *)((int)local_8 + 0x10) == 6) {
      ...
      FUN_10005f20((int)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        FUN_10006810(*(short **)((int)local_8 + 0x20));
...
*(int *)((int)this_ptr + 4) = param_1;
  (&DAT_1003f3a4)[DAT_1003f3f4] = this_ptr;
...
local_8 = DAT_1003f3a4;
  for (local_c = 0; local_c < DAT_1003f3f4; local_c = local_c + 1) {
    psVar1 = (short *)FUN_100069e0((&DAT_1003f3a4)[local_c]);
    if (*psVar1 == *param_1) {
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  FUN_100062f0(param_1,*(int *)((int)this_ptr + 0xc),*(int *)((int)this_ptr + 0x10));
  FUN_10005e30(param_1,*(int *)((int)local_8 + 8));
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  bVar1 = FUN_100071b0((int)this_ptr);
  if (bVar1) {
    local_8[2] = param_1;
    *local_8 = param_2;
    local_8[1] = param_3;
...

{
  ...
  void *local_8;
local_8 = param_1;
  FUN_100081b0((int)param_1);
  if (cVar1 != '\0') {
    if (*(char *)((int)local_8 + 0xc) == '\x01') {
      uVar4 = 500;
      FUN_10008260(local_8,local_10);
      FUN_10008010((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        *(char *)((int)local_8 + 0xc) = 2;
      }
      else {
        FUN_10008110((int)local_8);
        if (cVar1 == '\0') {
          SelectUnits((int)local_8 + 0xd,0);
          SelSendTo(DAT_1003cd6c,(int)local_8 + 0x1d,*(char *)((int)local_8 + 8),0);
        }
      }
    }
    if (*(char *)((int)local_8 + 0xc) == '\x02') {
      ...
      if (iVar3 < 1) {
        SelectUnits((int)local_8 + 0xd,0);
        SelSendTo(DAT_1003cd6c,DAT_1003f404,*(char *)((int)local_8 + 8),0);
      }
      else {
...
local_c = param_1;
  ...
  FUN_10009254(*(int*)((char*)&local_28 + 4),(int)local_28);
  lVar5 = 0;
  local_14 = (void *)lVar5;
  FUN_10008010((int)local_8 + 0x1d,local_18,local_14,100);
...
local_8 = this_ptr;
  ...
  FUN_10008630(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  ...
  FUN_10008630(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_2,param_3);
...
int __cdecl
FUN_100097e0(int *param_1,int param_2,int param_3,int param_4,
            int param_5,int param_6,int param_7)
