...
local_c = local_c & -65536;
  ...
  for (local_40 = 0; local_40 < 8; local_40 = local_40 + 1) {
    if (0 < (int)((long long *)&DAT_1003eca0)[local_40]) {
      ...
      FUN_10002480(&DAT_1003ec90,(intptr_t)local_2a,1,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_48 = 0; local_48 < 8; local_48 = local_48 + 1) {
      if (0 < (int)((long long *)&DAT_1003eca0)[local_48]) {
        ...
        FUN_10002480(&DAT_1003ec90,(intptr_t)local_2a,2,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_50 = 0; local_50 < 8; local_50 = local_50 + 1) {
      if (0 < (int)((long long *)&DAT_1003eca0)[local_50]) {
        ...
        lVar5 = 0;
        FUN_10002480(&DAT_1003ec90,(intptr_t)local_2a,
...
if (((*(char *)((intptr_t)param_1 + 0x2c) != '\0') &&
    ...
    if (*(int *)((intptr_t)local_8 + 0x10) == 6) {
      ...
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        FUN_10006000(*(short **)((intptr_t)local_8 + 0x20));
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  FUN_10006810((intptr_t)this_ptr);
  if (iVar2 == 0) {
...
local_8 = this_ptr;
  ...
  FUN_10004ca0((intptr_t)local_8 + 0xc);
