...
int FUN_10006000(short *param_1);
...
int  FUN_10006810(int param_1);
int  FUN_10006880(void *this_ptr,int param_1);
...
int  FUN_100072b0(int param_1);
int  FUN_10007350(int param_1);
...
int  FUN_10008430(void *this_ptr,int param_1);
...
int  FUN_100088f0(void *this_ptr,int param_1);
...
int  FUN_10008c10(int param_1);
int  FUN_10008d10(int param_1);
...
local_8 = param_3;
  ...
  FUN_100093d4((intptr_t)local_1c);
  lVar4 = 0;
  local_24 = (int)lVar4;
  return 0;
}
...
if ((DAT_1003ecc8 & 1) == 0) {
    ...
    FUN_100025d0((intptr_t)&DAT_1003ec90);
  }
  uStack_8 = 0x10002b6c;
  return;
}
...
local_c = local_c & -65536;
  ...
  for (local_40 = 0; local_40 < 8; local_40 = local_40 + 1) {
    if (0 < (int)((long long *)&DAT_1003eca0)[local_40]) {
      ...
      uVar1 = FUN_10002480(&DAT_1003ec90,(intptr_t)local_2a,1,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_48 = 0; local_48 < 8; local_48 = local_48 + 1) {
      if (0 < (int)((long long *)&DAT_1003eca0)[local_48]) {
        ...
        uVar1 = FUN_10002480(&DAT_1003ec90,(intptr_t)local_2a,2,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_50 = 0; local_50 < 8; local_50 = local_50 + 1) {
      if (0 < (int)((long long *)&DAT_1003eca0)[local_50]) {
        ...
        lVar5 = 0;
        uVar1 = FUN_10002480(&DAT_1003ec90,(intptr_t)local_2a,
...
int __cdecl FUN_10003c90(int param_1)
...

{
  ...
  int local_48 [16];
  unsigned int local_8;
for (local_8 = 0; (intptr_t)local_8 < param_1; local_8 = local_8 + 1) {
    iVar2 = rand();
...
int __cdecl FUN_10004ca0(int param_1)
...

{
  ...
  void *local_8;
local_8 = param_1;
  cVar1 = FUN_10004f70(param_1);
  if (cVar1 != '\0') {
    FUN_10005980(local_8);
    iVar2 = FUN_100054e0(local_8);
    if (iVar2 < 10) {
      FUN_10005620(local_8,*(int *)((intptr_t)local_8 + 0x20));
    }
  }
...
local_c = 0;
  uVar4 = 0;
  local_8 = param_1;
  uVar1 = FUN_100050a0(param_1,2000);
...
if (((*(char *)((intptr_t)param_1 + 0x2c) != '\0') &&
      (local_8 = param_1, cVar1 = FUN_10004f70(param_1), cVar1 != '\0')) &&
     (*(int *)((intptr_t)local_8 + 0x10) != 0)) {
    if (*(int *)((intptr_t)local_8 + 0x10) == 6) {
      uVar6 = 0;
      uVar2 = FUN_100050a0(local_8,600);
      ...
      iVar3 = FUN_100054e0(local_8);
      if (iVar3 < 0x32) {
        FUN_10005e20(local_8);
      }
      cVar1 = FUN_10005710((intptr_t)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        this_ptr = (void *)FUN_10006000(*(short **)((intptr_t)local_8 + 0x20));
...
local_8 = param_1;
  ...
  uVar5 = 0;
  uVar4 = 0;
  uVar1 = FUN_100050a0(local_8,100);
  SelSendTo(*(char *)((intptr_t)local_8 + 0x10),uVar1,uVar4,uVar5);
  FUN_10005830((intptr_t)local_8);
...
int __cdecl FUN_10006000(short *param_1)
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  FUN_10005ae0(param_1,*(int *)((intptr_t)this_ptr + 0xc),*(int *)((intptr_t)this_ptr + 0x10));
  FUN_10005620(param_1,*(int *)((intptr_t)local_8 + 8));
...

{
  ...
  void *local_8;
local_8 = param_1;
  iVar2 = FUN_10006810((intptr_t)param_1);
  if ((0 < iVar2) && (*(int *)((intptr_t)local_8 + 0x1c) + 1 < *(int *)((intptr_t)local_8 + 0x20))) {
    if (*(int *)((intptr_t)local_8 + *(int *)((intptr_t)local_8 + 0x1c) * 8 + 0x2c) == 1) {
      cVar1 = FUN_10006880(local_8,*(int *)
                                          ((intptr_t)local_8 + *(int *)((intptr_t)local_8 + 0x1c) * 8 + 0x28))
      ;
      if (cVar1 != '\0') {
        FUN_10006ed0((intptr_t)local_8 + 0xc,
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  iVar2 = FUN_10006810((intptr_t)this_ptr);
  if (iVar2 == 0) {
...
local_c = 0;
  ...
  iVar1 = FUN_10006810((intptr_t)local_8);
  if (iVar2 == iVar1) {
    local_c = 1;
  }
...
local_8 = this_ptr;
  ...
  uVar1 = FUN_10004ca0((intptr_t)local_8 + 0xc);
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  bVar1 = FUN_100069a0((intptr_t)this_ptr);
  if (bVar1) {
    local_8[2] = param_1;
    *local_8 = param_2;
    local_8[1] = param_3;
...

{
  ...
  int local_8;
local_8 = param_1;
  cVar1 = FUN_10007350(param_1);
  if (cVar1 != '\0') {
    local_c = *(char *)(local_8 + 0x1c);
    if (local_c == '\x01') {
      cVar1 = FUN_100072b0(local_8);
      if (cVar1 == '\0') {
...

{
  ...
  void *local_8;
local_8 = param_1;
  cVar1 = FUN_100079a0((intptr_t)param_1);
  if (cVar1 != '\0') {
    if (*(char *)((intptr_t)local_8 + 0xc) == '\x01') {
      uVar4 = 500;
      puVar2 = (int *)FUN_10007a50(local_8,local_10);
      FUN_10007800((intptr_t)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((intptr_t)local_8 + 0x15,0);
      if (iVar3 < 1) {
        *(char *)((intptr_t)local_8 + 0xc) = 2;
      }
      else {
        cVar1 = FUN_10007900((intptr_t)local_8);
        if (cVar1 == '\0') {
    ...
    if (*(char *)((intptr_t)local_8 + 0xc) == '\x02') {
      uVar4 = 400;
      puVar2 = (int *)FUN_10007a50(local_8,local_18);
      FUN_10007800((intptr_t)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((intptr_t)local_8 + 0x15,0);
      if (iVar3 < 1) {
        SelectUnits((intptr_t)local_8 + 0xd,0);
        SelSendTo(DAT_1003cd5c,DAT_1003f484,*(char *)((intptr_t)local_8 + 8),0);
      }
      else {
...
local_c = param_1;
  local_10 = param_2;
  local_8 = this_ptr;
  piVar1 = (int *)FUN_10007a50(this_ptr,local_34);
  local_1c = *piVar1;
  local_20 = piVar1[1];
  ...
  lVar5 = 0;
  local_14 = (int)lVar5;
  FUN_10007800((intptr_t)local_8 + 0x1d,local_18,local_14,100);
...
local_8 = this_ptr;
  ...
  FUN_10007e20(local_8,(intptr_t)local_8 + 0x16,(intptr_t)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  RegisterUnits((intptr_t)this_ptr + 0x16,param_1);
  CreateZoneNearGroup((intptr_t)local_8 + 0x1e,DAT_1003f490,(intptr_t)local_8 + 0x16,300);
  FUN_10007e20(local_8,(intptr_t)local_8 + 0x16,(intptr_t)local_8 + 0x1e,param_2,param_3);
...
local_c = 0;
  local_8 = this_ptr;
  cVar1 = FUN_10008430(this_ptr,param_1);
  if (cVar1 != '\0') {
...

{
  ...
  void *local_8;
local_8 = param_1;
  cVar1 = FUN_10008d10(param_1);
  if (cVar1 != '\0') {
    uVar5 = 0;
    uVar2 = FUN_100088f0(local_8,3000);
    ...
    if (0 < iVar3) {
      ...
      FUN_10008f70((intptr_t)local_8 + 0x3d);
    }
  }
...

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    FUN_1000c1b0(param_1,*(int *)((intptr_t)param_1 + -0xc));
    FUN_1000b6c0(9);
  }
  return;
}
...
int __cdecl FUN_10009750(void *param_1)
