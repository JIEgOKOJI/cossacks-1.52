...

{
  ...
  *(int *)((int)this_ptr + 0x2b8) = 0;
  ...
  if (((param_6 == 0) || (param_6 == 1)) || (param_6 == 2)) {
    ...
    RemoveGroup(&DAT_1000e7a8,(int)this_ptr + 0x2b0);
  }
  if (param_6 == 0) {
...

{
  ...
  if ((*(char *)((int)this_ptr + 0x2af) == '\0') && (*(char *)((int)this_ptr + 0x2f6) != '\0')) {
    if ((*(char *)((int)this_ptr + 0x2ff) != '\0') &&
       (iVar1 = GetUnitsAmount2(*(int *)((int)this_ptr + 0x2ab),&DAT_1000ee50,param_1),
       iVar1 != 0)) {
...

{
  ...
  ShowPageParam("#PAGE131",(int)&DAT_1000f1e0 + (int)pvVar5 * 0xf,100,
...

{
  ...
  if (iVar2 == 0) {
    ...
    if (iVar2 == 1) {
      ...
      if (iVar2 == 0) {
        FUN_100020f0(pvVar3,(char *)((int)param_1 + 0x298),*(int *)((int)param_1 + 0x2a7),
...

{
  ...
  if (*(char *)((int)param_1 + 0x2f6) != '\0') {
    iVar2 = GetUnitsAmount2(*(int *)((int)param_1 + 0x2ab),&DAT_1000eab8,
        ...
        if (*piVar8 != 0) {
          ...
          do {
            if (*(char *)(iVar3 + 0x19 + *piVar8) != '\0') {
              iVar4 = GetUnitsAmount1(*(int *)((int)param_1 + 0x2ab),iVar3 + *piVar8);
              if (iVar4 != 0) {
                iVar2 = iVar2 * 0x40;
  ...
  if ((cVar1 != '\0') && (*(int *)((int)this_ptr + 4) != 0)) {
    ...
    *(int *)((int)this_ptr + 4) = *(int *)((int)this_ptr + 4) + -1;
    ...
    if (iVar2 != 0) {
      ...
      RemoveGroup(&DAT_1000e7a8,(int)this_ptr + 0x2d);
    }
    ...
    if (iVar2 != 0) {
      ...
      SelectUnits(&DAT_1000e7a8,0);
      SelSendAndKill(*(char *)this_ptr,param_4,0,0);
      RemoveGroup(&DAT_1000e7a8,(int)this_ptr + 0x35);
    }
  }
  return;
}
...
LAB_10002cb7:
        ...
        iVar1 = iVar7 * 0xf;
        strncpy((char *)((int)&DAT_1000f1e0 + iVar1),(char *)(iVar9 + (int)puVar4),sVar6);
        iVar7 = iVar7 + 1;
        *(char *)((int)&DAT_1000f1e0 + sVar6 + iVar1) = 0;
      } while (iVar7 < 6);
      iVar7 = 0;
      do {
        if (iVar7 == 0) {
...
LAB_10002d3d:
        ...
        sVar6 = FUN_10004500((byte *)(iVar9 + (int)puVar4),&DAT_1000b598);
        iVar1 = iVar7 * 0xf;
        strncpy((char *)((int)&DAT_1000e3d0 + iVar1),(char *)(iVar9 + (int)puVar4),sVar6);
        iVar7 = iVar7 + 1;
        *(char *)((int)&DAT_1000e3d0 + sVar6 + iVar1) = 0;
      } while (iVar7 < 4);
