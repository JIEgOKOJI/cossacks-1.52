...
long long DAT_10031708 = 0;
long long DAT_10031820 = 0;
long long DAT_10031938 = 0;
long long DAT_10031a50 = 0;
...
local_8 = this_ptr;
  ...
  *(int *)((int)local_8 + 0xc) = param_1;
  *(int *)((int)local_8 + 0x10) = param_2;
  *(int *)((int)local_8 + 0x1c) = param_3;
  *(int *)((int)local_8 + 0x18) = 0;
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  CreateObject0(this_ptr,*(int *)((int)this_ptr + 0x10),*(int *)((int)this_ptr + 0xc),
                *(char *)((int)this_ptr + 0x1c),param_1,0);
  *(int *)((int)local_8 + 0x18) = 1;
  *(int *)((int)local_8 + 8) = param_2;
  *(int *)((int)local_8 + 0x14) = param_1;
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  bVar1 = FUN_10001e30((int)this_ptr);
  if (bVar1) {
    local_8[2] = param_1;
    *local_8 = param_2;
    local_8[1] = param_3;
...
local_8 = this_ptr;
  ...
  FUN_10002330(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  ...
  FUN_10002330(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_2,param_3);
...
uVar1 = Trigg(99);
  ...
  FUN_10001460(0x10031408);
  FUN_10001460(0x10031428);
  FUN_10001460(0x10031448);
  FUN_10001460(0x10031468);
  FUN_10001460(0x10031488);
  FUN_10001460(0x100314a8);
  uVar1 = Trigg(1);
  if ((uVar1 & 0xff) != 0) {
  ...
  uVar1 = TimerDone(0xb);
  if (((uVar1 & 0xff) != 0) && (FUN_10001ca0(0x100314d8), iVar3 == 0)) {
    FUN_100034b0(&DAT_100314d8,1);
    RunTimer(0xb,7000);
  }
  uVar1 = TimerDone(0xc);
  if (((uVar1 & 0xff) != 0) && (FUN_10001ca0(0x100315f0), iVar3 == 0)) {
    FUN_100034b0(&DAT_100315f0,2);
    RunTimer(0x16,6000);
  }
  uVar1 = TimerDone(0xd);
  if (((uVar1 & 0xff) != 0) && (FUN_10001ca0(0x10031708), iVar3 == 0)) {
    FUN_100034b0(&DAT_10031708,1);
    RunTimer(0xd,8000);
  }
  uVar1 = TimerDone(0xe);
  if (((uVar1 & 0xff) != 0) && (FUN_10001ca0(0x10031820), iVar3 == 0)) {
    FUN_100034b0(&DAT_10031820,2);
    RunTimer(0xe,9000);
  }
  uVar1 = TimerDone(0xf);
  if (((uVar1 & 0xff) != 0) && (FUN_10001ca0(0x10031938), iVar3 == 0)) {
    FUN_100034b0(&DAT_10031938,1);
    RunTimer(0xf,7000);
  }
  uVar1 = TimerDone(0x10);
  if (((uVar1 & 0xff) != 0) && (FUN_10001ca0(0x10031a50), iVar3 == 0)) {
    FUN_100034b0(&DAT_10031a50,2);
    RunTimer(0x10,7000);
  }
  uVar1 = TimerDone(0x15);
  if (((uVar1 & 0xff) != 0) && (iVar3 = FUN_10001380(0x10031408), iVar3 == 0)) {
    FUN_100037f0();
    FUN_100013c0(&DAT_10031408,&DAT_10031cf8,uVar2);
    RunTimer(0x15,1000);
  }
  uVar1 = TimerDone(0x16);
  if (((uVar1 & 0xff) != 0) && (iVar3 = FUN_10001380(0x10031428), iVar3 == 0)) {
    FUN_100037f0();
    FUN_100013c0(&DAT_10031428,&DAT_10031cf8,uVar2);
    RunTimer(0x16,1000);
  }
  uVar1 = TimerDone(0x17);
  if (((uVar1 & 0xff) != 0) && (iVar3 = FUN_10001380(0x10031448), iVar3 == 0)) {
    FUN_100037f0();
    FUN_100013c0(&DAT_10031448,&DAT_10031d08,uVar2);
    RunTimer(0x17,1000);
  }
  uVar1 = TimerDone(0x18);
  if (((uVar1 & 0xff) != 0) && (iVar3 = FUN_10001380(0x10031468), iVar3 == 0)) {
    FUN_100037f0();
    FUN_100013c0(&DAT_10031468,&DAT_10031d18,uVar2);
    RunTimer(0x18,1000);
  }
  uVar1 = TimerDone(0x19);
  if (((uVar1 & 0xff) != 0) && (iVar3 = FUN_10001380(0x10031488), iVar3 == 0)) {
    FUN_100037f0();
    FUN_100013c0(&DAT_10031488,&DAT_10031d28,uVar2);
    RunTimer(0x19,1000);
  }
  uVar1 = TimerDone(0x1a);
  if (((uVar1 & 0xff) != 0) && (iVar3 = FUN_10001380(0x100314a8), iVar3 == 0)) {
    FUN_100037f0();
