...
void  FUN_100060c0(int param_1);
void  FUN_10006120(int param_1);
int  FUN_10006180(int param_1);
void  FUN_100061b0(int param_1);
...
local_8 = param_3;
  ...
  fVar3 = (long double)FUN_10009d44(local_2c,(int)((double)(int)local_2c / (double)local_30));
...
local_14 = this_ptr;
  if (*(int *)((int)this_ptr + 8) == 0) {
    ...
    *(char **)((int)local_14 + 8) = local_20;
    ...
    FUN_10002260(*(void **)((int)this_ptr + 8),param_1,param_2,param_3,param_4,param_5,param_6,
                       param_7);
  }
  return;
}
...
LAB_1000242a:
  ...
  if (*(int *)((int)this_ptr + 8) != 0) {
    ...
    local_8 = this_ptr;
    FUN_10002380(*(void **)((int)this_ptr + 8),
                                 (int)(char)param_1,
                                 (int)(char)param_2,
...
local_c = local_c & 0xffff0000;
  ...
  for (local_40 = 0; local_40 < 8; local_40 = local_40 + 1) {
    if (0 < (int)(&DAT_1003fcc8)[local_40]) {
      ...
      FUN_10002380(&DAT_1003fcb8,(int)local_2a,1,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_48 = 0; local_48 < 8; local_48 = local_48 + 1) {
      if (0 < (int)(&DAT_1003fcc8)[local_48]) {
        ...
        FUN_10002380(&DAT_1003fcb8,(int)local_2a,2,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_50 = 0; local_50 < 8; local_50 = local_50 + 1) {
      if (0 < (int)(&DAT_1003fcc8)[local_50]) {
        local_54 = ((float)(int)(&DAT_1003fcc8)[local_50] * DAT_1003a050_ovl) / (float)local_10;
        if (local_54 < DAT_1003a04c_ovl) {
          local_54 = 1.0;
        }
        lVar5 = 0;
        FUN_10002380(&DAT_1003fcb8,(int)local_2a,
...
local_8 = param_1;
  ...
  if (0 < iVar3) {
    ...
    case 3:
      ...
      local_18 = local_48;
      FUN_100018b0((int)local_10,*(int*)((char*)&local_10 + 4),(int)local_48,
    ...
    case 4:
      ...
      *(int*)((char*)&local_10 + 4) = *(unsigned short *)(local_8 + 10) - 0x96;
      ...
      local_18 = local_58;
      FUN_100018b0((int)local_10,*(int*)((char*)&local_10 + 4),(int)local_58,
...
SetPlayerName(0,"AUSTRIANS");
  ...
  for (local_10 = 0; local_10 < 0x13; local_10 = local_10 + 1) {
    ...
    *(int *)(&DAT_1003fd18 + local_10 * 0x1f) = 0x80;
    (&DAT_1003fd1e)[local_10 * 0x1f] = 3;
  }
  for (local_10 = 0; local_10 < 10; local_10 = local_10 + 1) {
    FUN_1000a580(local_c,0x1003a084);
    FUN_10009500(&DAT_1003ff58 + local_10 * 0x49,local_c);
  }
...
UnitsCenter(param_1 + 0x10,param_1,500);
  ...
  fVar3 = (long double)FUN_10009d44(local_28,(int)((double)(int)local_28 / (double)local_2c));
  local_1c = (double)fVar3;
...
local_8 = (int)1;
  ...
  if ((local_8 & 0xff) != 0) {
    FUN_100097a0(param_1,&DAT_100402d8 + (local_10 & 0xff) * 8 + (local_c & 0xff) * 0x20,
...
uVar2 = Trigg(99);
  ...
  for (local_1c = 0; local_1c < 10; local_1c = local_1c + 1) {
    FUN_100096d0(&DAT_1003ff58 + local_1c * 0x49,&DAT_10040338,&DAT_100403e8);
    if (cVar1 != '\0') {
      FUN_10004040(&DAT_1003ff58 + local_1c * 0x49);
      FUN_10005ef0(&DAT_10040338);
    }
    FUN_100099b0((int)(&DAT_1003ff58 + local_1c * 0x49));
    if (cVar1 != '\0') {
      DAT_100403e8 = DAT_100403e8 + 100;
      uVar5 = 0;
      iVar3 = FUN_10009760((int)(&DAT_1003ff58 + local_1c * 0x49));
  ...
  if ((uVar2 & 0xff) != 0) {
    for (local_20 = 0; local_20 < 0xe; local_20 = local_20 + 1) {
      FUN_100030c0((int)(&DAT_1003fd00 + local_20 * 0x1f));
    }
    uVar2 = Trigg(0x1d);
    if (10 < (uVar2 & 0xff)) {
...
local_8 = param_1;
  ...
  if (cVar1 != '\0') {
    ...
    if (iVar2 < 10) {
      FUN_100067d0(local_8,*(int *)((int)local_8 + 0x20));
    }
  }
...
if (((*(char *)((int)param_1 + 0x2c) != '\0') &&
    ...
    if (*(int *)((int)local_8 + 0x10) == 6) {
      ...
      FUN_100068c0((int)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        FUN_100071b0(*(short **)((int)local_8 + 0x20));
...
*(int *)((int)this_ptr + 4) = param_1;
  (&DAT_1004056c)[DAT_100405bc] = this_ptr;
...
local_8 = DAT_1004056c;
  for (local_c = 0; local_c < DAT_100405bc; local_c = local_c + 1) {
    psVar1 = (short *)FUN_10007380((&DAT_1004056c)[local_c]);
    if (*psVar1 == *param_1) {
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  FUN_10006c90(param_1,*(int *)((int)this_ptr + 0xc),*(int *)((int)this_ptr + 0x10));
  FUN_100067d0(param_1,*(int *)((int)local_8 + 8));
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  bVar1 = FUN_10007b50((int)this_ptr);
  if (bVar1) {
    local_8[2] = param_1;
    *local_8 = param_2;
    local_8[1] = param_3;
...

{
  ...
  void *local_8;
local_8 = param_1;
  FUN_10008b50((int)param_1);
  if (cVar1 != '\0') {
    if (*(char *)((int)local_8 + 0xc) == '\x01') {
      uVar4 = 500;
      FUN_10008c00(local_8,local_10);
      FUN_100089b0((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        *(char *)((int)local_8 + 0xc) = 2;
      }
      else {
        FUN_10008ab0((int)local_8);
        if (cVar1 == '\0') {
          SelectUnits((int)local_8 + 0xd,0);
          SelSendTo(DAT_1003dd6c,(int)local_8 + 0x1d,*(char *)((int)local_8 + 8),0);
        }
      }
    }
    if (*(char *)((int)local_8 + 0xc) == '\x02') {
      ...
      if (iVar3 < 1) {
        SelectUnits((int)local_8 + 0xd,0);
        SelSendTo(DAT_1003dd6c,DAT_100405cc,*(char *)((int)local_8 + 8),0);
      }
      else {
...
local_c = param_1;
  ...
  FUN_10009be4(*(int*)((char*)&local_28 + 4),(int)local_28);
  lVar5 = 0;
  local_14 = (void *)lVar5;
  FUN_100089b0((int)local_8 + 0x1d,local_18,local_14,100);
...
local_8 = this_ptr;
  ...
  FUN_10008fd0(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  ...
  FUN_10008fd0(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_2,param_3);
