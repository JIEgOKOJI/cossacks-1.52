...
unsigned char DAT_1003deb8[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_1003dec8 (*(long long *)((char *)DAT_1003deb8 + 0x10))
unsigned char DAT_1003ded8[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_1003dee8 (*(long long *)((char *)DAT_1003ded8 + 0x10))
unsigned char DAT_1003def8[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_1003df08 (*(long long *)((char *)DAT_1003def8 + 0x10))
unsigned char DAT_1003df60[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_1003df70 (*(long long *)((char *)DAT_1003df60 + 0x10))
unsigned char DAT_1003df80[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_1003df90 (*(long long *)((char *)DAT_1003df80 + 0x10))
unsigned char DAT_1003dfa0[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_1003dfb0 (*(long long *)((char *)DAT_1003dfa0 + 0x10))
unsigned char DAT_1003dfc0[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_1003dfd0 (*(long long *)((char *)DAT_1003dfc0 + 0x10))
unsigned char DAT_1003dfe0[32] = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
#define DAT_1003dff0 (*(long long *)((char *)DAT_1003dfe0 + 0x10))
unsigned char DAT_1003e000[32] = {0};
#define DAT_1003e010 (*(long long *)((char *)DAT_1003e000 + 0x10))
...
int DAT_1003e138 = 0;
unsigned char DAT_1003e140[32] = {0};
#define DAT_1003e150 (*(long long *)((char *)DAT_1003e140 + 0x10))
unsigned char DAT_1003e160[32] = {0};
#define DAT_1003e170 (*(long long *)((char *)DAT_1003e160 + 0x10))
...
int FUN_10001450(int param_1);
int FUN_10001560(int param_1,unsigned short param_2);
int FUN_100016b0(int param_1,char param_2,char param_3);
int FUN_10001770(int param_1,char param_2);
int FUN_10001830(int param_1,int param_2,int param_3,int param_4,int param_5);
...
FUN_10001cf0(void *this_ptr,char param_1,char param_2,char param_3,char param_4,
            short param_5,char param_6,char param_7);
int  FUN_10001e10(void *this_ptr,unsigned int param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4);
void  FUN_10001f60(intptr_t param_1);
int FUN_10001fe0(unsigned int param_1);
int  FUN_10002050(int param_1);
...
int FUN_10005ee0(short *param_1);
...
int  FUN_100066f0(int param_1);
int  FUN_10006760(void *this_ptr,int param_1);
...
int  FUN_10007190(int param_1);
int  FUN_10007230(int param_1);
...
int  FUN_100077e0(int param_1);
int  FUN_10007880(int param_1);
int  FUN_100078f0(int param_1);
int  FUN_10007930(void *this_ptr,int *param_1);
void  FUN_10007a60(int param_1);
void  FUN_10007ba0(void *this_ptr,int param_1);
int  FUN_10007c00(int param_1);
int  FUN_10007c90(int param_1);
void 
...
int FUN_10008700(unsigned int param_1);
...
int __cdecl FUN_10001450(int param_1)
...
int __cdecl FUN_10001560(int param_1,unsigned short param_2)
...
int __cdecl FUN_100016b0(int param_1,char param_2,char param_3)
...
RegisterDynGroup(local_c);
  ...
  local_14 = FUN_10001560(local_c,(unsigned short)(intptr_t)param_3);
  uStack_8 = 0x1000173f;
  return 0;
}
...
int __cdecl FUN_10001770(int param_1,char param_2)
...
int __cdecl FUN_10001830(int param_1,int param_2,int param_3,int param_4,int param_5)
...
local_8 = param_3;
  ...
  fVar3 = (long double)FUN_100084e4(local_2c,(int)((double)(intptr_t)local_2c / (double)local_30));
...
local_14 = this_ptr;
  if (*(int *)((intptr_t)this_ptr + 8) == 0) {
    ...
    *(char **)((intptr_t)local_14 + 8) = local_20;
    ...
    FUN_10001cf0(*(void **)((intptr_t)this_ptr + 8),param_1,param_2,param_3,param_4,param_5,param_6,
                       param_7);
  }
  return;
}
...
LAB_10001eba:
  ...
  if (*(int *)((intptr_t)this_ptr + 8) != 0) {
    ...
    local_8 = this_ptr;
    local_c = FUN_10001e10(*(void **)((intptr_t)this_ptr + 8),
                                 (int)(char)param_1,
                                 (int)(char)param_2,
...
for (local_c = 0; local_c < 8; local_c = local_c + 1) {
  ...
  SaveSelectedUnits(0,(intptr_t)local_8 + 0x20,0);
  ...
  for (local_c = 0; local_c < local_10; local_c = local_c + 1) {
    ...
    local_40 = (int *)((intptr_t)local_8 + (uVar1 & 0xff) * 4);
    *local_40 = *local_40 + 1;
  }
...

{
  ...
  char local_2c [36];
  int uStack_8;
puVar1 = (int *)FUN_10002050((intptr_t)local_2c);
  puVar3 = &DAT_1003dcd8;
...
if ((DAT_1003dd00 & 1) == 0) {
    ...
    FUN_10001f60((intptr_t)&DAT_1003dcc8);
  }
  uStack_8 = 0x100024fc;
  return;
}
...
local_c = local_c & -65536;
  ...
  for (local_40 = 0; local_40 < 8; local_40 = local_40 + 1) {
    if (0 < (int)((long long *)&DAT_1003dcd8)[local_40]) {
      uVar1 = FUN_10001e10(&DAT_1003dcc8,
                                 (intptr_t)local_2a,1,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_48 = 0; local_48 < 8; local_48 = local_48 + 1) {
      if (0 < (int)((long long *)&DAT_1003dcd8)[local_48]) {
        ...
        uVar1 = FUN_10001e10(&DAT_1003dcc8,(intptr_t)local_2a,2,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_50 = 0; local_50 < 8; local_50 = local_50 + 1) {
      if (0 < (int)((long long *)&DAT_1003dcd8)[local_50]) {
        ...
        uVar1 = FUN_10001e10(&DAT_1003dcc8,(intptr_t)local_2a,3,
...
*(int *)(param_1 + 0x18) = 0;
  ...
  if (0 < iVar3) {
    ...
    case 2:
      ...
      break;
    case 3:
      local_28 = FUN_100016b0(local_8 + 8,1,0x14);
      local_10 = local_28;
      local_30 = FUN_10001770(local_8 + 8,0);
      local_18 = local_30;
      local_38 = FUN_10001830((intptr_t)local_10,*(int*)((char*)&local_10 + 4),(intptr_t)local_30,
    ...
    case 4:
      ...
      *(int*)((char*)&local_10 + 4) = *(unsigned short *)(local_8 + 10) - 0x96;
      local_40 = FUN_10001770(local_8 + 8,0);
      local_18 = local_40;
      local_48 = FUN_10001830((intptr_t)local_10,*(int*)((char*)&local_10 + 4),(intptr_t)local_40,
...

{
  ...
  int local_44 [15];
  int uStack_8;
RegisterDynGroup(&DAT_1003deb8);
  RegisterDynGroup(&DAT_1003ded8);
  RegisterDynGroup(&DAT_1003def8);
  uStack_8 = 0x10003083;
  return;
}
...

{
  ...
  int local_44 [15];
  int uStack_8;
RegisterDynGroup(&DAT_1003e140);
  RegisterDynGroup(&DAT_1003e160);
  uStack_8 = 0x10003119;
  return;
}
...

{
  ...
  int local_44 [15];
  int uStack_8;
RegisterDynGroup(&DAT_1003df60);
  RegisterDynGroup(&DAT_1003df80);
  RegisterDynGroup(&DAT_1003dfa0);
  RegisterDynGroup(&DAT_1003dfc0);
  RegisterDynGroup(&DAT_1003dfe0);
  RegisterDynGroup(&DAT_1003e000);
  uStack_8 = 0x100031d1;
  return;
}
...
int __cdecl FUN_10004c80(int param_1)
...

{
  ...
  void *local_8;
local_8 = param_1;
  cVar1 = FUN_10004e50(param_1);
  if (cVar1 != '\0') {
    FUN_10005860(local_8);
    iVar2 = FUN_100053c0(local_8);
    if (iVar2 < 10) {
      FUN_10005500(local_8,*(int *)((intptr_t)local_8 + 0x20));
    }
  }
...
local_c = 0;
  uVar4 = 0;
  local_8 = param_1;
  uVar1 = FUN_10004f80(param_1,2000);
...
if (((*(char *)((intptr_t)param_1 + 0x2c) != '\0') &&
      (local_8 = param_1, cVar1 = FUN_10004e50(param_1), cVar1 != '\0')) &&
     (*(int *)((intptr_t)local_8 + 0x10) != 0)) {
    if (*(int *)((intptr_t)local_8 + 0x10) == 6) {
      uVar6 = 0;
      uVar2 = FUN_10004f80(local_8,600);
      ...
      iVar3 = FUN_100053c0(local_8);
      if (iVar3 < 0x32) {
        FUN_10005d00(local_8);
      }
      cVar1 = FUN_100055f0((intptr_t)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        this_ptr = (void *)FUN_10005ee0(*(short **)((intptr_t)local_8 + 0x20));
...
local_8 = param_1;
  ...
  uVar5 = 0;
  uVar4 = 0;
  uVar1 = FUN_10004f80(local_8,100);
  SelSendTo(*(char *)((intptr_t)local_8 + 0x10),uVar1,uVar4,uVar5);
  FUN_10005710((intptr_t)local_8);
...
int __cdecl FUN_10005ee0(short *param_1)
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  FUN_100059c0(param_1,*(int *)((intptr_t)this_ptr + 0xc),*(int *)((intptr_t)this_ptr + 0x10));
  FUN_10005500(param_1,*(int *)((intptr_t)local_8 + 8));
...

{
  ...
  void *local_8;
local_8 = param_1;
  iVar2 = FUN_100066f0((intptr_t)param_1);
  if ((0 < iVar2) && (*(int *)((intptr_t)local_8 + 0x1c) + 1 < *(int *)((intptr_t)local_8 + 0x20))) {
    if (*(int *)((intptr_t)local_8 + *(int *)((intptr_t)local_8 + 0x1c) * 8 + 0x2c) == 1) {
      cVar1 = FUN_10006760(local_8,*(int *)
                                          ((intptr_t)local_8 + *(int *)((intptr_t)local_8 + 0x1c) * 8 + 0x28))
      ;
      if (cVar1 != '\0') {
        FUN_10006db0((intptr_t)local_8 + 0xc,
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  iVar2 = FUN_100066f0((intptr_t)this_ptr);
  if (iVar2 == 0) {
...
local_c = 0;
  ...
  iVar1 = FUN_100066f0((intptr_t)local_8);
  if (iVar2 == iVar1) {
    local_c = 1;
  }
...
local_8 = this_ptr;
  ...
  uVar1 = FUN_10004c80((intptr_t)local_8 + 0xc);
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  bVar1 = FUN_10006880((intptr_t)this_ptr);
  if (bVar1) {
    local_8[2] = param_1;
    *local_8 = param_2;
    local_8[1] = param_3;
...

{
  ...
  int local_8;
local_8 = param_1;
  cVar1 = FUN_10007230(param_1);
  if (cVar1 != '\0') {
    local_c = *(char *)(local_8 + 0x1c);
    if (local_c == '\x01') {
      cVar1 = FUN_10007190(local_8);
      if (cVar1 == '\0') {
...

{
  ...
  void *local_8;
local_8 = param_1;
  cVar1 = FUN_10007880((intptr_t)param_1);
  if (cVar1 != '\0') {
    if (*(char *)((intptr_t)local_8 + 0xc) == '\x01') {
      uVar4 = 500;
      puVar2 = (int *)FUN_10007930(local_8,local_10);
      FUN_100076e0((intptr_t)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((intptr_t)local_8 + 0x15,0);
      if (iVar3 < 1) {
        *(char *)((intptr_t)local_8 + 0xc) = 2;
      }
      else {
        cVar1 = FUN_100077e0((intptr_t)local_8);
        if (cVar1 == '\0') {
          SelectUnits((intptr_t)local_8 + 0xd,0);
          SelSendTo(DAT_1003bd6c,(intptr_t)local_8 + 0x1d,*(char *)((intptr_t)local_8 + 8),0);
        }
      }
    }
    if (*(char *)((intptr_t)local_8 + 0xc) == '\x02') {
      uVar4 = 400;
      puVar2 = (int *)FUN_10007930(local_8,local_18);
      FUN_100076e0((intptr_t)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((intptr_t)local_8 + 0x15,0);
      if (iVar3 < 1) {
        SelectUnits((intptr_t)local_8 + 0xd,0);
        SelSendTo(DAT_1003bd6c,DAT_1003e304,*(char *)((intptr_t)local_8 + 8),0);
      }
      else {
...
local_c = param_1;
  local_10 = param_2;
  local_8 = this_ptr;
  piVar1 = (int *)FUN_10007930(this_ptr,local_34);
  local_1c = *piVar1;
  ...
  FUN_10008384(*(int*)((char*)&local_28 + 4),(intptr_t)local_28);
  lVar5 = 0;
  local_14 = (void *)lVar5;
  FUN_100076e0((intptr_t)local_8 + 0x1d,local_18,local_14,100);
...
local_8 = this_ptr;
  ...
  FUN_10007d00(local_8,(intptr_t)local_8 + 0x16,(intptr_t)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  RegisterUnits((intptr_t)this_ptr + 0x16,param_1);
  CreateZoneNearGroup((intptr_t)local_8 + 0x1e,DAT_1003e310,(intptr_t)local_8 + 0x16,300);
  FUN_10007d00(local_8,(intptr_t)local_8 + 0x16,(intptr_t)local_8 + 0x1e,param_2,param_3);
...

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    FUN_1000b260(param_1,*(int *)((intptr_t)param_1 + -0xc));
    FUN_1000a770(9);
  }
  return;
}
...
int __cdecl FUN_10008700(unsigned int param_1)
...
uVar1 = Trigg(99);
  ...
  if ((uVar1 & 0xff) != 0) {
    ShowPage("#PAGE0");
    for (local_c = 0; (intptr_t)local_c < 0x28; local_c = local_c + 1) {
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    FUN_10002b10((intptr_t)&DAT_1003deb8);
    FUN_10002b10((intptr_t)&DAT_1003ded8);
    FUN_10002b10((intptr_t)&DAT_1003def8);
    FUN_10002b10((intptr_t)&DAT_1003e140);
    FUN_10002b10((intptr_t)&DAT_1003e160);
    FUN_10002b10((intptr_t)&DAT_1003df60);
    FUN_10002b10((intptr_t)&DAT_1003df80);
    FUN_10002b10((intptr_t)&DAT_1003dfa0);
    FUN_10002b10((intptr_t)&DAT_1003dfc0);
    FUN_10002b10((intptr_t)&DAT_1003dfe0);
    FUN_10002b10((intptr_t)&DAT_1003e000);
