...
int __cdecl FUN_10001180(int param_1)
...

{
  ...
  int local_44 [15];
  int uStack_8;
bVar1 = FUN_10001a60((intptr_t)&DAT_100304f8);
  if (bVar1) {
...

{
  ...
  void *local_8;
local_8 = param_1;
  iVar2 = FUN_100018b0((intptr_t)param_1);
  if ((0 < iVar2) && (*(int *)((intptr_t)local_8 + 0x1c) + 1 < *(int *)((intptr_t)local_8 + 0x20))) {
    if (*(int *)((intptr_t)local_8 + *(int *)((intptr_t)local_8 + 0x1c) * 8 + 0x2c) == 1) {
      cVar1 = FUN_10001920(local_8,*(int *)
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  iVar2 = FUN_100018b0((intptr_t)this_ptr);
  if (iVar2 == 0) {
...
local_c = 0;
  ...
  iVar1 = FUN_100018b0((intptr_t)local_8);
  if (iVar2 == iVar1) {
    local_c = 1;
  }
...
uVar1 = Trigg(99);
  ...
  FUN_10001d50((intptr_t)&DAT_100304f8);
  ...
  if ((uVar1 & 0xff) != 0) {
    uVar8 = 0;
    iVar6 = FUN_10001ff0((intptr_t)&DAT_100304f8);
    SelectUnits(iVar6,uVar8);
    DoNotUseSelInAI(1);
    FUN_10001720(&DAT_100303e0,&DAT_10030550,4);
    uVar8 = 0;
    iVar6 = FUN_10001870((intptr_t)&DAT_100303e0);
    SelectUnits(iVar6,uVar8);
    DoNotUseSelInAI(1);
