...
long long DAT_100157a0 = 0;
long long DAT_100157d9 = 0;
long long DAT_100157dd = 0;
...
long long DAT_10015c28 = 0;
long long DAT_1001746d = 0;
...
void  FUN_10001240(void *this_ptr,int param_1);
void  FUN_10001260(void *this_ptr,int param_1);
void  FUN_10001280(void *this_ptr,int param_1);
...
void  FUN_10001d80(void *this_ptr,int param_1);
...

{
  ...
  SelectUnits((int)this_ptr + 0x44,1);
  uVar2 = 0;
  iVar1 = rand();
...
{
  RegisterUnits((int)this_ptr + 5,param_1);
  *(int *)((int)this_ptr + 0xd) = param_2;
  return;
}
...
{
  RegisterUnits((int)this_ptr + 0x11,param_1);
  return;
}
...
{
  RegisterZone((int)this_ptr + *(int *)((int)this_ptr + 0x166) * 8 + 0x22,param_1);
  *(int *)((int)this_ptr + 0x166) = *(int *)((int)this_ptr + 0x166) + 1;
  return;
}
...
{
  RegisterUnits((int)this_ptr + *(int *)((int)this_ptr + 0x166) * 8 + 0xc2,param_1);
  *(int *)((int)this_ptr + 0x166) = *(int *)((int)this_ptr + 0x166) + 1;
  return;
}
...

{
  ...
  iVar1 = *(int *)((int)this_ptr + 0x59);
  if (iVar1 == 10) {
    return 0;
  }
  *(int *)((int)this_ptr + 0x59) = iVar1 + 1;
  RegisterUnits((int)this_ptr + iVar1 * 8 + 9,param_1);
  return 1;
}
...

{
  ...
  if (*(int *)((int)this_ptr + 0x140) == 0x14) {
    return 0;
  }
  iVar1 = *(int *)((int)this_ptr + 0x140) + 1;
  *(int *)((int)this_ptr + 0x140) = iVar1;
  RegisterZone((void *)((int)this_ptr + iVar1 * 8),param_1);
  *(int *)((int)this_ptr + *(int *)((int)this_ptr + 0x140) * 4 + 0xa0) = param_2;
  *(int *)((int)this_ptr + *(int *)((int)this_ptr + 0x140) * 4 + 0xf0) = param_3;
  return 1;
}
...
{
  RegisterUnits((int)this_ptr + 4,param_1);
  return;
}
...

{
  ...
  iVar1 = *(int *)((int)this_ptr + 0xac);
  if (iVar1 == 0x14) {
    return 0;
  }
  *(int *)((int)this_ptr + 0xac) = iVar1 + 1;
  RegisterUnits((int)this_ptr + iVar1 * 8 + 0xc,param_1);
  return 1;
}
...

{
  ...
  iVar5 = rand();
  CreateObject0((int)this_ptr + 0xc,&DAT_10015798,(int)this_ptr + 4,*(char *)this_ptr,param_1,iVar5);
...
{
  RegisterUnitType((int)this_ptr + 4,param_1);
  return;
}
...

{
  ...
  bVar1 = FUN_10001da0((int)this_ptr);
  uVar2 = (int)bVar1;
  if (bVar1) {
...
{
  FUN_10001af0((void *)((int)this_ptr + 0x7c),param_1);
  return;
}
...

{
  ...
  FUN_10001c00((int *)((int)param_1 + 0x3d));
...

{
  ...
  *(char *)((int)this_ptr + 0x184d) = 1;
  *(int *)((int)this_ptr + 0x1845) = 0;
  *(int *)((int)this_ptr + 0x184e) = 0;
  return 1;
}
...

{
  ...
  if ((!bVar2) && (*(int *)((int)param_1 + 0x1845) != 4)) {
    ...
    ClearLightSpot(*(char *)((int)param_1 + 0x1852));
    return;
  }
  piVar1 = param_1 + 3;
  UnitsCenter((int)param_1 + 0x1839,piVar1,100);
  SetLightSpot((int)param_1 + 0x1839,1,*(char *)((int)param_1 + 0x1852));
  switch(*(int *)((int)param_1 + 0x1845)) {
  case 0:
    ...
    if (iVar4 == 0) {
      ...
      uVar3 = 0;
      iVar4 = rand();
      SelSendTo(*(char *)((int)param_1 + 0x1841),
  ...
  case 2:
    ...
    if (*(int *)((int)param_1 + 0x1849) < iVar4) {
      *(int *)((int)param_1 + 0x1845) = 3;
      this_ptr = (void *)((int)param_1 + 0xa9);
      FUN_10001830(this_ptr,*(int *)(&DAT_100157d9 + *(int *)((int)param_1 + 0x3e1) * 0x42),
                   *(int *)(&DAT_100157dd + *(int *)((int)param_1 + 0x3e1) * 0x42));
      FUN_100029c0(this_ptr,(int)param_1,*(int *)((int)param_1 + 0x1841),1);
      iStack_4 = 0;
  ...
  if ((((iVar4 == 0) || (*(int *)((int)param_1 + 0x1845) != 0)) &&
    ...
    uVar7 = *(char *)((int)param_1 + 0x1841);
    uVar6 = (char)*param_1;
  }
  else {
    uVar7 = (char)*param_1;
    uVar6 = *(char *)((int)param_1 + 0x1841);
  }
...

{
  ...
  do {
    FUN_10001d80(this_00,"GRUZ(UN)");
    FUN_10001d00(this_00,*(int *)((int)this_ptr + 0x1841));
...

{
  ...
  uVar3 = *(unsigned int *)((int)param_1 + 0x1845);
  if (uVar3 == 0) {
    uVar2 = FUN_100020e0((int)param_1);
    if ((char)uVar2 != '\0') {
      this_ptr = (void *)((int)param_1 + 0xa9);
      *(int *)((int)param_1 + 0x1845) = 1;
      FUN_10002880(this_ptr,*(int *)((int)param_1 + 0x71),*(int *)((int)param_1 + 0x75));
      FUN_100028a0(this_ptr,(int)param_1,*param_1,1);
...

{
  ...
  if (iVar2 == 0) {
    if (*(char *)((int)param_1 + 0x41) != '\0') {
      *(char *)((int)param_1 + 0x41) = 0;
      *(int *)(&DAT_1001746d + *(int *)((int)param_1 + 0x35) * 0x186a) = 5;
      ShowPage("#MarketLost");
      return;
    }
  }
    ...
    if (iVar2 < 2) {
      if (*(char *)((int)param_1 + 0x41) == '\0') {
        *(char *)((int)param_1 + 0x41) = 1;
        *(int *)(&DAT_1001746d + *(int *)((int)param_1 + 0x35) * 0x186a) = 0;
...

{
  ...
  uVar1 = FUN_10002d70((int)this_ptr);
  if ((char)uVar1 != '\0') {
    uVar2 = rand();
    if ((uVar2 & 0xff) < 0xa0) {
...

{
  ...
  FUN_10001240(&DAT_10025070,"5_band0_barrack");
  FUN_10001210(&DAT_10025070,"5_band0_house0");
  FUN_10001210(&DAT_10025070,"5_band0_house1");
  FUN_10001210(&DAT_10025070,"5_band0_house2");
  FUN_10001260(&DAT_10025070,"Strelec_Algir_DIP(fr)");
  FUN_10001280(&DAT_10025070,"Rundashir_Avstria_DIP(fr)");
  iVar1 = GetDiff(0);
  ...
  FUN_10001460(&DAT_100150f0,"5_assault0_guard");
  ...
  FUN_10001460(&DAT_10015260,"5_assault1_guard");
  ...
  FUN_10001460(&DAT_100153d0,"5_assault2_guard");
  ...
  FUN_10001460(&DAT_10015540,"5_assault3_guard");
  ...
  FUN_100019f0(&DAT_100156c8,"commander");
  ...
  FUN_10001d80(&DAT_100157a0,"Rinok(SV)");
  FUN_10002710(DAT_10025060,0);
  DAT_10015c08 = &DAT_10015c28;
  FUN_10001d80(&DAT_10015c28,"KUPEC(UN)");
...

{
  ...
  if (cVar1 != '\0') {
    ...
    StartAI(2,"DENMARK.0",0,2,2,0xffffffff);
    ShowPage("#Entry0");
    DisableMission(0x52);
    iVar4 = GetDiff(0);
    if (0 < iVar4) {
