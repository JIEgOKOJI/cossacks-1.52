...
int FUN_10009dd0() { return 0; }
int FUN_1000a160() { return 0; }
...
void FUN_10001840(int param_1,char param_2,char param_3);
void FUN_10001900(int param_1,char param_2);
void FUN_100019c0(int param_1,int param_2,int param_3,int param_4,int param_5);
...
void FUN_100044b0(void *param_1);
...
void FUN_10006500(short *param_1);
...
void  FUN_10007e00(int param_1);
void  FUN_10007ea0(int param_1);
int  FUN_10007f10(int param_1);
void  FUN_10007f50(void *this_ptr,int *param_1);
void  FUN_10008080(int param_1);
void  FUN_100081c0(void *this_ptr,int param_1);
void  FUN_10008220(int param_1);
...
void  FUN_10008930(void *this_ptr,int param_1);
...
void  FUN_10008df0(void *this_ptr,short param_1);
void  FUN_10008e60(void *param_1);
...
void FUN_10009af0(void *param_1);
int FUN_10009d00(int *param_1,int param_2,int param_3,int param_4,
...
void FUN_1000a110(DWORD param_1);


void __cdecl FUN_10001840(int param_1,char param_2,char param_3)
...
void __cdecl FUN_10001900(int param_1,char param_2)
...
local_8 = param_3;
  ...
  fVar3 = (long double)FUN_100098d4(local_2c,(int)((double)(int)local_2c / (double)local_30));
...
local_c = local_c & 0xffff0000;
  ...
  for (local_40 = 0; local_40 < 8; local_40 = local_40 + 1) {
    if (0 < (int)(&DAT_1003fd10)[local_40]) {
      ...
      FUN_10002490(&DAT_1003fd00,(int)local_2a,1,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_48 = 0; local_48 < 8; local_48 = local_48 + 1) {
      if (0 < (int)(&DAT_1003fd10)[local_48]) {
        ...
        FUN_10002490(&DAT_1003fd00,(int)local_2a,2,
  ...
  if ((local_c & 0xffff) == 0) {
    ...
    for (local_50 = 0; local_50 < 8; local_50 = local_50 + 1) {
      if (0 < (int)(&DAT_1003fd10)[local_50]) {
        local_54 = ((float)(int)(&DAT_1003fd10)[local_50] * DAT_1003a050_ovl) / (float)local_10;
        if (local_54 < DAT_1003a04c_ovl) {
          local_54 = 1.0;
        }
        lVar5 = 0;
        FUN_10002490(&DAT_1003fd00,(int)local_2a,
...
local_8 = param_1;
  ...
  if (0 < iVar3) {
    ...
    FUN_10002ba0(local_8,*(char *)(local_8 + 0x1e));
    ...
    case 2:
      ...
      break;
    case 3:
      FUN_10001840(local_8 + 8,*(char *)(local_8 + 0x1d),0x14);
      local_10 = local_28;
      if ((int)local_28 == 0) {
        FUN_10001840(local_8 + 8,*(char *)(local_8 + 0x1d),0xf);
        local_10 = local_30;
      }
      bVar5 = (int)local_10 == 0;
      if (bVar5) {
        FUN_10001840(local_8 + 8,*(char *)(local_8 + 0x1d),0xb);
        local_10 = local_38;
      }
      bVar5 = (int)local_10 == 0;
      if (bVar5) {
        FUN_10001840(local_8 + 8,*(char *)(local_8 + 0x1d),0x16);
        local_10 = local_40;
      }
      FUN_10001900(local_8 + 8,*(char *)(local_8 + 0x1e));
      local_18 = local_48;
      FUN_100019c0((int)local_10,*(int*)((char*)&local_10 + 4),(int)local_48,
    ...
    case 4:
      ...
      *(int*)((char*)&local_10 + 4) = *(unsigned short *)(local_8 + 10) - 0x96;
      FUN_10001900(local_8 + 8,0);
      local_18 = local_58;
      FUN_100019c0((int)local_10,*(int*)((char*)&local_10 + 4),(int)local_58,
...
DVar1 = FUN_1000a160((int *)0x0);
  ...
  for (local_8 = 0; local_8 < 0x14; local_8 = local_8 + 1) {
    RegisterUnitType(&DAT_1003fd58 + local_8 * 8,(((int*)0))[local_8]);
  }
  for (local_8 = 0; local_8 < 0x14; local_8 = local_8 + 1) {
    FUN_10009570(&DAT_1003ffa0 + local_8 * 0x41);
    FUN_10009430(&DAT_1003ffa0 + local_8 * 0x41,&DAT_1003fd48);
    FUN_100093f0(&DAT_1003ffa0 + local_8 * 0x41,1);
...
local_8 = local_8 & 0xffffff00;
  while ((local_8 & 0xff) < 0x14) {
    FUN_10009200(&DAT_1003ffa0 + (local_8 & 0xff) * 0x41);
    if (cVar1 == '\0') {
      uVar2 = rand();
      ...
      puVar6 = &DAT_1003fed0;
      uVar3 = FUN_10009070(&DAT_1003ffa0 + (local_8 & 0xff) * 0x41);
...
ClearSelection(1);
  ...
  for (local_10 = 0; local_10 < 0x14; local_10 = local_10 + 1) {
    FUN_10009200(&DAT_1003ffa0 + local_10 * 0x41);
    if (cVar1 != '\0') {
      if ((local_8 & 0xff) == 0) {
        uVar5 = 1;
        uVar2 = FUN_10009070(&DAT_1003ffa0 + local_10 * 0x41);
        SelectUnits(uVar2,uVar5);
      }
      else {
        FUN_10009360(&DAT_1003ffa0 + local_10 * 0x41,&DAT_1003fd50);
        if (cVar1 != '\0') {
          uVar5 = 1;
          uVar2 = FUN_10009070(&DAT_1003ffa0 + local_10 * 0x41);
          SelectUnits(uVar2,uVar5);
...

{
  ...
  int local_8;
for (local_8 = 0; local_8 < 0x14; local_8 = local_8 + 1) {
    FUN_10009200(&DAT_1003ffa0 + local_8 * 0x41);
    if (cVar1 != '\0') {
      FUN_10009360(&DAT_1003ffa0 + local_8 * 0x41,&DAT_1003fd50);
      if (cVar1 == '\0') {
        FUN_10009020(&DAT_1003ffa0 + local_8 * 0x41,&DAT_1003fd50);
      }
    }
  }
  return;
...
local_8 = (unsigned int)*param_1;
  ...
  fVar3 = (long double)FUN_100098d4(local_24,(int)((double)local_20 / (double)(int)local_24));
  local_1c = (double)fVar3;
...
local_8 = local_8 & 0xffffff00;
  ...
  while ((local_c < 0x14 && ((local_8 & 0xff) == 0))) {
    FUN_10009200(&DAT_1003ffa0 + local_c * 0x41);
    if ((cVar1 != '\0') &&
       (FUN_100044b0(&DAT_1003ffa0 + local_c * 0x41), cVar1 != '\0')) {
      local_8 = (int)1;
    }
    local_c = local_c + 1;
  }
  if ((DAT_100404b8 != '\0') && ((local_8 & 0xff) != 0)) {
    ...
    for (local_10 = 0; local_10 < 0x14; local_10 = local_10 + 1) {
      FUN_10009200(&DAT_1003ffa0 + local_10 * 0x41);
      if (cVar1 != '\0') {
        FUN_10008e60(&DAT_1003ffa0 + local_10 * 0x41);
        FUN_10009020(&DAT_1003ffa0 + local_10 * 0x41,uVar2);
        FUN_10009510((int)(&DAT_1003ffa0 + local_10 * 0x41));
      }
    }
  }
  if ((local_8 & 0xff) == 0) {
    ...
    for (local_40 = 0; local_40 < 0x14; local_40 = local_40 + 1) {
      FUN_10009200(&DAT_1003ffa0 + local_40 * 0x41);
      if (cVar1 != '\0') {
        FUN_10008e60(&DAT_1003ffa0 + local_40 * 0x41);
        FUN_100052e0();
        if (5000 < local_48) {
          FUN_10004640(local_44,local_28,local_24);
          FUN_10009020(&DAT_1003ffa0 + local_40 * 0x41,local_44);
        }
      }
    }
  }
  ...
  if ((uVar2 & 0xff) != 0) {
    ...
    if ((uVar2 & 0xff) != 0) {
      for (local_8 = 0; local_8 < 0x14; local_8 = local_8 + 1) {
        FUN_10009200(&DAT_1003ffa0 + local_8 * 0x41);
        if ((cVar1 != '\0') &&
           (FUN_10009360(&DAT_1003ffa0 + local_8 * 0x41,&DAT_1003fd50), cVar1 != '\0')
           ) {
          FUN_10009510((int)(&DAT_1003ffa0 + local_8 * 0x41));
        }
      }
      RunTimer(3,0x32);
    }
    ...
    if ((uVar2 & 0xff) != 0) {
      ...
      for (local_10 = 0; local_10 < 9; local_10 = local_10 + 1) {
        iVar3 = GetReadyAmount(&DAT_1003fe60 + local_10 * 8,0);
...
local_8 = param_1;
  ...
  if (cVar1 != '\0') {
    ...
    if (iVar2 < 10) {
      FUN_10005b20(local_8,*(int *)((int)local_8 + 0x20));
    }
  }
...
if (((*(char *)((int)param_1 + 0x2c) != '\0') &&
      (local_8 = param_1, FUN_10005470(param_1), cVar1 != '\0')) &&
     (*(int *)((int)local_8 + 0x10) != 0)) {
    if (*(int *)((int)local_8 + 0x10) == 6) {
      uVar6 = 0;
      FUN_100055a0(local_8,600);
      ...
      FUN_10005c10((int)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        FUN_10006500(*(short **)((int)local_8 + 0x20));
...
*(int *)((int)this_ptr + 4) = param_1;
  (&DAT_10040638)[DAT_10040688] = this_ptr;
...
local_8 = DAT_10040638;
  for (local_c = 0; local_c < DAT_10040688; local_c = local_c + 1) {
    psVar1 = (short *)FUN_100066d0((&DAT_10040638)[local_c]);
    if (*psVar1 == *param_1) {
...
local_8 = this_ptr;
  ...
  FUN_10005b20(param_1,*(int *)((int)local_8 + 8));
...

{
  ...
  void *local_8;
local_8 = param_1;
  FUN_10007ea0((int)param_1);
  if (cVar1 != '\0') {
    if (*(char *)((int)local_8 + 0xc) == '\x01') {
      uVar4 = 500;
      FUN_10007f50(local_8,local_10);
      FUN_10007d00((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        *(char *)((int)local_8 + 0xc) = 2;
      }
      else {
        FUN_10007e00((int)local_8);
        if (cVar1 == '\0') {
          SelectUnits((int)local_8 + 0xd,0);
          SelSendTo(DAT_1003ddcc,(int)local_8 + 0x1d,*(char *)((int)local_8 + 8),0);
        }
      }
    }
    if (*(char *)((int)local_8 + 0xc) == '\x02') {
      uVar4 = 400;
      FUN_10007f50(local_8,local_18);
      FUN_10007d00((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        SelectUnits((int)local_8 + 0xd,0);
        SelSendTo(DAT_1003ddcc,DAT_10040698,*(char *)((int)local_8 + 8),0);
      }
      else {
...
local_c = param_1;
  local_10 = param_2;
  local_8 = this_ptr;
  FUN_10007f50(this_ptr,local_34);
  local_1c = *piVar1;
  ...
  FUN_10009774(*(int*)((char*)&local_28 + 4),(int)local_28);
  lVar5 = 0;
  local_14 = (void *)lVar5;
  FUN_10007d00((int)local_8 + 0x1d,local_18,local_14,100);
...
local_8 = this_ptr;
  ...
  FUN_10008320(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  ...
  FUN_10008320(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_2,param_3);
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  UnitsCenter((int)this_ptr + 8,this_ptr,(int)param_1);
...
int __cdecl
FUN_10009d00(int *param_1,int param_2,int param_3,int param_4,
            int param_5,int param_6,int param_7)
