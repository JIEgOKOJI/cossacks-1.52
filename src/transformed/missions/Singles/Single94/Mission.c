...
FUN_10002310(void *this_ptr,char param_1,char param_2,char param_3,char param_4,
            short param_5,char param_6,char param_7);
void  FUN_10002430(void *this_ptr,unsigned int param_1,unsigned int param_2,unsigned int param_3,unsigned int param_4);
void  FUN_10002580(int param_1);
void FUN_10002600(unsigned int param_1);
void  FUN_10002670(int param_1);
...
void FUN_10002b40(int param_1,char param_2);
...
void  FUN_10004b00(int param_1);
void  FUN_10004b60(int param_1);
int  FUN_10004bc0(int param_1);
void  FUN_10004bf0(int param_1);
void  FUN_10004c50(void *this_ptr,int param_1);
void  FUN_10004c90(void *this_ptr,int param_1);
...
void FUN_10005bf0(short *param_1);
...
void  FUN_10006400(int param_1);
void  FUN_10006470(void *this_ptr,int param_1);
...
void  FUN_100074f0(int param_1);
void  FUN_10007590(int param_1);
...
void  FUN_10008020(void *this_ptr,int param_1);
...
void  FUN_10008790(int param_1);
void  FUN_100087f0(int param_1);
void  FUN_10008890(int param_1);
...
void __cdecl FUN_100018a0(int param_1,char param_2)
...
local_14 = this_ptr;
  if (*(int *)((int)this_ptr + 8) == 0) {
    ...
    *(char **)((int)local_14 + 8) = local_20;
    ...
    FUN_10002310(*(void **)((int)this_ptr + 8),param_1,param_2,param_3,param_4,param_5,param_6,
                       param_7);
  }
  return;
}
...
LAB_100024da:
  ...
  if (*(int *)((int)this_ptr + 8) != 0) {
    ...
    local_8 = this_ptr;
    FUN_10002430(*(void **)((int)this_ptr + 8),
                                 (int)(char)param_1,
                                 (int)(char)param_2,
...
local_8 = param_1;
  ...
  if (0 < iVar3) {
    ...
    FUN_10002b40(local_8,*(char *)(local_8 + 0x1e));
    ...
    case 2:
      ...
      break;
    case 3:
      FUN_100017e0(local_8 + 8,*(char *)(local_8 + 0x1d),0x14);
      local_10 = local_28;
      if ((int)local_28 == 0) {
        FUN_100017e0(local_8 + 8,*(char *)(local_8 + 0x1d),0xf);
        local_10 = local_30;
      }
      bVar5 = (int)local_10 == 0;
      if (bVar5) {
        FUN_100017e0(local_8 + 8,*(char *)(local_8 + 0x1d),0xb);
        local_10 = local_38;
      }
      bVar5 = (int)local_10 == 0;
      if (bVar5) {
        FUN_100017e0(local_8 + 8,*(char *)(local_8 + 0x1d),0x16);
        local_10 = local_40;
      }
      FUN_100018a0(local_8 + 8,*(char *)(local_8 + 0x1e));
      local_18 = local_48;
      FUN_10001960((int)local_10,*(int*)((char*)&local_10 + 4),(int)local_48,
    ...
    case 4:
      ...
      *(int*)((char*)&local_10 + 4) = *(unsigned short *)(local_8 + 10) - 0x96;
      FUN_100018a0(local_8 + 8,0);
      local_18 = local_58;
      FUN_10001960((int)local_10,*(int*)((char*)&local_10 + 4),(int)local_58,
...
void __cdecl FUN_10004890(int param_1)
...

{
  ...
  void *local_8;
local_8 = param_1;
  FUN_10004b60(param_1);
  if (cVar1 != '\0') {
    FUN_10005570(local_8);
    FUN_100050d0(local_8);
    if (iVar2 < 10) {
      FUN_10005210(local_8,*(int *)((int)local_8 + 0x20));
    }
  }
...
if (((*(char *)((int)param_1 + 0x2c) != '\0') &&
      (local_8 = param_1, FUN_10004b60(param_1), cVar1 != '\0')) &&
     (*(int *)((int)local_8 + 0x10) != 0)) {
    if (*(int *)((int)local_8 + 0x10) == 6) {
      uVar6 = 0;
      FUN_10004c90(local_8,600);
      ...
      FUN_10005300((int)local_8);
      if (cVar1 != '\0') {
        pvVar5 = local_8;
        FUN_10005bf0(*(short **)((int)local_8 + 0x20));
...

{
  ...
  void *local_8;
local_8 = this_ptr;
  FUN_100056d0(param_1,*(int *)((int)this_ptr + 0xc),*(int *)((int)this_ptr + 0x10));
  FUN_10005210(param_1,*(int *)((int)local_8 + 8));
...

{
  ...
  int *local_8;
local_8 = this_ptr;
  bVar1 = FUN_10006590((int)this_ptr);
  if (bVar1) {
    local_8[2] = param_1;
    *local_8 = param_2;
    local_8[1] = param_3;
...

{
  ...
  int local_8;
local_8 = param_1;
  FUN_10006f40(param_1);
  if (cVar1 != '\0') {
    local_c = *(char *)(local_8 + 0x1c);
    if (local_c == '\x01') {
      FUN_10006ea0(local_8);
      if (cVar1 == '\0') {
...

{
  ...
  void *local_8;
local_8 = param_1;
  FUN_10007590((int)param_1);
  if (cVar1 != '\0') {
    if (*(char *)((int)local_8 + 0xc) == '\x01') {
      uVar4 = 500;
      FUN_10007640(local_8,local_10);
      FUN_100073f0((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        *(char *)((int)local_8 + 0xc) = 2;
      }
      else {
        FUN_100074f0((int)local_8);
        if (cVar1 == '\0') {
    ...
    if (*(char *)((int)local_8 + 0xc) == '\x02') {
      uVar4 = 400;
      FUN_10007640(local_8,local_18);
      FUN_100073f0((int)local_8 + 0x15,*puVar2,puVar2[1],uVar4);
      iVar3 = GetUnitsAmount0((int)local_8 + 0x15,0);
      if (iVar3 < 1) {
        SelectUnits((int)local_8 + 0xd,0);
        SelSendTo(DAT_1003cd5c,DAT_1003eec8,*(char *)((int)local_8 + 8),0);
      }
      else {
...
local_c = param_1;
  local_10 = param_2;
  local_8 = this_ptr;
  FUN_10007640(this_ptr,local_34);
  local_1c = *piVar1;
  local_20 = piVar1[1];
  ...
  lVar5 = 0;
  local_14 = (int)lVar5;
  FUN_100073f0((int)local_8 + 0x1d,local_18,local_14,100);
...
local_8 = this_ptr;
  ...
  FUN_10007a10(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_3,param_4);
...
local_8 = this_ptr;
  ...
  FUN_10007a10(local_8,(int)local_8 + 0x16,(int)local_8 + 0x1e,param_2,param_3);
