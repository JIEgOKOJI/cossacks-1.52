...
long long DAT_10013e00 = 0;
long long DAT_10013e39 = 0;
long long DAT_10013e3d = 0;
...
long long DAT_10014110 = 0;
long long DAT_10015955 = 0;
...
void  FUN_10002f00(void *this_ptr,int param_1);
...
void  FUN_10003140(void *this_ptr,int param_1);
...

{
  ...
  FUN_10002d80((int *)((int)param_1 + 0x3d));
...
{
  RegisterUnitType((int)this_ptr + 0x35,param_1);
  return;
}
...

{
  ...
  iVar6 = GetReadyAmount((int)param_1 + 0x35,(int)(char)*param_1);
  if (iVar6 != 0) {
    iVar6 = 0;
    piVar5 = param_1 + 7;
    do {
    ...
    *(int *)((int)param_1 + 0x1845) = 4;
    *(char *)((int)param_1 + 0x184d) = 1;
    *(int *)((int)param_1 + 0x184e) = 0;
    return (int)1;
  }
  ShowPage("#NeedHall");
  ...
  case 2:
    ...
    if (*(int *)((int)param_1 + 0x1849) < iVar4) {
      *(int *)((int)param_1 + 0x1845) = 3;
      ...
      FUN_10003bd0(this_ptr,*(int *)(&DAT_10013e39 + *(int *)((int)param_1 + 0x3e1) * 0x42),
                   *(int *)(&DAT_10013e3d + *(int *)((int)param_1 + 0x3e1) * 0x42));
      FUN_10003d20(this_ptr,(int)param_1,*(int *)((int)param_1 + 0x1841),1);
      iStack_4 = 0;
  ...
  if (uVar3 == 0) {
    ...
    if ((char)uVar2 != '\0') {
      ...
      *(int *)((int)param_1 + 0x1845) = 1;
      FUN_10003be0(this_ptr,*(int *)((int)param_1 + 0x71),*(int *)((int)param_1 + 0x75));
      FUN_10003c00(this_ptr,(int)param_1,*param_1,1);
...

{
  ...
  if (iVar2 == 0) {
    if (*(char *)((int)param_1 + 0x41) != '\0') {
      *(char *)((int)param_1 + 0x41) = 0;
      *(int *)(&DAT_10015955 + *(int *)((int)param_1 + 0x35) * 0x186a) = 5;
      ShowPage("#MarketLost");
      return;
    }
  }
    ...
    if (iVar2 < 2) {
      if (*(char *)((int)param_1 + 0x41) == '\0') {
        ...
        *(int *)(&DAT_10015955 + *(int *)((int)param_1 + 0x35) * 0x186a) = 0;
...

{
  ...
  FUN_10002f00(&DAT_10013e00,"Rinok(sp)");
  FUN_10003a60(DAT_10023568,0);
  DAT_100140d8 = &DAT_10014110;
  FUN_10002f00(&DAT_10014110,"KUPEC(UN)");
  FUN_10003140(DAT_100140d8,"Center_Spain(sp)");
...

{
  ...
  FUN_10002b20(0x10023590);
  if (iVar3 < 0x50) {
    FUN_10002950(&DAT_10023590,2);
  }
  FUN_10002b20(0x10023608);
  if (iVar3 < 0x4b) {
    FUN_10002950(&DAT_10023608,2);
  }
  FUN_10002b20(0x10023680);
  if (iVar3 < 0x55) {
