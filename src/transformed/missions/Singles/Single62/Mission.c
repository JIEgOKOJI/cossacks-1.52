...

{
  ...
  if (*(int *)(param_1 + 0x2ff) == 1) {
    FUN_100015a0(param_1);
    ShowPageParam("#PAGE11",param_1 + 0x2e8,&DAT_1000f728 + *(int *)(param_1 + 0x33c) * 5,
...

{
  ...
  ShowPageParam("#PAGE131",&DAT_1000f728 + (int)pvVar5 * 5,100,
  ...
  if (iVar3 == 0) {
    ...
    if (iVar2 != 0) {
      ShowPageParam("#PAGE7",(int)pvVar1 + 0x29,
                    ...
                    &DAT_1000f728 + *(int *)((int)pvVar1 + 9) * 5,*(int *)((int)pvVar1 + 0xd)
                    ,&DAT_1000f728 + *(int *)((int)pvVar1 + 0x11) * 5,
                    *(int *)((int)pvVar1 + 0x15));
      return;
    }
    ...
    if (iVar3 == 1) {
      ...
      if (iVar3 == 0) {
        FUN_100021d0(pvVar1,*(int *)((int)param_1 + 0x2ff),(char *)((int)param_1 + 0x2e8),
                     *(int *)((int)param_1 + 0x2f7),
                     (int)*(char *)((int)param_1 + 0x33b)
...

{
  ...
  if (*(char *)((int)param_1 + 0x349) != '\0') {
    iVar2 = GetUnitsAmount2(*(int *)((int)param_1 + 0x2fb),&DAT_1000f300,
                            (int)*(char *)((int)param_1 + 0x33b));
    uVar1 = 0;
    if (iVar2 != 0) {
      iVar2 = 0;
        ...
        if (*piVar8 != 0) {
          ...
          do {
            if (*(char *)(*piVar8 + iVar3 + 0x19) != '\0') {
              iVar4 = GetUnitsAmount1(*(int *)((int)param_1 + 0x2fb),*piVar8 + iVar3);
              if (iVar4 != 0) {
                iVar2 = iVar2 * 0x48;
                *(char *)(*(int *)((int)param_1 + uStack_4 * 4 + 0x2d4) + 0x19 + iVar2) = 0;
...
LAB_10002b0a:
        ...
        iVar10 = iVar6 * 0x14;
        strncpy((char *)(&DAT_1000f728 + iVar6 * 5),(char *)(iVar11 + (int)puVar3),sVar5);
        iVar6 = iVar6 + 1;
        *(char *)((int)&DAT_1000f728 + sVar5 + iVar10) = 0;
      } while (iVar6 < 6);
      iVar6 = 0;
      do {
        if (iVar6 == 0) {
...
LAB_10002b9d:
        ...
        sVar5 = FUN_10003b30((byte *)(iVar11 + (int)puVar3),&DAT_1000b66c);
        iVar10 = iVar6 * 0x14;
        strncpy((char *)(&DAT_1000ead0 + iVar6 * 5),(char *)(iVar11 + (int)puVar3),sVar5);
        iVar6 = iVar6 + 1;
        *(char *)((int)&DAT_1000ead0 + sVar5 + iVar10) = 0;
      } while (iVar6 < 5);
