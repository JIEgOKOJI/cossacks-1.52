...
void FUN_10002740(int param_1);
void FUN_10002790(int param_1,char param_2);


void __cdecl FUN_10002740(int param_1)
...
void __cdecl FUN_10002790(int param_1,char param_2)
...
uVar1 = Trigg(1);
  ...
  uVar1 = Trigg(8);
  if ((uVar1 & 0xff) != 0) {
    FUN_10002740(&DAT_1002f430);
    if (iVar2 == 0) {
      uVar1 = Trigg(0x1e);
      if ((uVar1 & 0xff) != 0) {
        FUN_10002740(&DAT_1002f4b8);
