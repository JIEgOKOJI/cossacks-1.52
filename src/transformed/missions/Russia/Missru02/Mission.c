...
uVar1 = Trigg(1);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (iVar3 == 0) {
      ...
      if (iVar3 == 0) {
        iVar3 = GetTotalAmount1(&DAT_100314c0,4);
        iVar2 = GetTotalAmount1(&DAT_100314c0,0);
        if (1 < iVar3 + iVar2) {
          SetTrigg(4,0);
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (0 < iVar3) {
      iVar3 = GetTotalAmount0(&DAT_10031540);
      if (0 < iVar3) {
        SetTrigg(5,0);
        ShowPage("#PAGE5");
        ShowPage("#PAGE5A");
  ...
  uVar1 = Trigg(0xd);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount0(&DAT_100315d0);
    if (iVar3 == 0) {
      SetTrigg(0xd,0);
      ShowPage("#PAGE13");
  ...
  uVar1 = Trigg(0x32);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount0(&DAT_10031578);
    if (iVar3 == 0) {
      SetTrigg(0x32,0);
...
LAB_100028de:
  ...
  uVar1 = TimerDone(10);
  if ((uVar1 & 0xff) != 0) {
    iVar3 = GetTotalAmount0(&DAT_10031530);
    if (0 < iVar3) {
      SelectUnits(&DAT_10031530,0);
      SelSendAndKill(1,&DAT_100314f0,0,0);
      RunTimer(10,100);
