...
void FUN_10003df0(int param_1,char param_2);
...
void __cdecl FUN_10003df0(int param_1,char param_2)
...
uVar1 = Trigg(1);
  ...
  uVar1 = Trigg(4);
  if ((uVar1 & 0xff) != 0) {
    FUN_10003da0(&DAT_10031430);
    if (iVar3 == 0) {
      FUN_10003da0(&DAT_10031448);
      if (iVar3 == 0) {
        FUN_10003df0(&DAT_100314c0,4);
        FUN_10003df0(&DAT_100314c0,0);
        if (1 < iVar3 + iVar2) {
          SetTrigg(4,0);
