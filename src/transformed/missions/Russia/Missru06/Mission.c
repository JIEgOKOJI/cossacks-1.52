...
uVar1 = Trigg(1);
  ...
  if ((uVar1 & 0xff) == 0) {
    ...
    if (0 < iVar2) {
      GetTotalAmount0(&DAT_1002f558);
      if (iVar2 < 1) {
        GetTotalAmount0(&DAT_1002f560);
        if (iVar2 < 1) {
