...

{
  ...
  int uStack_8;
for (DAT_1002f3e0 = 0; DAT_1002f3e0 < 5; DAT_1002f3e0 = DAT_1002f3e0 + 1) {
    iVar2 = GetUnitsAmount0(&DAT_1002f420 + DAT_1002f3e0 * 8,0);
    if (0 < iVar2) {
      iVar2 = GetUnitsAmount0(&DAT_1002f420 + DAT_1002f3e0 * 8,1);
      if (iVar2 == 0) {
  ...
  uVar1 = Trigg(0xf);
  if (((uVar1 & 0xff) != 0) && (FUN_10002610(&DAT_1002f410), iVar2 < 0x14)) {
    SetTrigg(0xf,0);
    iVar2 = GetMyNation();
    if (iVar2 == 1) {
  ...
  uVar1 = Trigg(0x10);
  if (((uVar1 & 0xff) != 0) && (FUN_10002610(&DAT_1002f418), iVar2 < 0x14)) {
    SetTrigg(0x10,0);
    iVar2 = GetMyNation();
    if (iVar2 == 0) {
      ShowCentralText("TEXT8",100);
  ...
  FUN_10002610(&DAT_1002f410);
  if (iVar2 == 0) {
    ProcessScenary();
  }
  FUN_10002610(&DAT_1002f418);
  if (iVar2 == 0) {
    OnInit();
  }
  uStack_8 = 0x1000253a;
...
void __cdecl FUN_10002610(int param_1)
