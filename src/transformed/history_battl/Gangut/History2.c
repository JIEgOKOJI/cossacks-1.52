...

{
  ...
  int local_44 [15];
  int uStack_8;
(*DAT_1002f4e4)(param_1,param_2,(int)param_3);
  uStack_8 = 0x10001443;
  return;
}
...

{
  ...
  int local_44 [15];
  int uStack_8;
(*DAT_1002f4e8)(param_1,param_2,(int)param_3);
  uStack_8 = 0x100014a3;
  return;
}
...

{
  ...
  int local_44 [15];
  int uStack_8;
(*DAT_1002f598)(param_1,param_2,(int)param_3);
  uStack_8 = 0x10001733;
  return;
}
...
void __cdecl FUN_10002370(char param_1)
...
if (DAT_1002f508 != (void *)0x0) {
    (*DAT_1002f508)(param_1,(int)param_2);
  }
  uStack_8 = 0x10002828;
  return;
}
...
if (DAT_1002f574 != (void *)0x0) {
    (*DAT_1002f574)(param_1,(int)param_2);
  }
  uStack_8 = 0x10002878;
  return;
}
...
void __cdecl FUN_100028b0(int param_1)
