...
for (DAT_1002e3e0 = 0; DAT_1002e3e0 < 5; DAT_1002e3e0 = DAT_1002e3e0 + 1) {
  ...
  uVar1 = Trigg(0xf);
  if (((uVar1 & 0xff) != 0) && (FUN_100017a0(&DAT_1002e410), iVar2 < 0x14)) {
    SetTrigg(0xf,0);
    iVar2 = GetMyNation();
    if (iVar2 == 1) {
  ...
  uVar1 = Trigg(0x10);
  if (((uVar1 & 0xff) != 0) && (FUN_100017a0(&DAT_1002e418), iVar2 < 0x14)) {
    SetTrigg(0x10,0);
    iVar2 = GetMyNation();
    if (iVar2 == 0) {
      ShowCentralText("TEXT8",100);
  ...
  FUN_100017a0(&DAT_1002e410);
  if (iVar2 == 0) {
    ProcessScenary();
  }
  FUN_100017a0(&DAT_1002e418);
  if (iVar2 == 0) {
    OnInit();
  }
  uStack_8 = 0x100016ca;
...
void __cdecl FUN_100017a0(int param_1)
