...
{
                    /* 0x1012  1  OnInit */
  SetPlayerName(1,s_HOLLAND_10006198);
  SetPlayerName(2,s_FRANCE_10006190);
  SetPlayerName(4,s_DWELLERS_10006184);
  SetPlayerName(5,s_BANDITS_1000617c);
  ...
  RegisterFormation(&DAT_100065b8,s__LINE30PUS_10006064);
  RegisterUnitType(&DAT_100065c0,s_Konni_Ricar_en__10006054);
  RegisterDynGroup(&DAT_100065e0);
  RegisterDynGroup(&DAT_100066a0);
  RegisterUnitType(&DAT_10006730,s_Kavalerist_avstrii_au__1000603c);
  RegisterDynGroup(&DAT_100065e8);
  RegisterDynGroup(&DAT_100065f8);
  RegisterUnitType(&DAT_10006740,s_Mameluk_AL__10006030);
...
// Function: ProcessScenary @ 0x100013a4
...

{
  ...
  char *pcVar8;
                    ...
                    /* 0x13a4  2  ProcessScenary */
  cVar1 = Trigg(99);
  if (cVar1 != '\0') {
    DAT_10006598 = GetDiff(0);
    if (DAT_10006598 == 1) {
      pcVar8 = s__LINE5_10006254;
    }
    else if (DAT_10006598 == 2) {
      pcVar8 = s__LINE10_1000624c;
    }
    else if (DAT_10006598 == 3) {
      pcVar8 = s__LINE15PUS_10006240;
    }
    else {
      pcVar8 = s__LINE3_10006238;
    }
    ...
    InitialUpgrade(&DAT_100060c8,s_AKA01SP_10006230);
    InitialUpgrade(&DAT_100060c8,s_AKA02SP_10006228);
    InitialUpgrade(&DAT_100060c8,s_AKA03SP_10006220);
    InitialUpgrade(&DAT_100060c8,s_AKA04SP_10006218);
    if (DAT_10006598 < 2) {
    ...
    StartAI(1,s_HOLLAND_0_1000620c,0,0,1,DAT_10006598);
    StartAI(2,s_FRANCE_0_10006200,0,0,1,DAT_10006598);
    ShowPage(s__PAGE12_100061f8);
    SetTrigg(99,0);
  }
  cVar1 = Trigg(1);
  ...
  if (((cVar1 != '\0') && (cVar1 = Trigg(0x37), cVar1 == '\0')) &&
    ...
    cVar1 = AskQuestion(s__PAGE1_100061d8);
    if ((cVar1 == '\0') || (iVar3 = GetResource(0,1), iVar3 < 1000)) {
      SetTrigg(0x38,0);
      ShowPage(s__PAGE6_100061d0);
    }
    else {
      SelectUnits(&DAT_100066e8,0);
      SelErase(4);
...
LAB_10001c4a:
  ...
  if (cVar1 != '\0') {
    ...
    if ((cVar1 != '\0') || (iVar3 = GetUnitsAmount0(&DAT_10006698,5), iVar3 < 10)) {
      ...
      ShowPageParam(s__PAGE9_100061b8,DAT_10006748,DAT_10006618,DAT_1000661c);
      DisableMission(0x42);
      EnableMission(0x43);
  ...
  cVar1 = Trigg(0x26);
  if ((cVar1 != '\0') && (cVar1 = (*pcVar6)(1), cVar1 != '\0')) {
    ShowPage(s__PAGE10_100061b0);
    SetTrigg(0x26,0);
  }
  cVar1 = Trigg(0x27);
  if ((cVar1 != '\0') && (cVar1 = (*pcVar6)(2), cVar1 != '\0')) {
    ShowPage(s__PAGE11_100061a8);
    SetTrigg(0x27,0);
  }
  cVar1 = (*pcVar6)(1);
  if ((cVar1 != '\0') && (cVar1 = (*pcVar6)(2), cVar1 != '\0')) {
    ShowPage(s__PAGE8_100061a0);
    ShowVictory();
  }
  cVar1 = (*pcVar6)(0);
  if (cVar1 != '\0') {
...
// Function: FUN_10002368 @ 0x10002368

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

undefined4 FUN_10002368(undefined4 param_1,int param_2)

{
  ...
  if (param_2 == 1) {
    DAT_100067ac = GetVersion();
    iVar1 = FUN_10002d9c(1);
    if (iVar1 != 0) {
      _DAT_100067b8 = DAT_100067ac >> 8 & 0xff;
      _DAT_100067b4 = DAT_100067ac & 0xff;
      DAT_100067ac = DAT_100067ac >> 0x10;
      _DAT_100067b0 = _DAT_100067b4 * 0x100 + _DAT_100067b8;
      iVar1 = FUN_1000262f();
      if (iVar1 != 0) {
        DAT_10006d18 = GetCommandLineA();
        DAT_10006798 = FUN_10002c6a();
        FUN_10002754();
        FUN_10002a1d();
        FUN_10002964();
        FUN_10002511();
...
LAB_100023c8:
    ...
    if (param_2 == 0) {
      if (DAT_10006794 < 1) goto LAB_100023c8;
      DAT_10006794 = DAT_10006794 + -1;
      if (DAT_100067e4 == 0) {
        FUN_1000254f();
      }
...

{
  ...
  iVar2 = DAT_10006794;
  if (param_2 != 0) {
    if ((param_2 != 1) && (param_2 != 2)) goto LAB_10002489;
    if ((DAT_10006d1c != (code *)0x0) &&
       (iVar2 = (*DAT_10006d1c)(param_1,param_2,param_3), iVar2 == 0)) {
      return 0;
    }
    iVar2 = FUN_10002368(param_1,param_2);
  }
  if (iVar2 == 0) {
    return 0;
  }
LAB_10002489:
  ...
  if (param_2 == 1) {
    ...
    FUN_10002368(param_1,0);
  }
  if ((param_2 != 0) && (param_2 != 3)) {
    return iVar2;
  }
  iVar3 = FUN_10002368(param_1,param_2);
  param_2 = iVar2;
  if (iVar3 == 0) {
    param_2 = 0;
  }
...
// Function: __amsg_exit @ 0x100024de
...
{
  if ((DAT_100067a0 == 1) || ((DAT_100067a0 == 0 && (DAT_100067a4 == 1)))) {
    FUN_10002e4d();
  }
  FUN_10002e86(param_1);
  (*(code *)PTR___exit_1000625c)(0xff);
  return;
}



// Function: FUN_10002511 @ 0x10002511

void FUN_10002511(void)

{
  if (DAT_10006d14 != (code *)0x0) {
    (*DAT_10006d14)();
  }
  FUN_10002615((undefined4 *)&DAT_10006008,(undefined4 *)&DAT_10006010);
  FUN_10002615((undefined4 *)&DAT_10006000,(undefined4 *)&DAT_10006004);
  return;
}



// Function: __exit @ 0x1000253e
...
// Function: FUN_1000255e @ 0x1000255e

void __cdecl FUN_1000255e(UINT param_1,int param_2,int param_3)

{
  ...
  DAT_100067e4 = 1;
  DAT_100067e0 = (undefined1)param_3;
  if (param_2 == 0) {
    ...
    FUN_10002615((undefined4 *)&DAT_10006014,(undefined4 *)&DAT_10006018);
  }
  FUN_10002615((undefined4 *)&DAT_1000601c,(undefined4 *)&DAT_10006020);
  if (param_3 == 0) {
    DAT_100067e8 = 1;
...
void __cdecl FUN_10002615(undefined4 *param_1,undefined4 *param_2)
...
// Function: FUN_1000262f @ 0x1000262f

undefined4 FUN_1000262f(void)

{
  ...
  FUN_10002fd9();
  DAT_10006260 = TlsAlloc();
  if (DAT_10006260 != 0xffffffff) {
    lpTlsValue = (DWORD *)FUN_100030e4(1,0x74);
    if (lpTlsValue != (DWORD *)0x0) {
      BVar1 = TlsSetValue(DAT_10006260,lpTlsValue);
      if (BVar1 != 0) {
        FUN_100026a1((int)lpTlsValue);
...
// Function: FUN_10002683 @ 0x10002683
...

{
  FUN_10003002();
  if (DAT_10006260 != 0xffffffff) {
    TlsFree(DAT_10006260);
    DAT_10006260 = 0xffffffff;
  }
  return;
}
...
// Function: FUN_100026a1 @ 0x100026a1

void __cdecl FUN_100026a1(int param_1)

{
  *(undefined **)(param_1 + 0x50) = &DAT_100063e0;
...
// Function: FUN_100026b4 @ 0x100026b4

void __cdecl FUN_100026b4(LPVOID param_1)

{
  if (DAT_10006260 != 0xffffffff) {
    if ((param_1 != (LPVOID)0x0) || (param_1 = TlsGetValue(DAT_10006260), param_1 != (LPVOID)0x0)) {
      if (*(LPVOID *)((int)param_1 + 0x24) != (LPVOID)0x0) {
        FUN_10003171(*(LPVOID *)((int)param_1 + 0x24));
      }
      if (*(LPVOID *)((int)param_1 + 0x28) != (LPVOID)0x0) {
        FUN_10003171(*(LPVOID *)((int)param_1 + 0x28));
      }
      if (*(LPVOID *)((int)param_1 + 0x30) != (LPVOID)0x0) {
        FUN_10003171(*(LPVOID *)((int)param_1 + 0x30));
      }
      if (*(LPVOID *)((int)param_1 + 0x38) != (LPVOID)0x0) {
        FUN_10003171(*(LPVOID *)((int)param_1 + 0x38));
      }
      if (*(LPVOID *)((int)param_1 + 0x40) != (LPVOID)0x0) {
        FUN_10003171(*(LPVOID *)((int)param_1 + 0x40));
      }
      if (*(LPVOID *)((int)param_1 + 0x44) != (LPVOID)0x0) {
        FUN_10003171(*(LPVOID *)((int)param_1 + 0x44));
      }
      if (*(undefined **)((int)param_1 + 0x50) != &DAT_100063e0) {
        FUN_10003171(*(undefined **)((int)param_1 + 0x50));
      }
      FUN_10003171(param_1);
    }
    TlsSetValue(DAT_10006260,(LPVOID)0x0);
    return;
  }
  return;
}
...
// Function: FUN_10002754 @ 0x10002754

void FUN_10002754(void)
...
// Function: FUN_10002964 @ 0x10002964

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_10002964(void)

{
  ...
  iVar5 = 0;
  for (puVar6 = DAT_10006798; (char)*puVar6 != '\0'; puVar6 = (uint *)((int)puVar6 + sVar2 + 1)) {
    if ((char)*puVar6 != '=') {
      iVar5 = iVar5 + 1;
    }
  ...
  _DAT_100067c8 = puVar3;
  if (puVar3 == (undefined4 *)0x0) {
    __amsg_exit(9);
  }
  cVar1 = (char)*DAT_10006798;
  puVar6 = DAT_10006798;
  while (cVar1 != '\0') {
    sVar2 = _strlen((char *)puVar6);
    if ((char)*puVar6 != '=') {
  ...
  FUN_10003171(DAT_10006798);
  DAT_10006798 = (uint *)0x0;
  *puVar3 = 0;
  _DAT_10006d04 = 1;
  return;
}
...
// Function: FUN_10002a1d @ 0x10002a1d

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void FUN_10002a1d(void)

{
  ...
  GetModuleFileNameA((HMODULE)0x0,&DAT_100067ec,0x104);
  _DAT_100067d8 = &DAT_100067ec;
  pbVar2 = &DAT_100067ec;
  if (*DAT_10006d18 != 0) {
    pbVar2 = DAT_10006d18;
  }
  FUN_10002ab6(pbVar2,(undefined4 *)0x0,(byte *)0x0,&local_8,&local_c);
  puVar1 = _malloc(local_c + local_8 * 4);
  if (puVar1 == (undefined4 *)0x0) {
    __amsg_exit(8);
  }
  FUN_10002ab6(pbVar2,puVar1,(byte *)(puVar1 + local_8),&local_8,&local_c);
  _DAT_100067c0 = puVar1;
  _DAT_100067bc = local_8 + -1;
  return;
}



// Function: FUN_10002ab6 @ 0x10002ab6

void __cdecl FUN_10002ab6(byte *param_1,undefined4 *param_2,byte *param_3,int *param_4,int *param_5)
...
// Function: FUN_10002c6a @ 0x10002c6a

LPSTR FUN_10002c6a(void)
...
LAB_10002cc1:
    ...
    if (DAT_100068f0 == 1) goto LAB_10002cc1;
    if (DAT_100068f0 != 2) {
      return (LPSTR)0x0;
    }
  }
...
// Function: FUN_10002d9c @ 0x10002d9c

undefined4 __cdecl FUN_10002d9c(int param_1)
...

{
  ...
  iVar1 = 0;
  if (0 < DAT_100069a8) {
    puVar2 = (undefined4 *)((int)DAT_100069ac + 0xc);
    do {
      ...
      puVar2 = puVar2 + 5;
      iVar1 = iVar1 + 1;
    } while (iVar1 < DAT_100069a8);
  }
  HeapFree(DAT_10006be8,0,DAT_100069ac);
  HeapDestroy(DAT_10006be8);
  return;
}
...
// Function: FUN_10002e4d @ 0x10002e4d

void FUN_10002e4d(void)

{
  if ((DAT_100067a0 == 1) || ((DAT_100067a0 == 0 && (DAT_100067a4 == 1)))) {
    FUN_10002e86(0xfc);
    if (DAT_100068f4 != (code *)0x0) {
      (*DAT_100068f4)();
    }
    FUN_10002e86(0xff);
  }
...
void __cdecl FUN_10002e86(DWORD param_1)

{
  ...
  do {
    ...
    pDVar2 = pDVar2 + 2;
    iVar5 = iVar5 + 1;
  } while ((int)pDVar2 < 0x10006320);
  if (param_1 == (&DAT_10006290)[iVar5 * 2]) {
    if ((DAT_100067a0 == 1) || ((DAT_100067a0 == 0 && (DAT_100067a4 == 1)))) {
      pDVar2 = &param_1;
      puVar1 = (undefined4 *)(iVar5 * 8 + 0x10006294);
      ...
      FUN_10003260(local_a4,(uint *)&DAT_1000540c);
      FUN_10003260(local_a4,*(uint **)(iVar5 * 8 + 0x10006294));
      auStackY_1e3._3_4_ = 0x10002faa;
      FUN_1000432e(local_a4,"Microsoft Visual C++ Runtime Library",0x12010);
    }
  }
  return;
}
...
// Function: FUN_10002fd9 @ 0x10002fd9

void FUN_10002fd9(void)

{
  InitializeCriticalSection((LPCRITICAL_SECTION)PTR_DAT_10006364);
  InitializeCriticalSection((LPCRITICAL_SECTION)PTR_DAT_10006354);
  InitializeCriticalSection((LPCRITICAL_SECTION)PTR_DAT_10006344);
  InitializeCriticalSection((LPCRITICAL_SECTION)PTR_DAT_10006324);
  return;
}



// Function: FUN_10003002 @ 0x10003002

void FUN_10003002(void)

{
  undefined **ppuVar1;
  
  ppuVar1 = (undefined **)&DAT_10006320;
  do {
    if (((((LPCRITICAL_SECTION)*ppuVar1 != (LPCRITICAL_SECTION)0x0) &&
         (ppuVar1 != &PTR_DAT_10006364)) && (ppuVar1 != &PTR_DAT_10006354)) &&
       ((ppuVar1 != &PTR_DAT_10006344 && (ppuVar1 != &PTR_DAT_10006324)))) {
      DeleteCriticalSection((LPCRITICAL_SECTION)*ppuVar1);
      FUN_10003171(*ppuVar1);
    }
    ppuVar1 = ppuVar1 + 1;
  } while ((int)ppuVar1 < 0x100063e0);
  DeleteCriticalSection((LPCRITICAL_SECTION)PTR_DAT_10006344);
  DeleteCriticalSection((LPCRITICAL_SECTION)PTR_DAT_10006354);
  DeleteCriticalSection((LPCRITICAL_SECTION)PTR_DAT_10006364);
  DeleteCriticalSection((LPCRITICAL_SECTION)PTR_DAT_10006324);
  return;
}
...
void __cdecl FUN_1000306e(int param_1)

{
  int *piVar1;
  LPCRITICAL_SECTION lpCriticalSection;
  
  piVar1 = &DAT_10006320 + param_1;
  if ((&DAT_10006320)[param_1] == 0) {
    ...
    if (*piVar1 == 0) {
      ...
      *piVar1 = (int)lpCriticalSection;
      ...
      FUN_10003171(lpCriticalSection);
    }
    FUN_100030cf(0x11);
  }
...
void __cdecl FUN_100030cf(int param_1)

{
  LeaveCriticalSection((LPCRITICAL_SECTION)(&DAT_10006320)[param_1]);
  return;
}



// Function: FUN_100030e4 @ 0x100030e4

int * __cdecl FUN_100030e4(int param_1,int param_2)

{
  ...
  do {
    if (puVar3 < (uint *)0xffffffe1) {
      if (_Size < DAT_10006570 || (int)_Size - (int)DAT_10006570 == 0) {
        FUN_1000306e(9);
        piVar1 = FUN_10003e79(_Size);
        FUN_100030cf(9);
        if (piVar1 != (int *)0x0) {
...
// Function: FUN_10003171 @ 0x10003171

void __cdecl FUN_10003171(LPVOID param_1)

{
  ...
  if (param_1 != (LPVOID)0x0) {
    FUN_1000306e(9);
    puVar1 = (uint *)FUN_10003b23((int)param_1);
    if (puVar1 != (uint *)0x0) {
      FUN_10003b4e(puVar1,(uint)param_1);
      FUN_100030cf(9);
      return;
    }
    FUN_100030cf(9);
...

{
  ...
  pvVar1 = __nh_malloc(_Size,DAT_1000696c);
  return pvVar1;
}



// Function: __nh_malloc @ 0x100031cb
...

{
  ...
  if (_Size < 0xffffffe1) {
    do {
      piVar1 = FUN_100031f7((uint *)_Size);
      if (piVar1 != (int *)0x0) {
        return piVar1;
      }
      if (_NhFlag == 0) {
...
int * __cdecl FUN_100031f7(uint *param_1)

{
  int *piVar1;
  
  if (param_1 <= DAT_10006570) {
    FUN_1000306e(9);
    piVar1 = FUN_10003e79(param_1);
    FUN_100030cf(9);
    if (piVar1 != (int *)0x0) {
      return piVar1;
    }
...
LAB_100033f8:
      ...
      *(undefined1 *)puVar15 = 0;
      pbVar13 = (byte *)(iVar12 + 0x10006488);
      do {
        bVar3 = *pbVar13;
        pbVar11 = pbVar13;
      ...
      _DAT_100069cc = 1;
      DAT_100069b0 = CodePage;
      DAT_10006be4 = FUN_100035b2(CodePage);
      DAT_100069c0 = *(undefined4 *)(iVar12 + 0x1000647c);
      DAT_100069c4 = *(undefined4 *)(iVar12 + 0x10006480);
      DAT_100069c8 = *(undefined4 *)(iVar12 + 0x10006484);
      goto LAB_1000354c;
    }
    goto LAB_10003547;
  }
...
code_r0x100033fc:
  pUVar5 = pUVar5 + 0xc;
  iVar12 = iVar12 + 1;
  if (0x10006567 < (int)pUVar5) goto code_r0x10003407;
  goto LAB_100033f8;
code_r0x10003407:
...

{
  ...
  BVar2 = GetCPInfo(DAT_100069b0,&local_18);
  if (BVar2 == 1) {
    uVar3 = 0;
    do {
    ...
    FUN_10004782(1,local_118,0x100,local_518,DAT_100069b0,DAT_10006be4,0);
    FUN_10004533(DAT_10006be4,0x100,local_118,0x100,local_218,0x100,DAT_100069b0,0);
    FUN_10004533(DAT_10006be4,0x200,local_118,0x100,local_318,0x100,DAT_100069b0,0);
    uVar3 = 0;
    puVar7 = local_518;
    do {
      if ((*puVar7 & 1) == 0) {
...
undefined4 FUN_10003ae5(void)

{
  DAT_100069ac = HeapAlloc(DAT_10006be8,0,0x140);
  if (DAT_100069ac == (LPVOID)0x0) {
    return 0;
  }
  DAT_100069a4 = 0;
  DAT_100069a8 = 0;
  DAT_100069a0 = DAT_100069ac;
  DAT_10006998 = 0x10;
  return 1;
}
...
// Function: FUN_10003b23 @ 0x10003b23

uint __cdecl FUN_10003b23(int param_1)

{
  ...
  uVar1 = DAT_100069ac;
  while( true ) {
    if (DAT_100069ac + DAT_100069a8 * 0x14 <= uVar1) {
      return 0;
    }
...
// Function: FUN_10003b4e @ 0x10003b4e

void __cdecl FUN_10003b4e(uint *param_1,uint param_2)

{
  ...
  *piVar3 = *piVar3 + -1;
  uVar5 = DAT_1000699c;
  puVar2 = DAT_100069a4;
  if ((*piVar3 == 0) && (uVar5 = uVar10, puVar2 = param_1, DAT_100069a4 != (uint *)0x0)) {
    VirtualFree((LPVOID)(DAT_1000699c * 0x8000 + DAT_100069a4[3]),0x8000,0x4000);
    DAT_100069a4[2] = DAT_100069a4[2] | 0x80000000U >> ((byte)DAT_1000699c & 0x1f);
    *(undefined4 *)(DAT_100069a4[4] + 0xc4 + DAT_1000699c * 4) = 0;
    *(char *)(DAT_100069a4[4] + 0x43) = *(char *)(DAT_100069a4[4] + 0x43) + -1;
    if (*(char *)(DAT_100069a4[4] + 0x43) == '\0') {
      DAT_100069a4[1] = DAT_100069a4[1] & 0xfffffffe;
    }
    puVar2 = param_1;
    if (DAT_100069a4[2] == 0xffffffff) {
      VirtualFree((LPVOID)DAT_100069a4[3],0,0x8000);
      HeapFree(DAT_10006be8,0,(LPVOID)DAT_100069a4[4]);
      FUN_100048d0(DAT_100069a4,DAT_100069a4 + 5,
                   (DAT_100069a8 * 0x14 - (int)DAT_100069a4) + -0x14 + DAT_100069ac);
      DAT_100069a8 = DAT_100069a8 + -1;
      if (DAT_100069a4 < param_1) {
        param_1 = param_1 + -5;
      }
      DAT_100069a0 = DAT_100069ac;
      puVar2 = param_1;
...
// Function: FUN_10003e79 @ 0x10003e79

int * __cdecl FUN_10003e79(uint *param_1)

{
  ...
  puVar8 = DAT_100069ac + DAT_100069a8 * 5;
  ...
  puVar11 = DAT_100069ac;
  if (param_1 == puVar8) {
    for (; (puVar11 < DAT_100069a0 && ((puVar11[1] & local_c) == 0 && (*puVar11 & local_10) == 0));
        puVar11 = puVar11 + 5) {
    }
    param_1 = puVar11;
    if (puVar11 == DAT_100069a0) {
      for (; (puVar11 < puVar8 && (puVar11[2] == 0)); puVar11 = puVar11 + 5) {
      }
      puVar12 = DAT_100069ac;
      param_1 = puVar11;
      if (puVar11 == puVar8) {
        for (; (puVar12 < DAT_100069a0 && (puVar12[2] == 0)); puVar12 = puVar12 + 5) {
        }
        param_1 = puVar12;
        if ((puVar12 == DAT_100069a0) && (param_1 = FUN_10004182(), param_1 == (uint *)0x0)) {
          return (int *)0x0;
        }
      }
      iVar7 = FUN_10004233((int)param_1);
      *(int *)param_1[4] = iVar7;
      if (*(int *)param_1[4] == -1) {
        return (int *)0x0;
      }
...
LAB_1000413f:
  ...
  *(uint *)((int)piVar10 + (uVar6 - 4)) = uVar6 + 1;
  iVar7 = *piVar2;
  *piVar2 = iVar7 + 1;
  if (((iVar7 == 0) && (param_1 == DAT_100069a4)) && (local_8 == DAT_1000699c)) {
    DAT_100069a4 = (uint *)0x0;
  }
  *piVar4 = local_8;
  return piVar10 + 1;
}
...
// Function: FUN_10004182 @ 0x10004182

undefined4 * FUN_10004182(void)

{
  undefined4 *puVar1;
  LPVOID pvVar2;
  
  if (DAT_100069a8 == DAT_10006998) {
    pvVar2 = HeapReAlloc(DAT_10006be8,0,DAT_100069ac,(DAT_10006998 * 5 + 0x50) * 4);
    if (pvVar2 == (LPVOID)0x0) {
      return (undefined4 *)0x0;
    }
    DAT_10006998 = DAT_10006998 + 0x10;
    DAT_100069ac = pvVar2;
  }
  puVar1 = (undefined4 *)((int)DAT_100069ac + DAT_100069a8 * 0x14);
...
// Function: FUN_10004233 @ 0x10004233

int __cdecl FUN_10004233(int param_1)
...
int __cdecl FUN_1000432e(undefined4 param_1,undefined4 param_2,undefined4 param_3)

{
  ...
  iVar1 = 0;
  if (DAT_1000695c == (FARPROC)0x0) {
    hModule = LoadLibraryA("user32.dll");
    if (hModule != (HMODULE)0x0) {
      DAT_1000695c = GetProcAddress(hModule,"MessageBoxA");
      if (DAT_1000695c != (FARPROC)0x0) {
        DAT_10006960 = GetProcAddress(hModule,"GetActiveWindow");
        DAT_10006964 = GetProcAddress(hModule,"GetLastActivePopup");
        goto LAB_1000437d;
      }
    }
    iVar1 = 0;
...
LAB_1000437d:
    if (DAT_10006960 != (FARPROC)0x0) {
      iVar1 = (*DAT_10006960)();
      if ((iVar1 != 0) && (DAT_10006964 != (FARPROC)0x0)) {
        iVar1 = (*DAT_10006964)(iVar1);
      }
    }
    iVar1 = (*DAT_1000695c)(iVar1,param_1,param_2,param_3);
  }
  return iVar1;
}
...
LAB_100044a9:
          ...
          cVar3 = '\0';
          _Count = _Count & 3;
          if (_Count != 0) goto LAB_1000443b;
          return _Dest;
        }
        if ((char)(uVar2 >> 8) == '\0') {
          *puVar5 = uVar2 & 0xff;
          goto joined_r0x100044a5;
        }
        if ((uVar2 & 0xff0000) == 0) {
          *puVar5 = uVar2 & 0xffff;
          goto joined_r0x100044a5;
...
// Function: FUN_10004518 @ 0x10004518

undefined4 __cdecl FUN_10004518(undefined4 param_1)

{
  int iVar1;
  
  if (DAT_10006968 != (code *)0x0) {
    iVar1 = (*DAT_10006968)(param_1);
    if (iVar1 != 0) {
      return 1;
    }
  }
...
// Function: FUN_10004533 @ 0x10004533

int __cdecl
FUN_10004533(LCID param_1,uint param_2,char *param_3,int param_4,LPWSTR param_5,int param_6,
...

{
  ...
  if (0 < param_4) {
    param_4 = FUN_10004757(param_3,param_4);
  }
  if (DAT_10006990 == 2) {
...
// Function: FUN_10004757 @ 0x10004757

int __cdecl FUN_10004757(char *param_1,int param_2)
...
BOOL __cdecl
FUN_10004782(DWORD param_1,LPCSTR param_2,int param_3,LPWORD param_4,UINT param_5,LCID param_6,
            int param_7)
...
undefined4 * __cdecl FUN_100048d0(undefined4 *param_1,undefined4 *param_2,uint param_3)

{
  ...
  if ((param_2 < param_1) && (param_1 < (undefined4 *)(param_3 + (int)param_2))) {
    ...
    if (((uint)puVar4 & 3) == 0) {
      ...
      if (7 < uVar1) {
        ...
        case 0:
          return param_1;
        case 2:
          goto switchD_10004a87_caseD_2;
        case 3:
          goto switchD_10004a87_caseD_3;
        }
        goto switchD_10004a87_caseD_1;
      }
    }
    else {
      switch(param_3) {
      case 0:
        goto switchD_10004a87_caseD_0;
      case 1:
        goto switchD_10004a87_caseD_1;
      case 2:
        goto switchD_10004a87_caseD_2;
    ...
    switch(uVar2) {
    case 1:
switchD_10004a87_caseD_1:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      return param_1;
    case 2:
switchD_10004a87_caseD_2:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      *(undefined1 *)((int)puVar4 + 2) = *(undefined1 *)((int)puVar3 + 2);
      return param_1;
    case 3:
switchD_10004a87_caseD_3:
      *(undefined1 *)((int)puVar4 + 3) = *(undefined1 *)((int)puVar3 + 3);
      *(undefined1 *)((int)puVar4 + 2) = *(undefined1 *)((int)puVar3 + 2);
      *(undefined1 *)((int)puVar4 + 1) = *(undefined1 *)((int)puVar3 + 1);
      return param_1;
    }
switchD_10004a87_caseD_0:
    return param_1;
  }
  puVar3 = param_1;
  if (((uint)param_1 & 3) == 0) {
    ...
    if (7 < uVar1) {
      ...
      case 0:
        return param_1;
      case 2:
        goto switchD_10004905_caseD_2;
      case 3:
        goto switchD_10004905_caseD_3;
      }
      goto switchD_10004905_caseD_1;
    }
  }
  else {
    switch(param_3) {
    case 0:
      goto switchD_10004905_caseD_0;
    case 1:
      goto switchD_10004905_caseD_1;
    case 2:
      goto switchD_10004905_caseD_2;
  ...
  switch(uVar2) {
  case 1:
switchD_10004905_caseD_1:
    *(undefined1 *)puVar3 = *(undefined1 *)param_2;
    return param_1;
  case 2:
switchD_10004905_caseD_2:
    *(undefined1 *)puVar3 = *(undefined1 *)param_2;
    *(undefined1 *)((int)puVar3 + 1) = *(undefined1 *)((int)param_2 + 1);
    return param_1;
  case 3:
switchD_10004905_caseD_3:
    *(undefined1 *)puVar3 = *(undefined1 *)param_2;
    *(undefined1 *)((int)puVar3 + 1) = *(undefined1 *)((int)param_2 + 1);
    *(undefined1 *)((int)puVar3 + 2) = *(undefined1 *)((int)param_2 + 2);
    return param_1;
  }
switchD_10004905_caseD_0:
  return param_1;
}



// Function: __global_unwind2 @ 0x10004c08
...
// Function: __local_unwind2 @ 0x10004c4a
...

{
  ...
  DAT_10006588 = *(undefined4 *)(unaff_EBP + 8);
  DAT_10006584 = in_EAX;
  DAT_1000658c = unaff_EBP;
  return;
}



// Function: FUN_10004dbd @ 0x10004dbd
