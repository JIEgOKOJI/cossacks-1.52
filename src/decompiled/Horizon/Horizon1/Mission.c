  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (0 < iVar2) {
      ...
      AskMultilineQuestion
                (9,"#PAGE2",0,
                 "Kenneth\'s orders are they? Tell you what gentlemen. I have no quarrel with thee per se. Leave now in peace, but this cannon of yours is going into the sea, one way or another.|You on Kenneth\'s playrole? How about you take this 60 coins and relax in a brothel for a day or two?|To hell with you."
                );
...
LAB_10002021:
  ...
  if ((uVar1 & 0xff) != 0) {
    ...
    if (0 < iVar2) {
      ...
      AskMultilineQuestion
                (9,"#PAGE13",0,
                 "I have no quarrel with you men. Out of my way! And leave the cannon behind.|Maybe you ought to take this 60 coins and take a relaxing walk.|To hell with you."
                );
